...
z.prototype.R = function (a, b) {
  ...
  (b = this.l = this.l || b)
    ? b.Na
      ...
      : b.ga != void 0 && this.v < b.ga
        ? ((this.j = b.ga), (this.l = null))
        : (this.j = this.v)
    : (this.j = a);
};
...
function wa(a) {
  for (; a.j.j; )
    try {
      var b = a.l(a.j);
      if (b) return ((a.j.G = !1), { value: b.value, done: !1 });
    } catch (c) {
...
v("Promise", function (a) {
  ...
  b.prototype.v = function () {
    ...
    var h = this,
      k = !1;
    return { resolve: g(this.M), reject: g(this.A) };
  };
...
var cb = F("Firefox") || F("FxiOS"),
  db =
    ...
    !(
      (Za()
        ? Ya("Chromium")
        : ((F("Chrome") || F("CriOS")) && (Za() || !F("Edge"))) || F("Silk")) ||
      (Za() ? 0 : F("Coast")) ||
      (Za() ? 0 : F("Opera")) ||
      (Za() ? 0 : F("Edge")) ||
      (Za() ? Ya("Microsoft Edge") : F("Edg/")) ||
      (Za() ? Ya("Opera") : F("OPR")) ||
      F("Firefox") ||
      F("FxiOS") ||
      F("Silk") ||
    ...
    !((F("iPhone") && !F("iPod") && !F("iPad")) || F("iPad") || F("iPod"));
var eb = {},
  fb = null;
...
function qb(a, b) {
  if (a != null) {
    ...
    c = d[a] || 0;
    c >= b ||
      ((d[a] = c + 1), (a = Error()), nb(a, "severity", "incident"), Sa(a));
  }
}
function rb() {
...
var Bb = { qb: { value: 0, configurable: !0, writable: !0, enumerable: !1 } },
...
function rc(a) {
  ...
  if (a.length < 16) bc(Number(a));
    ...
    ((a = BigInt(a)),
      ...
      ($b = Number((a >> BigInt(32)) & BigInt(4294967295))));
  else {
    b = +(a[0] === "-");
    $b = I = 0;
    for (
      ...
      ((d = Number(a.slice(d, e))),
        ...
        (I = I * 1e6 + d),
        I >= 4294967296 &&
          (($b += Math.trunc(I / 4294967296)), ($b >>>= 0), (I >>>= 0)));
    b &&
      ((b = y(cc(I, $b))),
      (a = b.next().value),
      (b = b.next().value),
        ...
        ? ((b = kc(Number(a))),
          ic(b)
            ...
            : ((b = a.indexOf(".")),
              ...
              (a = rb() ? Sb(hc(64, BigInt(a))) : Sb(rc(a)))))
        : (a = ic(a) ? Sb(sc(a)) : Sb(tc(a))),
      a
    );
}
function vc(a) {
...
function wc(a, b, c, d) {
  ...
  if (!Array.isArray(a))
    return c ? (d & 2 ? b[vb] || (b[vb] = xc(b)) : new b()) : void 0;
  c = a[G] | 0;
  d = c | (d & 32) | (d & 2);
  d !== c && H(a, d);
  return new b(a);
    ...
    for (var E in r)
      ((h = r[E]),
        h != null &&
          ...
          ((t = +E),
          (w = void 0),
          l && !Number.isNaN(t) && (w = t + m) < g
            ? (f[w] = h)
            : ((t = void 0), (((t = b) != null ? t : (b = {}))[E] = h))));
  b && (k ? f.push(b) : (f[g] = b));
  e &&
    Ra(xb) &&
    (a = (c = Ra(xb)) ? a[c] : void 0) &&
    a instanceof zc &&
    (f[xb] = Bc(a));
  return f;
}
...
function Kc(a, b) {
  ...
  if (a != null && a[Ab] === Hb)
    return (
      (b = a.C),
      (c = b[G] | 0),
      Ib(a, c) ? a : Mc(a, b, c) ? Nc(a, b) : Lc(b, c)
    );
...
function bd(a) {
  return a == null
    ...
    : typeof a === "string"
      ...
      : a.constructor === kb
        ? a
        : gb && a != null && a instanceof Uint8Array
          ? a.length
            ? new kb(new Uint8Array(a), ib)
            : lb()
          : void 0;
}
function cd(a, b) {
...
function hd(a) {
  ...
  b = new Map();
  Object.defineProperty(a, wb, { value: b });
  return b;
}
function dd(a, b, c, d) {
  d === 0 || c.includes(d);
...
function nd(a, b, c, d) {
  if (d != null) {
    if (!(d instanceof b))
      throw Error(
        "Expected instanceof " + mc(b) + " but got " + (d && mc(d.constructor)),
      );
  } else d = void 0;
  Vc(a, c, d);
  d && !Ib(d) && Rc(a.C);
...
Hd.prototype.ctor = function (a) {
  ...
  try {
    ...
    if (rd(a, 1).split("/").pop() != e) var f = null;
      ...
      Pc(a) && ((h = a.C), (k = h[G] | 0));
      a = h;
      if (l != null && !(Array.isArray(l) || (l != null && l[Ab] === Hb)))
        throw Error(
...
q.div = function (a) {
  ...
  for (c = this; c.compare(a) >= 0; ) {
    ...
    for (var f = Zd(d), g = f.multiply(a); g.H < 0 || g.compare(c) > 0; )
      ((d -= e), (f = Zd(d)), (g = f.multiply(a)));
    Ud(f) && (f = Wd);
    b = b.add(f);
    c = c.add(Td(g));
  }
...
function Zd(a) {
  return a > 0
    ? a >= 0x7fffffffffffffff
      ? $d
      : new Rd(a, a / 4294967296)
    : a < 0
      ? a <= -0x7fffffffffffffff
        ? Vd
        : Td(new Rd(-a, -a / 4294967296))
      : Yd;
}
function N(a, b) {
  return new Rd(a, b);
...
function ce() {
  ...
  if ((b = typeof b !== "string" ? null : b))
    ((a = Qd("[" + b.substring(4))), (a = md(a, Od, 1)[0]));
  if (a) {
    b = y(md(a, Md, 2));
    var c = b.next(),
      d;
...
O.prototype.ya = function () {
  return (
    ...
    (Object.defineProperties(this, {
      A: { value: (le = (le + 1) | 0), enumerable: !1 },
    }),
    this.A)
  );
};
...
function T(a) {
  qe(a.j) &&
    (Error.captureStackTrace
      ? Error.captureStackTrace(U(a.j, qe, re))
      : (U(a.j, qe, re).stack = Error().stack));
}
...
function Ae() {
  Ae = n();
  for (var a = Be(), b = 0; b < 256; b = (b + 1) | 0)
    Ce(a, b, De((b - 128) | 0));
  ze = a;
}
function Ee() {}
...
function U(a, b, c) {
  if (a != null && !b(a))
    throw (
      (a = P(me(Se(a))) + " cannot be cast to " + P(me(Q(c)))),
      (b = new Ge()),
      (b.l = a),
      T(b),
      S(b, Error(b)),
...
function Be() {
  var a = [256];
  return bf(a, { ba: Ye, oa: $e, aa: a.length });
}
function bf(a, b) {
  var c = a[0];
            ...
            h == e
              ? ((e = g.ba),
                (d =
                  e === d
                    ? !0
                    : (d && d.prototype.Qa) || (e && e.prototype.Qa)
                      ? !1
                      : f(e.prototype)))
              : (d = h > e ? O == d : !1);
          } else d = !1;
...
function Cf(a) {
  ...
  A.onerror = function (c, d, e, f, g) {
    b && b(c, d, e, f, g);
    a({ message: c, fileName: d, line: e, lineNumber: e, Ac: f, error: g });
    return !0;
  };
}
function Df(a) {
...
function Hf(a, b) {
  a instanceof Error ||
    ((a = Error(a)), Error.captureStackTrace && Error.captureStackTrace(a, Hf));
...
function Jf(a, b) {
  a = Hf(a);
  if (b) for (var c in b) nb(a, c, b[c]);
  return a;
}
function If(a) {
  var b = Error();
  if (Error.captureStackTrace)
    (Error.captureStackTrace(b, a || If), (b = String(b.stack)));
  else {
    try {
      throw b;
    } catch (c) {
...
function Kf(a, b) {
  var c = [];
  if (Array.prototype.indexOf.call(b, a, void 0) >= 0)
...
function kg(a) {
  hg[hg.length] = a;
  if (jg) for (var b = 0; b < ig.length; b++) a(B(ig[b].j, ig[b]));
}
kg(n());
function lg() {
  this.l = this.j = null;
    ...
    if (c)
      for (
        var e = function (h, k, l) {
            c--;
            d[h] = k ? { kb: !0, value: l } : { kb: !1, reason: l };
            c == 0 && b(d);
          },
          f,
          g = 0;
...
function Mg(a, b, c, d) {
  if (c == 3 && b.l && !b.A) for (; a && a.A; a = a.o) a.A = !1;
...
function Xg(a) {
  ...
  for (var d = (c = !1); a.A.length && !a.I; ) {
    ...
    if ((f = a.v ? g : f))
      try {
        ...
        if (
          vg(b) ||
          (typeof A.Promise === "function" && b instanceof A.Promise)
        )
          ((d = !0), (a.I = !0));
      } catch (k) {
        ((b = k), (a.v = !0), dh(a) || (c = !0));
  ...
  d &&
    ((h = B(a.J, a, !0)),
    (d = B(a.J, a, !1)),
    b instanceof Tg ? (ah(b, h, d), (b.L = !0)) : b.then(h, d));
  ...
  if (a != null)
    for (var b in a) {
      var c = b,
        d = a[b];
      if (this.l != null)
        throw Je("Cannot use setClientFlag when comparison is enabled.").j;
...
x(vh, sf);
function xh(a) {
  if (!(((a.l.get(null) + 1) | 0) / V(a.l.o / 1e3) <= a.o))
    throw new uh("Query would cause " + P(a.G) + " to exceed " + a.o + " qps.")
      .j;
  a = a.l;
...
function Dh(a) {
  ...
  a != null
    ? "number" === typeof a
      ? ((a = V(a)), (a = Math.max(Math.min(a, 2147483647), -2147483648) | 0))
      : (a = a instanceof Rd ? V(a).K : a.X)
    : (a = 100);
  this.o = a;
  this.j = U([], mf, lf);
}
...
function Nh(a, b, c) {
  ...
  d ||
    ((a = a.l), (c = b.j(c)), (d = new Kh()), (d.j = b), (d.l = c), a.push(d));
}
...
Mh.prototype.removeAll = function () {
  for (var a = U(this.l.pop(), Lh, Kh); a != null; )
    (a.j.l(a.l), (a = U(this.l.pop(), Lh, Kh)));
};
Mh.prototype.D = [
...
Sh.prototype.toString = function () {
  ...
  if ((c = this.l))
    (this.j && c.charAt(0) != "/" && a.push("/"),
      a.push(Zh(c, c.charAt(0) == "/" ? ai : bi, !0)));
...
q.la = function (a) {
  ...
  var b = [];
  if (typeof a === "string")
    ii(this, a) && (b = b.concat(this.j.get(hi(this, a))));
  else {
...
si.prototype.add = function (a, b, c, d, e) {
  ...
  g > -1
    ? ((b = a[g]), c || (b.ia = !1))
    : ((b = new qi(b, this.src, f, !!d, e)), (b.ia = c), a.push(b));
  return b;
};
...
function ui(a, b) {
  ...
  c in a.j &&
    ab(a.j[c], b) &&
    (ri(b), a.j[c].length == 0 && (delete a.j[c], a.l--));
}
...
function yi(a, b, c, d, e) {
  ...
  c = Ai(c);
  return a && a[oi]
    ? a.listen(b, c, Ka(d) ? !!d.capture : !!d, e)
    : Bi(a, b, c, !1, d, e);
}
...
function zi(a, b, c, d, e) {
  ...
  c = Ai(c);
  return a && a[oi]
    ? a.l.add(String(b), c, !0, Ka(d) ? !!d.capture : !!d, e)
    : Bi(a, b, c, !0, d, e);
}
function Hi(a, b, c, d, e) {
  if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Hi(a, b[f], c, d, e);
  else
    ((d = Ka(d) ? !!d.capture : !!d), (c = Ai(c)), a && a[oi])
  ...
  if (typeof a !== "number" && a && !a.removed) {
    ...
    if (b && b[oi]) ui(b.l, a);
      ...
      b.removeEventListener
        ...
        : b.detachEvent
          ? b.detachEvent(Fi(c), d)
          : b.addListener && b.removeListener && b.removeListener(d);
      xi--;
      (c = Di(b))
        ? (ui(c, a), c.l == 0 && ((c.src = null), (b[vi] = null)))
        : ri(a);
    }
  }
}
...
function Ui(a, b, c) {
  b && (a.j.stop(), Vi(a, a.v));
  a.isActive() ||
    ((b = Math.max(0, a.B + a.l - Date.now())),
    b == 0 && (c ? (b = Vi(a, a.v)) : (a.l = 0)),
    a.j.start(b));
}
q.stop = function () {
  this.j.stop();
    ...
    $g(
      ...
      function (f) {
        if (!(f >= this.ea))
          return (
            this.O &&
              (a = W(a, "errorSender_enqueueTimeMs", Date.now().toString())),
            (f = {}),
            (f.u = a),
            (f.m = b),
            (f.c = c),
...
function bj(a, b) {
  ...
  try {
    ...
    a.O &&
      ((c = W(c, "errorSender_sendTimeMs", Date.now().toString())),
      (c = W(c, "errorSenderType", a.Ka())),
      b.errorSender_frontIndex &&
        (c = W(c, "errorSender_frontIndex", b.errorSender_frontIndex)),
      b.errorSender_nextIndex &&
        (c = W(c, "errorSender_nextIndex", b.errorSender_nextIndex)),
      b.errorSender_queueSize &&
        (c = W(c, "errorSender_queueSize", b.errorSender_queueSize)));
    a.V = b;
    var d = b.m,
      e = b.c,
      f = b.h;
    ...
    else throw Jf(g, { "docs-origin-class": "docs.debug.ErrorSender" });
  }
  return gh();
}
q.pb = function () {
...
tj.prototype.fa = function () {
  var a = new Map(),
    b,
    c = (b = this.j) == null ? void 0 : oj(sj(b));
  if (c == null ? 0 : pc(K(c, 2)) != null) {
    var d;
    (b = (d = sd(c, 2)) == null ? void 0 : d.toString()) &&
  ...
  (e =
    (h = this.j) == null
      ...
      : (k = ld(h, nj, 1)) == null
        ? void 0
        : sd(k, 6)) && a.set("clientApp", String(e));
  return a;
};
function uj(a, b) {
  this.width = a;
  ...
  try {
    for (; !c.done; c = b.next()) {
      var g = c.value,
        h = Bj(g.key);
      h === 0
        ? (a.set("apps_telemetry.automation_property_present." + g.T, "true"),
          (e = !0))
        : h === 2 &&
          a.set(
            "apps_telemetry.automation_property_check_failed." + g.T,
            "true",
          );
    }
  } finally {
...
function yj() {
  function a(b) {
    try {
      var c = new uj(1, 500);
      return (
        (b ? vj("CANVAS") : new OffscreenCanvas(c.width, c.height)).getContext(
          "2d",
        ) != null
      );
    } catch (d) {
...
function zj() {
  return (
    "WorkerGlobalScope" in A &&
    typeof A.WorkerGlobalScope === "function" &&
    self instanceof A.WorkerGlobalScope
  );
}
function Bj(a) {
  if (zj() || !A) return 1;
...
function Dj(a, b, c) {
  try {
    ...
    return { ca: !1, reason: "not_reachable" };
  }
  c = Ej(d);
  if (c !== "function") return { ca: !1, reason: "non_function_type", type: c };
  try {
    var e = a.j(d);
  } catch (f) {
    return { ca: !1, reason: "to_string_failed" };
  }
  a = Fj.exec(e);
  return a
    ? (a = a[1])
      ? a !== b
        ? { ca: !1, reason: "likely_wrong_native_function" }
        : { ca: !0 }
      : { ca: !1, reason: "likely_bound_function" }
    : { ca: !1, reason: "likely_non_native_source" };
}
function Ej(a) {
  switch (typeof a) {
    case "function":
...
function Qj(a, b) {
  return (b = a.j(b)) ? { ua: a.ua, ka: a.ka, Ba: b.toUpperCase() } : null;
}
function Rj() {
  Pj.call(this, 1, 1);
}
...
var Uj = [
  ...
  { errorMessage: "(reading 'toLowerCase')", pa: !0, Y: ["__aiNetCmd__"] },
  { errorMessage: "Cannot read properties of undefined", Y: ["recaptcha"] },
  { errorMessage: "a is not defined", Ha: !0, Y: ["<anonymous>"] },
  { errorMessage: "i is not defined", Ha: !0, Y: ["<anonymous>"] },
...
yk.prototype.fa = function () {
  ...
  try {
    ...
    try {
      for (; !c.done; c = b.next())
        c.value.fa().forEach(function (e, f) {
          a.set(f, e);
        });
    } finally {
      c && !c.done && (d = b.return) && d.call(b);
...
q.send = function (a, b, c, d) {
  ...
  !(Array.prototype.indexOf.call(el, b, void 0) >= 0) ||
    d ||
    g ||
    ...
    if ((b = b === 0))
      ((a = String(a.M).match(Vf)[1] || null),
        !a &&
          A.self &&
          A.self.location &&
          (a = A.self.location.protocol.slice(0, -1)),
        (b = !dl.test(a ? a.toLowerCase() : "")));
    c = b;
  }
  return c;
}
  ...
  if (a.l) {
    ...
    d.call(
      ...
      sl(e.getFullYear() - 2e3) +
        ...
        sl(e.getSeconds()) +
        "." +
        sl(Math.floor(e.getMilliseconds() / 10)),
      "] ",
    );
  }
  d = c.push;
...
function vl(a) {
  ...
  this.Xa = a.M;
  var c = a.l;
  this.Ua = (a.v || Ik)({ wb: kj, tb: lj, va: [new Kk()] });
  this.cb = a.R;
  this.U = new ki();
  var d = new cl();
  xl(this, c);
...
function yl(a) {
  ...
  if (Cl) {
    if (Dl != null)
      throw Error('ErrorReporter already installed. at "' + Dl.stack + '"');
  ...
  a.M.listen(a.j, "c", function (e) {
    ...
    (g = g == "fatal" || g == "postmortem") &&
      !a.gb &&
      (a.ib && !f ? a.U.notify(e, e.Z) : a.U.notify(void 0, e.Z));
...
vl.prototype.V = function (a, b, c) {
  ...
  if (g.trim().length == 0 || g == "Not available")
    ((b["stacklessError-reportingStack"] = If(vl.prototype.V)),
      [a.message]
        .concat(oa(Object.keys(b)), oa(Object.values(b)))
        .some(function (h) {
      ...
      new ta(function (u) {
        switch (u.j) {
          ...
          case 2:
            t = u.L();
            b.j = 3;
            w = Error("Failed to initialize crash storage", { cause: t });
...
q.ob = function (a) {
  if (
    ...
    this.A ||
      ...
      (this.readyState = 2),
      Tl(this)),
    this.j && ((this.readyState = 3), Tl(this), this.j))
  )
    if (this.responseType === "arraybuffer")
      a.arrayBuffer().then(this.mb.bind(this), this.ma.bind(this));
...
q.lb = function (a) {
  if (this.j) {
    if (this.O && a.value) this.o.push(a.value);
      ...
      if ((b = this.P.decode(b, { stream: !a.done }))) this.o = this.v += b;
    }
...
function jm(a, b) {
  ...
  c && c.data && c.ports && c.ports.length
    ? ((b = c.data ? em(JSON.stringify(c.data)) : new dm()),
      km(a, b, c.ports.length > 1 ? c.ports[1] : void 0).then(function (d) {
        c.ports[0].postMessage(Gc(d));
      }))
    : Yl(a.j, Error("Dropped invalid event."), { event: String(b) });
}
function km(a, b, c) {
  return Bg()
    .then(function () {
...
function rm(a) {
  ...
  a.j &&
    (a.v && ((a.A = Gg()), (a.v = !1)),
    a.j.parentNode && a.j.parentNode.removeChild(a.j),
    (a.j = null));
  return Promise.resolve();
}
function sm(a, b) {
...
function um(a, b) {
  return (
    Vh(a.F, "/offline/extension/frame").toString() +
    "?ouid=" +
