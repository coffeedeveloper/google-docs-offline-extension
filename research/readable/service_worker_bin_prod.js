...
y.prototype.P = function (a, b) {
  ...
  (b = this.l = this.l || b)
    ? b.Oa
      ...
      : b.ha != void 0 && this.v < b.ha
        ? ((this.j = b.ha), (this.l = null))
        : (this.j = this.v)
    : (this.j = a);
};
...
r("Promise", function (a) {
  ...
  b.prototype.v = function () {
    ...
    var h = this,
      k = !1;
    return { resolve: g(this.M), reject: g(this.D) };
  };
...
var gb = C("Firefox") || C("FxiOS"),
  hb =
    ...
    !(
      (bb()
        ? ab("Chromium")
        : ((C("Chrome") || C("CriOS")) && (bb() || !C("Edge"))) || C("Silk")) ||
      (bb() ? 0 : C("Coast")) ||
      (bb() ? 0 : C("Opera")) ||
      (bb() ? 0 : C("Edge")) ||
      (bb() ? ab("Microsoft Edge") : C("Edg/")) ||
      (bb() ? ab("Opera") : C("OPR")) ||
      C("Firefox") ||
      C("FxiOS") ||
      C("Silk") ||
...
function ub(a, b) {
  if (a != null) {
    ...
    c = d[a] || 0;
    c >= b ||
      ((d[a] = c + 1), (a = Error()), rb(a, "severity", "incident"), Va(a));
  }
}
function vb() {
...
var Fb = { qb: { value: 0, configurable: !0, writable: !0, enumerable: !1 } },
...
function Xb(a) {
  ...
  return Wb
    ? BigInt(a)
    : (a = Ub(a) ? (a ? "1" : "0") : Tb(a) ? a.trim() || "0" : String(a));
}
...
function sc(a) {
  if (typeof a !== "boolean")
    throw Error("Expected boolean but got " + Ja(a) + ": " + a);
  return a;
}
  ...
  if (a.length < 16) hc(Number(a));
    ...
    for (
      ...
      ((d = Number(a.slice(d, e))),
        ...
        (F = F * 1e6 + d),
        F >= 4294967296 &&
          ((ec += Math.trunc(F / 4294967296)), (ec >>>= 0), (F >>>= 0)));
    b &&
      ((b = w(ic(F, ec))),
      (a = b.next().value),
      (b = b.next().value),
        ...
        ? ((b = pc(Number(a))),
          nc(b)
            ...
            : ((b = a.indexOf(".")),
              ...
              (a = vb() ? Xb(mc(64, BigInt(a))) : Xb(xc(a)))))
        : (a = nc(a) ? Xb(yc(a)) : Xb(zc(a))),
      a
    );
}
function Bc(a) {
...
function Cc(a, b, c, d) {
  ...
  if (!Array.isArray(a))
    return c ? (d & 2 ? b[zb] || (b[zb] = Dc(b)) : new b()) : void 0;
  c = a[D] | 0;
  d = c | (d & 32) | (d & 2);
  d !== c && Jb(a, d);
  return new b(a);
    ...
    for (var E in q)
      ((h = q[E]),
        h != null &&
          ...
          ((t = +E),
          (x = void 0),
          l && !Number.isNaN(t) && (x = t + m) < g
            ? (f[x] = h)
            : ((t = void 0), (((t = b) != null ? t : (b = {}))[E] = h))));
  b && (k ? f.push(b) : (f[g] = b));
  e &&
    Ta(Bb) &&
    (a = (c = Ta(Bb)) ? a[c] : void 0) &&
    a instanceof Fc &&
    (f[Bb] = Hc(a));
  return f;
}
...
function Qc(a, b) {
  ...
  if (a != null && a[Eb] === Mb)
    return (
      (b = a.B),
      (c = b[D] | 0),
      Nb(a, c) ? a : Sc(a, b, c) ? Tc(a, b) : Rc(b, c)
    );
...
function hd(a) {
  return a == null
    ...
    : typeof a === "string"
      ...
      : a.constructor === ob
        ? a
        : kb && a != null && a instanceof Uint8Array
          ? a.length
            ? new ob(new Uint8Array(a), mb)
            : pb()
          : void 0;
}
function id(a, b) {
...
function nd(a) {
  ...
  b = new Map();
  Object.defineProperty(a, Ab, { value: b });
  return b;
}
function jd(a, b, c, d) {
  d === 0 || c.includes(d);
...
function od(a, b, c) {
  ...
  b = Cc(e, b, !f, d);
  if (!f || b)
    return ((b = Uc(b)), e !== b && ((d = bd(a, d, c, b)), Xc(a, d)), b);
}
function pd(a, b, c, d) {
  var e = !1;
...
function rd(a, b, c) {
  ...
  if (
    ...
    !(
      8 & m ||
      (!a.length && (h === 1 || (h !== 4 ? 0 : 2 & m || (!(16 & m) && 32 & e))))
    )
  ) {
    dd(m) &&
      ((a = Array.prototype.slice.call(a)),
...
function sd(a, b, c, d) {
  if (d != null) {
    if (!(d instanceof b))
      throw Error(
        "Expected instanceof " + rc(b) + " but got " + (d && rc(d.constructor)),
      );
  } else d = void 0;
  ad(a, c, d);
  d && !Nb(d) && Xc(a.B);
...
Nd.prototype.ctor = function (a) {
  ...
  try {
    ...
    if (wd(a, 1).split("/").pop() != e) var f = null;
      ...
      Vc(a) && ((h = a.B), (k = h[D] | 0));
      a = h;
      if (l != null && !(Array.isArray(l) || (l != null && l[Eb] === Mb)))
        throw Error(
...
p.div = function (a) {
  ...
  for (c = this; c.compare(a) >= 0; ) {
    ...
    for (var f = ee(d), g = f.multiply(a); g.I < 0 || g.compare(c) > 0; )
      ((d -= e), (f = ee(d)), (g = f.multiply(a)));
    $d(f) && (f = be);
    b = b.add(f);
    c = c.add(Zd(g));
  }
...
function ee(a) {
  return a > 0
    ? a >= 0x7fffffffffffffff
      ? fe
      : new Xd(a, a / 4294967296)
    : a < 0
      ? a <= -0x7fffffffffffffff
        ? ae
        : Zd(new Xd(-a, -a / 4294967296))
      : de;
}
function K(a, b) {
  return new Xd(a, b);
...
function ie() {
  ...
  if ((b = typeof b !== "string" ? null : b))
    ((a = Wd("[" + b.substring(4))), (a = rd(a, Ud, 1)[0]));
  if (a) {
    b = w(rd(a, Sd, 2));
    var c = b.next(),
      d;
...
L.prototype.ya = function () {
  return (
    ...
    (Object.defineProperties(this, {
      D: { value: (re = (re + 1) | 0), enumerable: !1 },
    }),
    this.D)
  );
};
...
function Q(a) {
  we(a.j) &&
    (Error.captureStackTrace
      ? Error.captureStackTrace(R(a.j, we, xe))
      : (R(a.j, we, xe).stack = Error().stack));
}
...
function Ge() {
  Ge = n();
  for (var a = He(), b = 0; b < 256; b = (b + 1) | 0)
    Ie(a, b, Je((b - 128) | 0));
  Fe = a;
}
function Ke() {}
...
function R(a, b, c) {
  if (a != null && !b(a))
    throw (
      (a = M(se(Ye(a))) + " cannot be cast to " + M(se(O(c)))),
      (b = new Me()),
      (b.l = a),
      Q(b),
      P(b, Error(b)),
...
function He() {
  var a = [256];
  return hf(a, { ca: df, oa: ff, ba: a.length });
}
function hf(a, b) {
  var c = a[0];
            ...
            h == e
              ? ((e = g.ca),
                (d =
                  e === d
                    ? !0
                    : (d && d.prototype.Ra) || (e && e.prototype.Ra)
                      ? !1
                      : f(e.prototype)))
              : (d = h > e ? L == d : !1);
          } else d = !1;
  ...
  var a =
    a == null
      ? function (c) {
          return (
            Math.max(
              Math.min(Math.floor(Math.random() * c), 2147483647),
              -2147483648,
            ) | 0
          );
        }
...
p.dispose = function () {
  ...
  if (a != null) {
    this.sa();
    if (a.length != 0) for (var b = 0; b < a.length; b++) a[b].dispose();
    a = O(te(this));
...
function Cf(a) {
  ...
  z.onerror = function (c, d, e, f, g) {
    b && b(c, d, e, f, g);
    a({ message: c, fileName: d, line: e, lineNumber: e, Gc: f, error: g });
    return !0;
  };
}
function Df(a) {
        ...
        ((c =
          a.constructor && a.constructor instanceof Function
            ? 'Unknown Error of type "' +
              (a.constructor.name ? a.constructor.name : Ff(a.constructor)) +
              '"'
...
function T(a, b) {
  a instanceof Error ||
    ((a = Error(a)), Error.captureStackTrace && Error.captureStackTrace(a, T));
...
function If(a, b) {
  a = T(a);
  if (b) for (var c in b) rb(a, c, b[c]);
  return a;
}
function Hf(a) {
  var b = Error();
  if (Error.captureStackTrace)
    (Error.captureStackTrace(b, a || Hf), (b = String(b.stack)));
  else {
    try {
      throw b;
    } catch (c) {
...
function kg(a) {
  hg[hg.length] = a;
  if (jg) for (var b = 0; b < ig.length; b++) a(A(ig[b].j, ig[b]));
}
kg(n());
function lg() {
  this.l = this.j = null;
...
X.prototype.then = function (a, b, c) {
  return Jg(
    this,
    eg(typeof a === "function" ? a : null),
    eg(typeof b === "function" ? b : null),
    c,
  );
};
      ...
      if (c.l) {
        ...
        e &&
          (c.j == 0 && d == 1
            ? Lg(c, b)
            : (f
                ? ((d = f), d.next == c.v && (c.v = d), (d.next = d.next.next))
                : Mg(c),
              Ng(c, e, 3, b)));
      }
      a.o = null;
...
function Ng(a, b, c, d) {
  if (c == 3 && b.l && !b.D) for (; a && a.D; a = a.o) a.D = !1;
...
function Yg(a) {
  ...
  for (var d = (c = !1); a.D.length && !a.J; ) {
    ...
    if ((f = a.v ? g : f))
      try {
        ...
        h === dh && (h = void 0);
        h !== void 0 &&
          ((a.v = a.v && (h == b || h instanceof Error)), (a.l = b = h));
        if (
          vg(b) ||
  ...
  d &&
    ((h = A(a.H, a, !0)),
    (d = A(a.H, a, !1)),
    b instanceof Ug ? (bh(b, h, d), (b.L = !0)) : b.then(h, d));
  ...
  if (a != null)
    for (var b in a) {
      var c = b,
        d = a[b];
      if (this.l != null)
        throw Pe("Cannot use setClientFlag when comparison is enabled.").j;
...
function rh(a, b) {
  if (a.l != null) {
    ...
    !(b = qe(a, f)) &&
      (b = a != null) &&
      (b = a.equals ? a.equals(f) : Object.is(a, f));
...
v(wh, yf);
function yh(a) {
  if (!(((a.l.get(null) + 1) | 0) / S(a.l.o / 1e3) <= a.o))
    throw new vh("Query would cause " + M(a.A) + " to exceed " + a.o + " qps.")
      .j;
  a = a.l;
...
function Eh(a) {
  ...
  a != null
    ? "number" === typeof a
      ? ((a = S(a)), (a = Math.max(Math.min(a, 2147483647), -2147483648) | 0))
      : (a = a instanceof Xd ? S(a).K : a.Y)
    : (a = 100);
  this.o = a;
  this.j = R([], sf, rf);
}
...
function Oh(a, b, c) {
  ...
  d ||
    ((a = a.l), (c = b.j(c)), (d = new Lh()), (d.j = b), (d.l = c), a.push(d));
}
...
Nh.prototype.removeAll = function () {
  for (var a = R(this.l.pop(), Mh, Lh); a != null; )
    (a.j.l(a.l), (a = R(this.l.pop(), Mh, Lh)));
};
Nh.prototype.F = [
...
p.xa = function (a) {
  ...
  var b = [];
  if (typeof a === "string")
    ki(this, a) && (b = b.concat(this.j.get(ji(this, a))));
  else {
...
ui.prototype.add = function (a, b, c, d, e) {
  ...
  g > -1
    ? ((b = a[g]), c || (b.ja = !1))
    : ((b = new si(b, this.src, f, !!d, e)), (b.ja = c), a.push(b));
  return b;
};
...
function wi(a, b) {
  ...
  c in a.j &&
    eb(a.j[c], b) &&
    (ti(b), a.j[c].length == 0 && (delete a.j[c], a.l--));
}
...
function Ai(a, b, c, d, e) {
  ...
  c = Ci(c);
  return a && a[qi]
    ? a.listen(b, c, La(d) ? !!d.capture : !!d, e)
    : Di(a, b, c, !1, d, e);
}
...
function Bi(a, b, c, d, e) {
  ...
  c = Ci(c);
  return a && a[qi]
    ? a.l.add(String(b), c, !0, La(d) ? !!d.capture : !!d, e)
    : Di(a, b, c, !0, d, e);
}
function Ii(a, b, c, d, e) {
  if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Ii(a, b[f], c, d, e);
  else
    ((d = La(d) ? !!d.capture : !!d), (c = Ci(c)), a && a[qi])
  ...
  if (typeof a !== "number" && a && !a.removed) {
    ...
    if (b && b[qi]) wi(b.l, a);
      ...
      b.removeEventListener
        ...
        : b.detachEvent
          ? b.detachEvent(Gi(c), d)
          : b.addListener && b.removeListener && b.removeListener(d);
      zi--;
      (c = Ei(b))
        ? (wi(c, a), c.l == 0 && ((c.src = null), (b[xi] = null)))
        : ti(a);
    }
  }
}
...
p.dispatchEvent = function (a) {
  ...
  if (c)
    for (f = 0; !a.l && f < c.length; f++)
      ((g = a.currentTarget = c[f]), (e = Qi(g, d, !1, a) && e));
  return e;
};
p.N = function () {
  Z.W.N.call(this);
...
function Xi(a, b) {
  b > 0 &&
    a.o != 0 &&
    (b = Math.floor(b * (1 - a.o + Math.random() * a.o * 2)));
  return (a.l = b);
}
p.zb = function () {
  this.C = Date.now();
    ...
    ah(
      ...
      function (f) {
        if (!(f >= this.fa))
          return (
            this.O &&
              (a = V(a, "errorSender_enqueueTimeMs", Date.now().toString())),
            (f = {}),
            (f.u = a),
            (f.m = b),
            (f.c = c),
...
function cj(a, b) {
  ...
  try {
    ...
    a.O &&
      ((c = V(c, "errorSender_sendTimeMs", Date.now().toString())),
      (c = V(c, "errorSenderType", a.Ka())),
      b.errorSender_frontIndex &&
        (c = V(c, "errorSender_frontIndex", b.errorSender_frontIndex)),
      b.errorSender_nextIndex &&
        (c = V(c, "errorSender_nextIndex", b.errorSender_nextIndex)),
      b.errorSender_queueSize &&
        (c = V(c, "errorSender_queueSize", b.errorSender_queueSize)));
    a.X = b;
    var d = b.m,
      e = b.c,
      f = b.h;
    ...
    else throw If(g, { "docs-origin-class": "docs.debug.ErrorSender" });
  }
  return hh();
}
p.ob = function () {
...
uj.prototype.ga = function () {
  var a = new Map(),
    b,
    c = (b = this.j) == null ? void 0 : pj(tj(b));
  if (c == null ? 0 : vc(H(c, 2)) != null) {
    var d;
    (b = (d = xd(c, 2)) == null ? void 0 : d.toString()) &&
  ...
  (e =
    (h = this.j) == null
      ...
      : (k = I(h, oj, 1)) == null
        ? void 0
        : xd(k, 6)) && a.set("clientApp", String(e));
  return a;
};
function vj(a, b) {
  this.width = a;
  ...
  try {
    for (; !c.done; c = b.next()) {
      var g = c.value,
        h = Bj(g.key);
      h === 0
        ? (a.set("apps_telemetry.automation_property_present." + g.S, "true"),
          (e = !0))
        : h === 2 &&
          a.set(
            "apps_telemetry.automation_property_check_failed." + g.S,
            "true",
          );
    }
  } finally {
  ...
  try {
    for (; !h.done; h = g.next()) {
      ...
      if (!q.da) {
        ...
        t === "non_function_type" &&
          a.set(
            "apps_telemetry.native_function_tampering." + m + ".type",
            q.type,
          );
        f = !0;
      }
...
function zj() {
  return (
    "WorkerGlobalScope" in z &&
    typeof z.WorkerGlobalScope === "function" &&
    self instanceof z.WorkerGlobalScope
  );
}
function Bj(a) {
  if (zj() || !z) return 1;
...
function Dj(a, b, c) {
  try {
    ...
    return { da: !1, reason: "not_reachable" };
  }
  c = Ej(d);
  if (c !== "function") return { da: !1, reason: "non_function_type", type: c };
  try {
    var e = a.j(d);
  } catch (f) {
    return { da: !1, reason: "to_string_failed" };
  }
  a = Fj.exec(e);
  return a
    ? (a = a[1])
      ? a !== b
        ? { da: !1, reason: "likely_wrong_native_function" }
        : { da: !0 }
      : { da: !1, reason: "likely_bound_function" }
    : { da: !1, reason: "likely_non_native_source" };
}
function Ej(a) {
  switch (typeof a) {
    case "function":
...
function Qj(a, b) {
  return (b = a.j(b)) ? { ta: a.ta, la: a.la, Ba: b.toUpperCase() } : null;
}
function Rj() {
  Pj.call(this, 1, 1);
}
...
var Uj = [
  ...
  { errorMessage: "] is not a function", pa: !0 },
  { errorMessage: "(reading 'toLowerCase')", pa: !0, Z: ["__aiNetCmd__"] },
  { errorMessage: "Cannot read properties of undefined", Z: ["recaptcha"] },
  { errorMessage: "a is not defined", Ha: !0, Z: ["<anonymous>"] },
  { errorMessage: "i is not defined", Ha: !0, Z: ["<anonymous>"] },
  { errorMessage: "Failed to fetch", Z: ["__DLD__", "frontend.min.js"] },
  { errorMessage: "Maximum call stack size exceeded", rb: !0 },
...
function zk(a, b, c, d) {
  ...
  "apps_telemetry.processed" in d &&
    (d["apps_telemetry.multi_processed"] = "true");
  var e = a.ga();
...
yk.prototype.ga = function () {
  ...
  try {
    ...
    try {
      for (; !c.done; c = b.next())
        c.value.ga().forEach(function (e, f) {
          a.set(f, e);
        });
    } finally {
      c && !c.done && (d = b.return) && d.call(b);
...
p.N = function () {
  this.j &&
    (this.o && ((this.o = !1), (this.v = !0), this.j.abort(), (this.v = !1)),
    ll(this, !0));
  fl.W.N.call(this);
};
p.Qa = function () {
...
function ml(a) {
  if (a.o && typeof Ga != "undefined")
    if (a.G && (a.j ? a.j.readyState : 0) == 4) setTimeout(a.Qa.bind(a), 0);
      ...
      (a.dispatchEvent("readystatechange"), (a.j ? a.j.readyState : 0) == 4)
    ) {
      a.o = !1;
      try {
        fj(a)
...
function fj(a) {
  ...
  if (!c) {
    if ((b = b === 0))
      ((a = String(a.M).match(Vf)[1] || null),
        !a &&
          z.self &&
          z.self.location &&
          (a = z.self.location.protocol.slice(0, -1)),
        (b = !gl.test(a ? a.toLowerCase() : "")));
    c = b;
  }
  return c;
}
  ...
  if (a.l) {
    ...
    d.call(
      ...
      vl(e.getFullYear() - 2e3) +
        ...
        vl(e.getSeconds()) +
        "." +
        vl(Math.floor(e.getMilliseconds() / 10)),
      "] ",
    );
  }
  d = c.push;
...
function yl(a) {
  ...
  this.Xa = a.M;
  var c = a.l;
  this.Ua = (a.v || Ik)({ Bb: lj, yb: mj, ua: [new Kk()] });
  this.cb = a.P;
  this.V = new mi();
  var d = new fl();
  Al(this, c);
...
function Bl(a) {
  ...
  if (Fl) {
    if (Gl != null)
      throw Error('ErrorReporter already installed. at "' + Gl.stack + '"');
  ...
  a.M.listen(a.j, "c", function (e) {
    ...
    var g = e.aa.severity;
    (g = g == "fatal" || g == "postmortem") &&
      !a.gb &&
      (a.ib && !f ? a.V.notify(e, e.aa) : a.V.notify(void 0, e.aa));
  ...
  if (a && typeof a === "object" && a.type === "error") {
    ...
    b =
      typeof a === "string"
        ...
        : typeof a === "number"
          ? Error("Unhandled " + b + " with number: " + a)
          : a == null
...
function Nl(a, b) {
  if (
    ...
    (a.constructor.name ? a.constructor.name : Ff(a.constructor)) === "Object"
  ) {
    b.unknownErrorToStringResult = Object.prototype.toString.call(a);
    for (
      var c = JSON, d = c.stringify, e = {}, f = Object.keys(a), g = 0, h = 0;
      h < f.length && g < 10;
      h++
    ) {
      var k = f[h];
      try {
        typeof a[k] !== "function" &&
          ((e[k] = String(a[k]).substring(0, 100)), g++);
      } catch (l) {}
    }
...
function Hl(a, b, c, d) {
  ...
  try {
    ...
    throw (
      e && !a.O && (a.H = !1),
      (a.C = !0),
      (c.provideLogDataError = g.message),
    ...
    if (
      ...
      (c.severity = "" + c["severity-unprefixed"]),
      !a.Va)
    )
      for (var f in c)
        typeof c[f] === "number" ||
...
yl.prototype.X = function (a, b, c) {
  ...
  c = b.severity || "fatal";
  (d = b.reportSeverity || (a && a.reportSeverity)) &&
    (d = Ol(d.toLowerCase())) &&
    (c = d);
  ...
  if (g.trim().length == 0 || g == "Not available")
    ((b["stacklessError-reportingStack"] = Hf(yl.prototype.X)),
      [a.message]
        .concat(pa(Object.keys(b)), pa(Object.values(b)))
        .some(function (h) {
  ...
  this.C && !this.O
    ? ((this.H = this.A),
      c == "fatal"
        ? (c = "postmortem")
        : c == "incident" && (c = "warningafterdeath"))
    : c == "fatal" && (this.C = !0);
  this.A = !1;
  b.severity = c;
};
      ...
      new ua(function (u) {
        switch (u.j) {
          ...
          case 2:
            t = u.L();
            b.j = 3;
            x = Error("Failed to initialize crash storage", { cause: t });
...
Ul.prototype.Pa = function (a, b) {
  ...
  if ((c = this.l === 1 && !!b && !!c && b.toUpperCase() !== c.toUpperCase()))
    this.l = 2;
  if (a || c)
    ((c = od(this.j, sj, 3)),
      (b = new rj()),
...
p.nb = function (a) {
  if (
    ...
    this.A ||
      ...
      (this.readyState = 2),
      Zl(this)),
    this.j && ((this.readyState = 3), Zl(this), this.j))
  )
    if (this.responseType === "arraybuffer")
      a.arrayBuffer().then(this.lb.bind(this), this.ma.bind(this));
...
p.kb = function (a) {
  if (this.j) {
    if (this.L && a.value) this.o.push(a.value);
      ...
      if ((b = this.R.decode(b, { stream: !a.done }))) this.o = this.v += b;
    }
...
p.getAllResponseHeaders = function () {
  if (!this.A) return "";
  for (var a = [], b = this.A.entries(), c = b.next(); !c.done; )
    ...
    ? ((d = b(c)),
      d.wa()
        ? ((b = a.reject),
          ...
          (d = d.wa()),
          (d = yd(d, 1)),
          b.call(a, c("Error from Offscreen page:" + d)))
        : a.resolve(d))
    : a.reject(
        Error(
          "No response from Offscreen page:" +
            (d.lastError ? d.lastError.message : "without lastError"),
        ),
      );
}
function nm() {
...
function pm(a) {
  return qm({ offlineOptedIn: !0 }).then(function () {
    if (a) {
      var b = {};
...
function rm() {
  return qm({ offlineOptedIn: !1 }).then(function () {
    return sm();
  });
}
function tm() {
...
function Fg() {
  return om(chrome.storage.managed, ["allowedDocsOfflineDomains"]).then(
    function (a) {
      return a && a.allowedDocsOfflineDomains
        ? a.allowedDocsOfflineDomains
        : [];
    },
  );
}
function Gg() {
  return om(chrome.storage.managed, ["autoEnabledDocsOfflineDomains"]).then(
    function (a) {
      return a && a.autoEnabledDocsOfflineDomains
        ? a.autoEnabledDocsOfflineDomains
        : [];
    },
  );
}
...
function um() {
  return om(chrome.storage.local, ["lastSuccessfulFrameConnectTime"]).then(
    function (a) {
...
function Pm(a) {
  return chrome.offscreen.createDocument(a.G).catch(function (b) {
    if (
      b instanceof Error &&
      b.message.includes("Only a single offscreen document may be created")
    )
      cm(a.j, b);
...
function Rm(a, b) {
  var c = { sendingFrameRequestType: xd(b, 1) },
    d = Cm(Bm(new Am(), 4), b);
  return Jm(Sm(a, d, c, 0)).catch(function (e) {
    if (e instanceof Error) {
      ...
      if ("Requests cancelled because user has been opted out" == e.message)
        return Promise.resolve(new fm());
    }
...
function Km(a, b) {
  xd(b, 1) == 6 || xd(b, 1);
  var c = { sendingOffscreenDocumentRequestType: xd(b, 1).toString() };
  return Ag(Nm(a, c))
    .then(function () {
      return Si();
    })
    ...
    .T(function (d) {
      return d instanceof Error && Tm(d.message)
        ? (cm(a.j, d, c),
          Ag(Gm())
            .then(function (e) {
              c[Om(1)] = e.toString();
...
function Tm(a) {
  return (
    ...
    a.includes("The message port closed before a response was received.") ||
    a.includes(
...
function jn(a, b, c) {
  return gi(
    gi(Wh(hn(a), "/offline/extension/report"), "v", c),
    "optin",
    b,
  ).toString();
}
...
function kn(a, b) {
  ...
  return new X(function (c) {
    chrome.alarms.get("heartbeat", function (d) {
      d || chrome.alarms.create("heartbeat", { periodInMinutes: 5 });
      (d && !b) ||
        ln(a, "heartbeat").T(function (e) {
          dm(a.l, T(e), { context: "startHeartbeat_triggerAlarm" });
        });
      c();
    });
  });
...
p.pb = function () {
  ...
  return um()
    .then(function (b) {
      a.j.o.lastSuccessfulFrameConnectTime =
        (b == null ? void 0 : b.toString()) || "null";
    })
    .then(function () {
      return tm();
    })
...
function nn(a, b, c) {
  a.H &&
    ((b = jn(a, b, c)),
    z
      .fetch(new Request(b, { method: "post", mode: "cors" }))
      .then(n())
      .catch(function (d) {
        Kl(a.j, T(d));
      }));
...
p.ub = function (a) {
  var b = this,
    c = a.j;
  c && c.data && c.ports && c.ports.length
    ? ((a = new Ym(c.data)),
      on(this, a, c.ports.length > 1 ? c.ports[1] : void 0)
        .then(function (d) {
          c.ports[0].postMessage(Mc(d));
        })
        .T(function (d) {
          dm(b.l, T(d), { context: "onMessageFromOfflineFrame_postMessage" });
        }))
    : dm(this.l, Error("Dropped invalid event."), { event: String(a) });
};
function en(a, b, c) {
  var d = new Ym(b);
  on(a, d)
...
p.tb = function (a, b, c) {
  ...
  switch (zd(a)) {
    case 3:
      ...
      pm(a)
        .then(function () {
          return qm({ lastSuccessfulFrameConnectTime: parseInt(f, 10) });
        })
        .then(function () {
          var h = d.o;
          h.o = !0;
        ...
        .T(function (h) {
          dm(d.l, T(h), { context: "saveFrameConnectInfo" });
        });
      break;
    case 7:
      var g = km(7);
      ...
      (a ? pn(this, a) : qn(this))
        ...
        .T(function (h) {
          dm(d.l, T(h), { context: "detectUserIsOptedOut" });
        });
      break;
    default:
  ...
  switch (zd(a)) {
    case 1:
      return (
        ...
        pm(a)
          .then(function () {
            return qm({ lastSuccessfulFrameConnectTime: Date.now() });
          })
          .then(function () {
            var f = b.o;
            f.o = !0;
    ...
    case 3:
      return (a = I(a, zm, 3)) && wd(a, 1)
        ? ((a = wd(a, 1)),
          pn(this, a).then(function () {
            return c;
          }))
    ...
    case 4:
      return (
        (a = I(a, ym, 4)),
        Ag(Rm(this.o, a)).then(function (f) {
          sd(c, fm, 3, f);
          return c;
        })
      );
...
function pn(a, b) {
  return a.M
    ? Ag(Fm(a.o))
    : (cm(a.l, Error("Extension frame connected with the wrong OUID.")),
      (a.M = !0),
      Ag(Mm(a.o, b)));
}
function qn(a) {
