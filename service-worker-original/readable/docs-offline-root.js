...
var fb = !!((Ja[0] >> 24) & 1),
  ...
  hb = !!((Ja[0] >> 26) & 1),
  ib = !!(Ja[0] & 4096);
var jb = fb ? hb : Ha(610401301, false),
  kb = fb ? gb || !ib : Ha(748402147, true);
function lb() {
  var a = K.navigator;
...
function qb() {
  return jb ? !!mb && mb.brands.length > 0 : false;
}
function rb() {
...
var Ec = { oe: { value: 0, configurable: true, writable: true, enumerable: false } },
    ...
    if (h)
      for (var x in h) {
        ...
        var y = c,
          ...
          D = e,
          Y = +x;
        if (!(!Number.isFinite(Y) || Y < r || Y < B || ae(Y, f, q, r, y, z, B, I, D, 2)))
          return false;
      }
    if (k)
      for (var aa in k)
        if (
          ((x = h && aa in h) ||
            ...
            (I = e),
            (D = +aa),
            (x = !Number.isFinite(D) || D < q || D < z ? true : ae(D, x, f, q, r, y, z, B, I, 2))),
          !x)
        )
          return false;
    return true;
...
function df(a, c, e, f, g, h, k, l) {
  ...
  if ((l = !(4 & r))) {
    var x = a,
      ...
      z = !!(2 & r);
    z && (y |= 2);
    for (var B = !z, I = true, D = 0, Y = 0; D < x.length; D++) {
      var aa = Sd(x[D], f, false, y);
      if (aa instanceof f) {
        if (!z) {
          var Va = Oc(aa);
          B && (B = !Va);
...
function wf(a, c) {
  ...
  if (a.constructor === Uint8Array) return new vf(a, false);
  if (a.constructor === ArrayBuffer) return ((a = new Uint8Array(a)), new vf(a, false));
  if (a.constructor === bc) return ((c = hc(a) || new Uint8Array(0)), new vf(c, true, a));
...
function ng(a) {
  ...
  g &&
    ...
    (g = a[++h]),
    typeof g === "function" &&
      ((f.qe = true), lg != null || (lg = g), mg != null || (mg = a[h + 1]), (g = a[(h += 2)])));
...
C.equals = function (a) {
  return a == null ? false : this.W == a.W && this.T == a.T;
};
...
function Hg(a) {
  return (
    a.ld ||
    (Object.defineProperties(a, { ld: { value: (Mh = (Mh + 1) | 0), enumerable: false } }), a.ld)
  );
}
function Ah(a, c) {
    ...
    if (e)
      for (
        var g = function (l, p, q) {
            e--;
            f[l] = p ? { ee: true, value: q } : { ee: false, reason: q };
            e == 0 && c(f);
          },
          h,
          k = 0;
...
Vi.prototype.$goog_Thenable = true;
function fj(a, c) {
  c = yi(c);
  c = Zi(c, c);
  c.A = true;
...
function cj(a, c, e, f) {
  if (a instanceof Vi) return (gj(a, Zi(c || Si, e || null, f)), true);
  if (Ui(a)) return (a.then(c, e, f), true);
  if (Ma(a))
    try {
      var g = a.then;
      if (typeof g === "function") return (nj(a, g, c, e, f), true);
    } catch (h) {
...
C.cancel = function (a) {
  if (this.j) this.v instanceof qj && this.v.cancel();
    ...
    this.R ? this.R.call(this.K, this) : (this.I = true);
...
qj.prototype.$goog_Thenable = true;
function Cj(a) {
...
function tj(a) {
  ...
  f &&
    ((l = Sa(a.td, a, true)),
    (f = Sa(a.td, a, false)),
    c instanceof qj ? (yj(c, l, f), (c.S = true)) : c.then(l, f));
...
function Yj(a, c, e, f, g) {
  ...
  (f = e.o) && Yj(a, c, f, "Caused by: ", false);
  var h;
  e.F ? (h = e.F.j(Pg([0], Tg, ah))) : (h = Pg([0], Tg, ah));
  e = h;
  for (h = 0; h < e.length; h++) Yj(a, c, e[h], "Suppressed: ", false);
...
function Gk(a) {
  ...
  if (Error.captureStackTrace) {
    Error.captureStackTrace(c, a || Gk);
    c = String(c.stack);
  } else {
    try {
      throw c;
...
F(sl, R);
function tl(a, c) {
  if (Gg(a, c)) return true;
  if (!a || !c) return false;
  var e = a.length;
  if (e != c.length) return false;
  for (var f = 0; f < e; f = (f + 1) | 0) if (!ul(a, c, f)) return false;
  return true;
}
function ul(a, c, e) {
  var f = hl(a[e]),
    g = hl(c[e]);
  if (!Gg(f, g)) return false;
  switch (f) {
    case "null":
      return true;
    case "boolean":
...
function Cl(a, c) {
  ...
  if (a == null) return "";
  var e;
  if ((c = "number" === typeof a && ((e = a), true))) c = sh(e).equals(sh(e));
  var f;
  c ? (f = "" + sh(e)) : (f = S(a));
  return f;
}
...
function El(a, c) {
  ...
  Th(hl(a), "object");
  var e;
  return a instanceof Array && ((e = a), true) ? e.concat() : ml(a);
}
function Gl(a, c) {
  a = Hl(a, c);
...
function Ll(a, c, e, f) {
  ...
  if (g == null) f = e == null;
    ...
    var h;
    f = Rg(e) && ((h = e), true) ? Ah(g, h.j) : Ah(g, e);
  }
...
var Fm = 0;
function Hm() {
  this.v = this.H = this.L = this.I = false;
  this.D = 0;
}
F(Hm, R);
...
function Xm(a, c) {
  if (c == null || !Gg(Oh(c), Oh(a))) return false;
  var e = Ym(a);
  if (e.length != Ym(c).length) return false;
  for (var f = 0; f < e.length; f++) {
    var g = e[f];
    if (!zh(a[g], c[g])) return false;
  }
  return true;
}
function Ym(a) {
...
C.Z = function (a) {
  return gn(a) ? xk(this.ba(), a.B) >= 0 : false;
};
function hn(a) {
  this.v = a;
}
...
ln.prototype.Vc = function (a, c) {
  ...
  true === c && ((a = wh(nn.j()) - e), this.j.C("md", a));
  return f;
};
function mn() {
  mn = u();
...
C.createDocument = function (a, c, e) {
  a = new tn(a, c, true, this.be, this.wc[c]);
      ...
      if (!a.A) {
        for (var p = JSON.stringify(l), q = [], r = 0; r < p.length; r = (r + 1) | 0) {
          ...
          y >= 55296 && y <= 56319
            ...
            : z &&
              (r > 0
                ? ((x = Sh(p, (r - 1) | 0)), (x = !(x >= 65536 && x <= 1114111)))
                : (x = true));
          x &&
            q.push(
              new yo(
...
kp.prototype.nc = function (a) {
  var c = sn(a.B);
  return c.length == 0 ? [] : [new Dn(a.X(), a.Aa(), c, true)];
};
kp.prototype.Aa = w("j");
function lp(a, c) {
  W.call(this);
...
op.prototype.Z = function (a) {
  return W.prototype.Z.call(this, a) ? (Th(a.getType(), "update-record") ? a.o : true) : false;
};
function qp(a, c) {
  ...
  a instanceof gq
    ...
    : a && (c = String(a).match(Mk))
      ? ((this.B = false),
        ...
        kq(this, c[6] || "", true),
        lq(this, c[7] || "", true))
      : ((this.B = false), (this.o = new nq(null, this.B)));
}
gq.prototype.toString = function () {
  var a = [],
    c = this.A;
  c && a.push(oq(c, pq, true), ":");
  var e = this.v;
  if (e || c == "file") {
    a.push("//");
    (c = this.F) && a.push(oq(c, pq, true), "@");
    a.push(encodeURIComponent(String(e)).replace(/%25([0-9a-fA-F]{2})/g, "%$1"));
    e = this.C;
    e != null && a.push(":", String(e));
  }
  if ((e = this.j)) {
    this.v && e.charAt(0) != "/" && a.push("/");
    a.push(oq(e, e.charAt(0) == "/" ? qq : rq, true));
  }
...
er.prototype.dispatchEvent = function (a) {
  ...
  a.o ||
    ((k = a.currentTarget = c), (g = fr(k, f, true, a) && g), a.o || (g = fr(k, f, false, a) && g));
  if (e)
...
function pr(a, c, e, f) {
  ...
  for (var g = 0; g < e.length; g++) {
    var h = Pq(c, e[g], f || a.handleEvent, false, a.o || a);
    if (!h) break;
    a.j[h.key] = h;
  }
  return a;
...
function vr(a, c) {
  ...
  try {
    ...
    if (wk(k) instanceof rp) a.Y = true;
...
function sr(a) {
  a.I != 1 || a.A.isActive() ? a.A.start() : lr(a.A, true, true);
}
C.N = function () {
...
function $r(a, c, e) {
  try {
    ...
    return { Na: false, reason: "not_reachable" };
  }
  e = as(f);
  if (e !== "function") return { Na: false, reason: "non_function_type", type: e };
  try {
    var g = a.j(f);
  } catch (h) {
    return { Na: false, reason: "to_string_failed" };
  }
  a = bs.exec(g);
  return a
    ? (a = a[1])
      ? a !== c
        ? { Na: false, reason: "likely_wrong_native_function" }
        : { Na: true }
      : { Na: false, reason: "likely_bound_function" }
    : { Na: false, reason: "likely_non_native_source" };
}
function as(a) {
  switch (typeof a) {
    case "function":
...
var qs = [
  ...
  { errorMessage: "] is not a function", Ab: true },
  { errorMessage: "(reading 'toLowerCase')", Ab: true, Ca: ["__aiNetCmd__"] },
  { errorMessage: "Cannot read properties of undefined", Ca: ["recaptcha"] },
  { errorMessage: "a is not defined", yd: true, Ca: ["<anonymous>"] },
  { errorMessage: "i is not defined", yd: true, Ca: ["<anonymous>"] },
  { errorMessage: "Failed to fetch", Ca: ["__DLD__", "frontend.min.js"] },
  { errorMessage: "Maximum call stack size exceeded", re: true },
...
function Ns(a, c) {
  ...
  try {
  ...
  } catch (z) {
    {
      g = false;
      a = Bs(z, e);
      f.set("apps_telemetry.handling_error", os(a));
    }
  }
...
function Os(a, c) {
  return Js.has(c.toUpperCase()) ? (a.j = true) : false;
}
function Ms(a) {
  var c = [];
  a = G(a);
...
function Us(a, c) {
  ...
  k = k === void 0 ? Ts() : k;
  e = e.Ee;
  this.v = Ls(c, f, h === void 0 ? false : h, e === void 0 ? A(true) : e);
...
C.abort = function () {
  ...
  this.readyState >= 1 && this.j && this.readyState != 4 && ((this.j = false), Dt(this));
  this.readyState = 0;
};
C.me = function (a) {
  if (
...
function Qt(a, c, e, f) {
  ...
  k = new Ht();
  Kt.push(k);
  k.v.add("ready", k.Td, true, void 0, void 0);
  k.send(a, c, e, g);
}
function Tt(a, c) {
  a.C = c;
...
function Bu(a, c, e, f, g, h) {
  ...
  for (c = this.P = 0; c < a.length; c++)
    yj(a[c], Sa(this.O, this, c, true), Sa(this.O, this, c, false));
...
function Nu(a, c, e, f, g, h, k, l) {
  rr.call(this, a, e, f, g, h, k, l === void 0 ? true : l);
  var p = this;
  this.M = c || "default";
  this.K = c + "-v";
  this.D = c + "-f";
...
wv.prototype.j = function (a, c, e) {
  var f = this;
  a = new Zn(null, this.A, Date.now(), oe(a), true, this.v);
  this.B.write(
    [a],
    13,
    c,
        ...
        case "document":
          ...
          if (p == null) Je(k, r, 3);
            ...
            for (z = 0; z < p.length; z++) {
              ...
              var I = Dd(q);
              Object.is(q, I) ||
                (B && ((p = sd(p)), (y = 0), (x = Pe(x, r)), (B = false)), (p[z] = I));
            }
...
function Ov(a, c, e, f, g, h, k, l, p, q, r) {
  ...
  this.I > 0 &&
    ...
    this.j.start());
  this.P.onsuccess = hu(this.v, this.Y, this, true);
  this.P.onerror = hu(this.v, this.S, this, true);
  switch (c) {
    case "read":
      this.C.F++;
      break;
...
Ov.prototype.S = function (a) {
  ...
  e = c.j[f];
  delete c.j[f];
  e && ((f = c.o), (e.o = false), (e.j = f), bw(c, e));
...
function jw(a, c, e, f, g, h, k, l) {
  Ov.call(this, a, "open", c, e, new gw(c), new ew(), f, h, true, k, l);
  this.H = this.D = null;
  this.V = g;
  a.onblocked = hu(c, this.U, this, true);
  a.onupgradeneeded = hu(c, this.ca, this, true);
}
F(jw, Ov);
...
function pw(a) {
  var c = new Zv(function (e) {
    Bb(a.j, e) && a.j.length === 0 && !a.o && ((a.o = true), a.v());
  });
  a.j.push(c);
  return c;
}
  ...
  this.A = new $v(
    function () {
      if (!D.j.o) {
        ...
        D.A.dispose();
        D.S && (sw(D, true), D.S(), (D.F.oncomplete = null));
      }
    },
    this.V,
    document,
...
C.open = function () {
  if (this.ca != null) {
    var a = U(this.D, "docs-intli") ? this.ia : true;
  ...
  e.onerror = hu(this.o, this.Od, this, true);
  this.F = e;
  this.C.add(this);
};
function Vv(a) {
...
function Cw(a, c, e, f, g) {
  ...
  lw(c, function (l) {
    ...
    l.onabort = l.onerror = hu(k, f, {}, true);
    e(l);
  });
  cw(c, f);
  kw(c, function (l) {
...
function Ww(a, c) {
  var e = new tn(c.id, c.documentType, false, a.o);
  V(e, "title", c.title);
  ...
  if (!a.wc[e.getType()]) {
    ...
    throw Hk(a, {
      ...
      localStoreDoc_id: k,
      localStoreDoc_isCreated: (true !== l).toString(),
  ...
  switch (a.getType()) {
    case "update-record":
      a.o
        ? ((a = a.j),
          f.add(a),
          (this.L || this.C) && this.j && ((f = this.j), Lw(f, a), (f.D = true)),
          Z(e))
        : ((c = this.j) == null
            ? (c = 0)
            : c.j != null
...
function Zw(a, c, e) {
  Uv(Lv(X(c, "PendingQueueCommands"), [a], [a, []]), function (f) {
    f.target.result ? e(true) : $w(a, c, e);
  });
}
function $w(a, c, e) {
...
bx.prototype.j = function (a, c, e, f, g, h, k) {
  return new Sw(a, c, e, f, g, h, k === void 0 ? false : k);
};
...
function dx(a, c, e) {
  ...
  Tv(
    ...
    function (f) {
      ...
      var h = new En(g, false, a.ja);
      g = a.za(g);
      var k = f.jobset;
      k != null && V(h, "jobset", k);
      k = f.ic;
      k != null && ((g = g.Vc(k)), (h.D = g.slice(0)), (h.B = true));
...
Ex.prototype.j = function (a, c, e, f, g, h, k) {
  ...
  if (k !== void 0) {
    for (var l in c) {
      h = c[l];
      yb(e, l) >= 0 ? (k[l] = h != null ? h : null) : (k[l] = h);
    }
    Hv(a, k);
    Z(f);
    g != null && Mw(g, c, e);
...
function Hx(a, c, e) {
  if (a.j.v) hr(Ta(c, []));
    ...
    e = Bw(a.j, ["Users"], 71, e, false, void 0, void 0, void 0, 1337522, true);
    var f = [];
    Uv(X(e, "Users").get(Xv.lowerBound(-Infinity)), function (g) {
      if ((g = g.target.result)) {
        var h = new mp(g.id, false, a.ja);
...
function io(a, c, e, f, g, h, k) {
  ...
  if (a.j.v) hr(f);
    ...
    e = Bw(a.j, q, e, g, true, p, void 0, void 0, h, k, l);
    vw(e, f);
    f = [];
...
function Ux(a, c, e, f, g, h, k, l, p, q) {
  Ix.call(this, a, c, e, f, g, h, k, l, p, q === void 0 ? false : q);
  a = this.j;
  e = this.A;
...
function Wx(a, c, e, f, g, h, k) {
  Sw.call(this, a, c, e, f, g, h, k === void 0 ? false : k);
}
F(Wx, Sw);
...
Xx.prototype.j = function (a, c, e, f, g, h, k) {
  return new Wx(a, c, e, f, g, h, k === void 0 ? false : k);
};
function Yx(a, c, e, f, g, h, k, l, p, q) {
  k = k === void 0 ? new Xx() : k;
  Ux.call(this, a, c, e, f, g, h, k, l, p, q === void 0 ? false : q);
  this.Ka = new Vx(this.j, this.A, this.o, h);
  Ro(this, this.Ka);
}
F(Yx, Ux);
Yx.prototype.ib = A(7);
Yx.prototype.lc = A(true);
...
function by(a, c, e, f, g, h, k, l, p, q, r) {
  Yx.call(this, a, c, f, g, h, l, void 0, p, q, r === void 0 ? false : r);
  a = ["kix", "punch", "ritz"];
  c = this.j;
...
function vz(a, c, e) {
  for (c += 1; c <= e; ++c) if (a.o[c] == null || !a.o[c].lc()) return false;
  return true;
}
...
ey.prototype.M = function () {
  ...
  if ((a = this.o[a])) {
    ...
    this.B.info(Error("Gc`" + (this.j ? Aw(this.j) : -1)));
    pk(this.C, null);
  }
};
function tz(a) {
...
function Az(a) {
  a.j && al(a.j);
  var c = Bl(a.o, "lssv");
  return new ey(a.B, a.K, 0, a.Vd.bind(a), c, true, new kx(), a.I, a.D, a.o);
}
function Bz(a) {
  if (a.v) return a.v;
  a.v = Cz(a);
...
/** RootRequestParser（原 OA）。
 * 通用入口请求解析器；本地路由与网络策略共享解析结果。
 */
function RootRequestParser(a) {
  this.j = a;
}
RootRequestParser.prototype.Ac = function (a) {
...
function PA(a) {
  ...
  return (a = c === "/open" ? a.o.get("id") : null)
    ? new IA("/edit", "unknown", a, false, false, false, e)
    : null;
}
function QA(a) {
  var c = Lp(Ip(a.j));
  a = a.o.get("usp");
  return (c = SA[c]) ? new IA("/", c, void 0, false, true, false, a) : null;
}
function RA(a) {
  var c = a.o.get("usp");
  return a.j === "/create" ? new IA("/create", "kix", void 0, true, false, false, c) : null;
}
...
TA.prototype.Ac = function (a) {
  ...
  c = this.getType();
  var f = Xk(a, "usp");
  if (LA(this.j, e)) return new IA(e, c, void 0, true, false, false, f);
  if (MA(this.j, e)) return new IA(e, c, void 0, false, true, false, f);
  if (this.j.o.F == e) return new IA(e, c, void 0, false, true, true);
  if (this.j.o.B == e) return new IA(e, c, void 0, false, false, true);
  if (NA(this.j, e)) {
    b: {
      try {
    ...
    return new IA(e, c, a, false, false, true);
  }
  l = e;
  k = new gq(a);
  e = k.o.get("usp");
  ...
  ab(a, "/d/")
    ? ((l = a.indexOf("/", 3)),
      ...
      (c = new IA(a, c, k, false, false, false, e)))
    : (c = (l = k.o.get("id")) ? new IA(a, c, l, false, false, false, e) : null);
...
function yC(a, c, e, f) {
  ...
  var g = g === void 0 ? {} : g;
  var h = e.ab;
  var k = c.j ? (c.j && c.j.o.includes("offline/iframeapi") ? false : true) : false;
  ...
  c && k
    ? (U(a.A, "docs-sw-erdcbnc"), (f = h && h instanceof xz && h.v ? false : true))
    : (f = false);
  f
    ? ((e = h || Error(aB(e.j))), a.o != null ? ru(a.j, e, a.o, g, false, 2) : Zt(a.j, e, g))
    : h && vC(a, h, g);
}
function zC(a) {
...
function vC(a, c, e) {
  a.o != null ? ru(a.j, c, a.o, e, false, 1) : gu(a.j, c, e);
}
function tC(a, c, e) {
  a.o != null
    ? ru(a.j, c, a.o, e, false, 0)
...
/** LocalEditorRedirectHandler（原 HC）。
...
function ED() {
  ...
  this.v = k;
  BD(this.v, h);
  this.o.addEventListener("install", hu(this.j, this.D, this), false);
  this.o.addEventListener("fetch", hu(this.j, this.C, this), false);
  this.o.addEventListener("activate", hu(this.j, this.F, this), false);
  this.o.addEventListener("message", hu(this.j, this.L, this), false);
}
...
if (U(dv, "docs-eiltdw")) MD = new Nm();
  ...
  if (LD && Vm && (OD || Tm !== "rootmain.js") && ND) {
    ...
    gu(ND.j, PD.J, null, false);
  }
  Vm = true;
  MD = OD;
}
var xv = new zz(ev, null, dv, KD, MD, void 0, void 0, true);
ev.o.sid = ID;
var QD,
  qv,
  fv = (function (a) {
...
if (U(dv, "docs-eil")) {
  ...
  WD = new aC();
  VD = new PB(WD, new VB(WD, TD.A, TD.v, TD.o, null), false);
  var fE = VD.Ob(),
    gE = Cl(dv, "buildLabel");
  if (fE.o == null) {
    fE.o = new tB();
...
/** rootWorkerServices（原 FD）。
 * 根 SW 的最终服务装配；不代表实际注册 scope 已经确认。
 */
var gD = IE,
  rootWorkerServices = new (function () {
    var a = XC,
      c = fD,
      e = dv,
      f = new QC(a, e),
      g = ZA(e);
    e = new LocalEditorRedirectHandler(g, e);
    this.o = new BC(a, new RootRequestParser(g));
    this.j = mC;
    this.v = new RootFetchStrategyChain(e, f, new lC(c));
  })();
new ED();
