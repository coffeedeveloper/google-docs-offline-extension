...
function ya(a, c, e, f) {
  try {
    ...
    sa(g);
    if (!g.done) return ((a.j.I = false), g);
    var h = g.value;
  } catch (k) {
...
function za(a) {
  for (; a.j.j; )
    try {
      var c = a.o(a.j);
      if (c) return ((a.j.I = false), { value: c.value, done: false });
    } catch (e) {
      {
        a.j.D = void 0;
        ua(a.j, e);
  ...
  this.throw = function (c) {
    ...
    if (a.j.v) {
      ...
      if (e) var f = ya(a, e, c, a.j.F);
        ...
        try {
          {
            c["return"] && ((f = c["return"]()), sa(f));
            ua(a.j, new TypeError("g"));
          }
        } catch (g) {
          ua(a.j, g);
        }
...
C("WeakMap", function (a) {
  ...
  c.prototype.delete = function (p) {
    return f(p) && qa(p, k) && qa(p[k], this.j) ? delete p[k][this.j] : false;
  };
  return c;
});
C("Map", function (a) {
...
var pb = !!((La[0] >> 24) & 1),
  ...
  rb = !!((La[0] >> 26) & 1),
  sb = !!(La[0] & 4096);
var tb = pb ? rb : Ja(610401301, false),
  ub = pb ? qb || !sb : Ja(748402147, true);
function vb() {
  var a = I.navigator;
...
function Ab() {
  return tb ? !!wb && wb.brands.length > 0 : false;
}
function Bb() {
...
function Pb(a, c) {
  if (!Na(a) || !Na(c) || a.length != c.length) return false;
  for (var e = a.length, f = Qb, g = 0; g < e; g++) if (!f(a[g], c[g])) return false;
  return true;
}
function Qb(a, c) {
  return a === c;
...
function wc(a, c) {
  ...
  else if (!(c instanceof pc)) return false;
  return uc(a, c);
}
var rc;
function xc(a, c, e) {
...
var Fc = Ec("jas", void 0, true),
  ...
  Nc = Ec("m_m", "Tf", true),
  Oc = Ec();
var Pc = { He: { value: 0, configurable: true, writable: true, enumerable: false } },
...
var ad = {};
function bd(a) {
  return !Array.isArray(a) || a.length ? false : (a[K] | 0) & 1 ? true : false;
}
...
function ie(a, c, e, f) {
  ...
  if (a.constructor === Array) {
    ...
    l = l - g - +!!h;
    p = p - g - +!!k;
    for (var r = 0; r < q; r++) if (!me(r - g, a, h, l, c, k, p, g, e, f)) return false;
    if (h)
      for (var w in h) {
        f = a;
        q = h;
        ...
        var y = c,
          ...
          J = e,
          W = +w;
        if (!(!Number.isFinite(W) || W < r || W < B || me(W, f, q, r, y, z, B, F, J, 2)))
          return false;
      }
    if (k)
      for (var ha in k)
        if (
          ((w = h && ha in h) ||
            ...
            (F = e),
            (J = +ha),
            (w = !Number.isFinite(J) || J < q || J < z ? true : me(J, w, f, q, r, y, z, B, F, 2))),
          !w)
        )
          return false;
    return true;
...
function me(a, c, e, f, g, h, k, l, p, q) {
  ...
  g = ne(a, g, h, k, l);
  q = q === 1;
  if ((g == null && bd(c)) || (c == null && bd(g))) return true;
...
function ke(a, c) {
  ...
  for (var g = 0, h = 0; g < e && h < f; ) {
    ...
    for (var p = l[0]; g < e - 1 && je((k = a[g + 1])[0], p); ) {
      g++;
      l = k;
    }
    var q = void 0;
    ...
    for (var r = k[0]; h < f - 1 && je((q = c[h + 1])[0], r); ) {
      h++;
      k = q;
    }
    if (!je(p, r)) return false;
    p = void 0;
    if (!je(l[1], k[1], (p = void 0) == null ? void 0 : p.j(2))) return false;
    g++;
    h++;
  }
  return g >= e && h >= f;
...
function Me(a) {
  var c = a.G,
    e = c[K] | 0;
  return $c(a, e) ? (Ke(a, c, e) ? Le(a, c, true) : new a.constructor(Je(c, e, false))) : a;
}
function Ne(a) {
  if (a.j !== ad) return false;
  var c = a.G;
  c = Je(c, c[K] | 0);
  Uc(c, 2048);
  a.G = c;
...
function Ke(a, c, e) {
  return e & 2 ? true : e & 32 && !(e & 4096) ? (Tc(c, e | 2), (a.j = ad), true) : false;
}
var Qe = nd(0),
  Re = {};
...
function qf(a, c, e, f, g, h, k, l) {
  ...
  if ((l = !(4 & r))) {
    var w = a,
      ...
      z = !!(2 & r);
    z && (y |= 2);
    for (var B = !z, F = true, J = 0, W = 0; J < w.length; J++) {
      var ha = ce(w[J], f, false, y);
      if (ha instanceof f) {
        if (!z) {
          var Pa = $c(ha);
          B && (B = !Pa);
...
function rf(a, c, e) {
  var f = a.G;
  return qf(a, f, f[K] | 0, c, e, void 0 === cd ? 2 : 4, false, true);
}
...
function Jf(a, c) {
  ...
  if (a.constructor === Uint8Array) return new If(a, false);
  if (a.constructor === ArrayBuffer) return ((a = new Uint8Array(a)), new If(a, false));
  if (a.constructor === pc) return ((c = vc(a) || new Uint8Array(0)), new If(c, true, a));
...
R.prototype.clone = function () {
  var a = this.G,
    c = a[K] | 0;
  return Ke(this, a, c) ? Le(this, a, true) : new this.constructor(Je(a, c, false));
};
function pg(a) {
  var c = a.G,
    e = c[K] | 0;
  return $c(a, e) ? a : Ke(a, c, e) ? Le(a, c) : new a.constructor(Je(c, e, true));
}
function qg(a, c, e) {
  te(a, c.j);
...
function Cg(a) {
  ...
  g &&
    ...
    (g = a[++h]),
    typeof g === "function" &&
      ((f.Je = true), Ag != null || (Ag = g), Bg != null || (Bg = a[h + 1]), (g = a[(h += 2)])));
...
A.equals = function (a) {
  return a == null ? false : this.aa == a.aa && this.Y == a.Y;
};
...
function Sg(a) {
  return (
    a.Ad ||
    (Object.defineProperties(a, { Ad: { value: (ai = (ai + 1) | 0), enumerable: false } }), a.Ad)
  );
}
function Nh(a, c) {
    ...
    if (e)
      for (
        var g = function (l, p, q) {
            e--;
            f[l] = p ? { ue: true, value: q } : { ue: false, reason: q };
            e == 0 && c(f);
          },
          h,
          k = 0;
...
vj.prototype.$goog_Thenable = true;
function Ij(a, c) {
  c = Yi(c);
  c = zj(c, c);
  c.A = true;
...
function Dj(a, c, e, f) {
  if (a instanceof vj) return (Jj(a, zj(c || sj, e || null, f)), true);
  if (uj(a)) return (a.then(c, e, f), true);
  if (Oa(a))
    try {
      var g = a.then;
...
A.cancel = function (a) {
  if (this.j) this.v instanceof Tj && this.v.cancel();
    ...
    this.T ? this.T.call(this.J, this) : (this.H = true);
...
function Wj(a) {
  ...
  c = a.v;
  for (var f = (e = false); a.B.length && !a.D; ) {
    var g = a.B.shift(),
      h = g[0],
      k = g[1];
    g = g[2];
  ...
  f &&
    ((l = Va(a.Id, a, true)),
    (f = Va(a.Id, a, false)),
    c instanceof Tj ? (bk(c, l, f), (c.R = true)) : c.then(l, f));
...
function mk(a, c, e) {
  ...
  if (a.j == 1) {
    ...
    a.v = true;
    try {
      a.j == 2 && c ? c(a.H.j) : a.j == 3 && e && ((a.N = true), e(a.C));
    } catch (g) {
      var f = jh(g);
      Wk(f);
      a.A || (a.A = f);
...
function Tk(a, c) {
  ...
  try {
    ...
    else for (a.B.length != 0 && (a.N = true), f = a.B, e = 0; e < f.length; e++) (0, f[e])(a.C);
  } catch (h) {
    var g = jh(h);
    Wk(g);
    a.A || (a.A = g);
...
function ol(a) {
  ...
  if (Error.captureStackTrace) {
    Error.captureStackTrace(c, a || ol);
    c = String(c.stack);
  } else {
    try {
      throw c;
...
D(im, S);
function jm(a, c) {
  if (Rg(a, c)) return true;
  if (!a || !c) return false;
  var e = a.length;
  if (e != c.length) return false;
  for (var f = 0; f < e; f = (f + 1) | 0) if (!km(a, c, f)) return false;
  return true;
}
function km(a, c, e) {
  var f = Yl(a[e]),
    g = Yl(c[e]);
  if (!Rg(f, g)) return false;
  switch (f) {
    case "null":
      return true;
    case "boolean":
...
function tm(a, c) {
  ...
  if (a == null) return "";
  var e;
  if ((c = "number" === typeof a && ((e = a), true))) c = Fh(e).equals(Fh(e));
  var f;
  c ? (f = "" + Fh(e)) : (f = T(a));
  return f;
}
...
function vm(a, c) {
  ...
  hi(Yl(a), "object");
  var e;
  return a instanceof Array && ((e = a), true) ? e.concat() : cm(a);
}
function xm(a, c) {
  a = ym(a, c);
...
function Dm(a, c, e, f) {
  ...
  if (g == null) f = e == null;
    ...
    var h;
    f = bh(e) && ((h = e), true) ? Nh(g, h.j) : Nh(g, e);
  }
...
var On = 0;
function Qn() {
  this.v = this.N = this.F = this.H = false;
  this.I = 0;
}
D(Qn, S);
...
function go(a, c) {
  if (c == null || !Rg(ci(c), ci(a))) return false;
  var e = ho(a);
  if (e.length != ho(c).length) return false;
  for (var f = 0; f < e.length; f++) {
    var g = e[f];
    if (!Mh(a[g], c[g])) return false;
  }
  return true;
}
function ho(a) {
...
A.ba = function (a) {
  return po(a) ? $k(this.ga(), a.B) >= 0 : false;
};
function qo(a) {
  this.v = a;
}
...
vo.prototype.kd = function (a, c) {
  ...
  true === c && ((a = Jh(xo.j()) - e), this.j.D("md", a));
  return f;
};
function wo() {
  wo = u();
...
function Lo(a) {
  var c = a.getType(),
    e = a.ia();
  return new Mo(c, e, wm(a, "isFastTrack") == null ? false : a.j.isFastTrack.length != 0);
}
function No(a, c) {
  X(a, "ic", c);
}
...
A.createDocument = function (a, c, e) {
  a = new Go(a, c, true, this.re, this.Mc[c]);
  e == null || (ym(a, "initialSyncReason") == null && X(a, "initialSyncReason", e));
  return a;
};
A.ba = function (a) {
  var c = a.getType();
  return c === "append-commands" || c === "write-trix" ? true : Y.prototype.ba.call(this, a);
};
A.za = function (a) {
...
D(Bp, qo);
function Cp(a, c) {
  if (V(c, "docs-offline-ercidep") && !V(c, "docs-localstore-cide")) return false;
  switch (a) {
    case "kix":
    case "punch":
    case "drawing":
...
function Xp(a, c, e, f, g, h, k) {
  ...
  X(this, "documentType", c);
  X(this, "revision", -1);
  Bm(this, "undeliverable", false);
  Bm(this, "unsavedChanges", false);
}
var Yp = [
  "revisionAccessInfo",
...
function kq(a) {
  for (var c = [], e = 0; e < a.length; e = (e + 1) | 0) {
    ...
    h >= 55296 && h <= 56319
      ? (g = !(f >= 65536 && f <= 1114111))
      : k && (e > 0 ? ((g = gi(a, (e - 1) | 0)), (g = !(g >= 65536 && g <= 1114111))) : (g = true));
    g &&
      c.push(
        new nq(
          "\\u" + T((f >>> 0).toString(16)),
...
Yq.prototype.Gc = function (a) {
  var c = Do(a.o);
  return c.length == 0 ? [] : [new Yo(a.V(), a.Ha(), c, true)];
};
...
A.ba = function (a) {
  return a.getType() === "append-template-commands" ? true : Y.prototype.ba.call(this, a);
};
function $q(a, c, e) {
  um.call(this, "user", e, c);
  X(this, "id", a);
  Bm(this, "fastTrack", true);
}
D($q, um);
...
dr.prototype.ba = function (a) {
  return Y.prototype.ba.call(this, a) ? (hi(a.getType(), "update-record") ? a.o : true) : false;
};
function er(a, c) {
...
/** initializeOfflineDocumentRecords（原 ds）。
 * 离线创建涉及 snapshot、ACL、pendingCreation 与待处理队列；不是全部协同算法。
 */
function initializeOfflineDocumentRecords(a, c, e, f, g) {
  ...
  Jo(h, a.v.V(), k);
  Ko(h, Jh(new zo().j()));
  if ((k = Cm(g, "docosKeyData"))) {
    k[10] = f;
    X(h, "docosKeyData", k);
  }
  Bm(h, "inc", true);
  Bm(h, "hpmdo", false);
  Bm(h, "pendingCreation", true);
...
function is(a, c, e, f, g) {
  a.j.j.J.Bc(
    f,
    function () {
      initializeOfflineDocumentRecords(a, c, e, f, g);
    },
    function (h) {
      cs(a, e, h);
    },
...
/** consumeReservedDocumentId（原 js）。
 * 消费预留未使用文档 ID，用于离线创建。
 */
function consumeReservedDocumentId(a, c) {
  var e = new Qk();
  ...
  a instanceof Ws
    ...
    : a && (c = Al(String(a)))
      ? ((this.B = false),
        ...
        $s(this, c[6] || "", true),
        at(this, c[7] || "", true))
      : ((this.B = false), (this.j = new ct(null, this.B)));
}
Ws.prototype.toString = function () {
  var a = [],
    c = this.A;
  c && a.push(et(c, ft, true), ":");
  var e = this.o;
  if (e || c == "file") {
    a.push("//");
    (c = this.D) && a.push(et(c, ft, true), "@");
  ...
  if ((e = this.v)) {
    ...
    a.push(et(e, e.charAt(0) == "/" ? gt : ht, true));
  }
...
function wt(a, c) {
  ...
  this.defaultPrevented = this.v = false;
}
...
function Lt(a, c, e, f, g) {
  ...
  e = Nt(e);
  return At(a)
    ? a.A.add(String(c), e, false, Oa(f) ? !!f.capture : !!f, g)
    : Ot(a, c, e, false, f, g);
}
...
function Mt(a, c, e, f, g) {
  ...
  e = Nt(e);
  return At(a)
    ? a.A.add(String(c), e, true, Oa(f) ? !!f.capture : !!f, g)
    : Ot(a, c, e, true, f, g);
}
function Tt(a, c, e, f, g) {
  if (Array.isArray(c)) for (var h = 0; h < c.length; h++) Tt(a, c[h], e, f, g);
    ...
    f = Oa(f) ? !!f.capture : !!f;
    e = Nt(e);
    At(a) ? a.A.remove(String(c), e, f, g) : a && (a = Pt(a)) && (c = Ht(a, c, e, f, g)) && Ut(c);
  }
}
function Ut(a) {
...
au.prototype.dispatchEvent = function (a) {
  ...
  a.v ||
    ((k = a.currentTarget = c), (g = bu(k, f, true, a) && g), a.v || (g = bu(k, f, false, a) && g));
  if (e)
...
function lu(a, c, e, f) {
  ...
  for (var g = 0; g < e.length; g++) {
    var h = Lt(c, e[g], f || a.handleEvent, false, a.o || a);
    if (!h) break;
    a.j[h.key] = h;
  }
  return a;
...
function ou(a, c, e, f, g, h) {
  if (Array.isArray(e)) for (var k = 0; k < e.length; k++) ou(a, c, e[k], f, g, h);
    ...
    f = Nt(f);
    g = !!g;
    e = At(c) ? Ht(c.A, String(e), f, g, h) : c ? ((c = Pt(c)) ? Ht(c, e, f, g, h) : null) : null;
...
function uu(a, c) {
  ...
  try {
    ...
    if (Zk(k) instanceof fr) a.X = true;
...
function ru(a) {
  a.H != 1 || a.A.isActive() ? a.A.start() : hu(a.A, true, true);
}
A.P = function () {
  ...
  try {
    for (; !e.done; e = c.next()) {
      var k = e.value,
        l = Xu(k.key);
      l === 0
        ? (a.set("apps_telemetry.automation_property_present." + k.oa, "true"), (g = true))
...
function Zu(a, c, e) {
  try {
    ...
    return { fb: false, reason: "not_reachable" };
  }
  e = $u(f);
  if (e !== "function") return { fb: false, reason: "non_function_type", type: e };
  try {
    var g = a.j(f);
  } catch (h) {
    return { fb: false, reason: "to_string_failed" };
  }
  a = av.exec(g);
  return a
    ? (a = a[1])
      ? a !== c
        ? { fb: false, reason: "likely_wrong_native_function" }
        : { fb: true }
      : { fb: false, reason: "likely_bound_function" }
    : { fb: false, reason: "likely_non_native_source" };
}
function $u(a) {
  switch (typeof a) {
    case "function":
...
var pv = [
  ...
  { errorMessage: "] is not a function", Qb: true },
  { errorMessage: "(reading 'toLowerCase')", Qb: true, Ra: ["__aiNetCmd__"] },
  { errorMessage: "Cannot read properties of undefined", Ra: ["recaptcha"] },
  { errorMessage: "a is not defined", Od: true, Ra: ["<anonymous>"] },
  { errorMessage: "i is not defined", Od: true, Ra: ["<anonymous>"] },
  { errorMessage: "Failed to fetch", Ra: ["__DLD__", "frontend.min.js"] },
  { errorMessage: "Maximum call stack size exceeded", Me: true },
...
function Mv(a, c) {
  ...
  try {
  ...
  } catch (z) {
    {
      g = false;
      a = Av(z, e);
      f.set("apps_telemetry.handling_error", nv(a));
    }
  }
...
function Nv(a, c) {
  return Iv.has(c.toUpperCase()) ? (a.j = true) : false;
}
function Lv(a) {
  var c = [];
  a = E(a);
...
function Tv(a, c) {
  ...
  k = k === void 0 ? Sv() : k;
  e = e.Ze;
  this.v = Kv(c, f, h === void 0 ? false : h, e === void 0 ? x(true) : e);
...
function Aw(a) {
  ...
  this.O = "";
  this.B = 0;
  this.v = this.M = this.F = this.K = false;
  this.H = 0;
  this.C = null;
  this.D = "";
  this.J = false;
...
function Fw(a) {
  a.K || ((a.K = true), a.dispatchEvent("complete"), a.dispatchEvent("error"));
}
A.abort = function (a) {
  this.j &&
    this.o &&
...
function Kw(a, c, e, f) {
  ...
  k = new Aw();
  Dw.push(k);
  k.A.add("ready", k.ie, true, void 0, void 0);
  k.send(a, c, e, g);
}
function Nw(a, c) {
  a.C = c;
...
function xx(a, c, e, f, g, h) {
  ...
  for (c = this.O = 0; c < a.length; c++)
    bk(a[c], Va(this.M, this, c, true), Va(this.M, this, c, false));
...
function Jx(a, c, e, f, g, h, k, l) {
  qu.call(this, a, e, f, g, h, k, l === void 0 ? true : l);
  var p = this;
  this.K = c || "default";
  this.J = c + "-v";
  this.D = c + "-f";
  ...
  try {
    {
      ...
      this.j.setItem(this.K + "-e-" + c, JSON.stringify(a));
    }
  } catch (e) {}
  return ik();
};
...
Ky.prototype.j = function (a, c, e) {
  var f = this;
  a = new Lp(null, this.A, Date.now(), ze(a), true, this.v);
  this.B.write(
    [a],
    13,
    c,
        ...
        case "document":
          ...
          if (p == null) Ve(k, r, 3);
            ...
            for (z = 0; z < p.length; z++) {
              ...
              var F = Od(q);
              Object.is(q, F) ||
                (B && ((p = Ed(p)), (y = 0), (w = af(w, r)), (B = false)), (p[z] = F));
            }
...
function iz(a, c, e, f, g, h, k, l, p, q, r) {
  ...
  this.J > 0 &&
    ...
    this.j.start());
  this.H.onsuccess = cx(this.v, this.X, this, true);
  this.H.onerror = cx(this.v, this.R, this, true);
  switch (c) {
    case "read":
      this.D.C++;
      break;
...
iz.prototype.R = function (a) {
  ...
  e = c.j[f];
  delete c.j[f];
  e && ((f = c.o), (e.o = false), (e.j = f), wz(c, e));
...
function Ez(a, c, e, f, g, h, k, l) {
  iz.call(this, a, "open", c, e, new Bz(c), new zz(), f, h, true, k, l);
  this.N = this.I = null;
  this.S = g;
  a.onblocked = cx(c, this.U, this, true);
  a.onupgradeneeded = cx(c, this.Z, this, true);
}
D(Ez, iz);
...
function Kz(a) {
  var c = new tz(function (e) {
    Mb(a.j, e) && a.j.length === 0 && !a.o && ((a.o = true), a.v());
  });
  a.j.push(c);
  return c;
}
  ...
  this.A = new uz(
    function () {
      if (!J.j.o) {
        ...
        J.A.dispose();
        J.O && (Nz(J, true), J.O(), (J.C.oncomplete = null));
      }
    },
    this.S,
    document,
...
A.open = function () {
  if (this.Z != null) {
    var a = V(this.I, "docs-intli") ? this.ma : true;
  ...
  e.onerror = cx(this.o, this.de, this, true);
  this.C = e;
  this.D.add(this);
};
function $y(a) {
...
function Wz(a, c, e, f, g) {
  ...
  Gz(c, function (l) {
    ...
    l.onabort = l.onerror = cx(k, f, {}, true);
    e(l);
  });
  xz(c, f);
  Fz(c, function (l) {
...
function pA(a, c) {
  ...
  var e = new Go(c.id, c.documentType, false, a.o);
  X(e, "title", c.title);
  ...
  if (!a.Mc[e.getType()])
    throw (
      ...
      pl(a, {
        ...
        localStoreDoc_isCreated: (true !== Am(e, "inc")).toString(),
  ...
  switch (a.getType()) {
    case "update-record":
      a.o
        ? ((a = a.j),
          f.add(a),
          (this.F || this.C) && this.j && ((f = this.j), eA(f, a), (f.I = true)),
          bz(e))
        : ((c = this.j) == null
            ? (c = 0)
            : c.j != null
...
function sA(a, c, e) {
  Zy(fz(Z(c, "PendingQueueCommands"), [a], [a, []]), function (f) {
    f.target.result ? e(true) : tA(a, c, e);
  });
}
function tA(a, c, e) {
...
vA.prototype.j = function (a, c, e, f, g, h, k) {
  return new lA(a, c, e, f, g, h, k === void 0 ? false : k);
};
...
D(wA, xp);
function ks(a, c, e, f) {
  var g = Yy(a.j, ["NewDocumentIds"], 43, f, true),
...
function zA(a, c) {
  ...
  var f = new Zo(e, false, a.na);
  a = a.Oa(e);
  e = c.jobset;
  e != null && X(f, "jobset", e);
  e = c.ic;
  e != null && ((a = a.kd(e)), (f.C = a.slice(0)), (f.o = true));
...
function LA(a, c, e, f) {
  ...
  a.U = I.navigator.locks
    .request("GoogleDocs:document:" + c, { ifAvailable: true }, function (l) {
...
function OA(a, c, e) {
  return Yy(a.C, ["DocumentLocks"], 54, e, true, void 0, sm(a.D, "docs-localstore-ilat"), c, 29027);
}
function UA(a, c) {
...
KA.prototype.nd = function () {
  if (I.navigator.locks) {
    this.S = true;
    this.J && (this.J(), QA(this, "releaseAllLocks"));
...
kB.prototype.j = function (a, c, e, f, g, h, k) {
  ...
  if (k !== void 0) {
    for (var l in c) {
      h = c[l];
      Lb(e, l) ? (k[l] = h != null ? h : null) : (k[l] = h);
    }
    az(a, k);
    bz(f);
    g != null && fA(g, c, e);
...
function nB(a, c, e) {
  if (a.j.A) du(Wa(c, []));
    ...
    e = Yy(a.j, ["Users"], 71, e, false, void 0, void 0, void 0, 1337522, true);
    var f = [];
    Zy(Z(e, "Users").get(pz.lowerBound(-Infinity)), function (g) {
      if ((g = g.target.result)) {
        var h = new $q(g.id, false, a.na);
...
function Up(a, c, e, f, g, h, k) {
  ...
  if (a.j.A) du(f);
    ...
    l = Ns(l);
    q = V(a.v, "docs-eaiturd") || (V(a.v, "docs-eirdfi") && Pb(l, ["Impressions"])) ? true : false;
    e = Yy(a.j, l, e, g, true, p, void 0, void 0, h, k, q);
    Qz(e, f);
    f = [];
...
function AB(a, c, e, f, g, h, k, l, p, q) {
  oB.call(this, a, c, e, f, g, h, k, l, p, q === void 0 ? false : q);
  a = this.j;
  e = this.A;
...
function CB(a, c, e, f, g, h, k) {
  lA.call(this, a, c, e, f, g, h, k === void 0 ? false : k);
}
D(CB, lA);
...
DB.prototype.j = function (a, c, e, f, g, h, k) {
  return new CB(a, c, e, f, g, h, k === void 0 ? false : k);
};
function EB(a, c, e, f, g, h, k, l, p, q) {
  k = k === void 0 ? new DB() : k;
  AB.call(this, a, c, e, f, g, h, k, l, p, q === void 0 ? false : q);
  this.cb = new BB(this.j, this.A, this.o, h);
  Eq(this, this.cb);
}
D(EB, AB);
EB.prototype.Bb = x(7);
EB.prototype.Ec = x(true);
...
function IB(a, c, e, f, g, h, k, l, p, q, r) {
  EB.call(this, a, c, f, g, h, l, void 0, p, q, r === void 0 ? false : r);
  a = ["kix", "punch", "ritz"];
  c = this.j;
...
function SB(a, c, e) {
  for (c += 1; c <= e; ++c) if (a.o[c] == null || !a.o[c].Ec()) return false;
  return true;
}
...
LB.prototype.K = function () {
  ...
  if ((a = this.o[a])) {
    ...
    this.B.info(Error("Jc`" + (this.j ? Vz(this.j) : -1)));
    Sk(this.C, null);
  }
};
function QB(a) {
...
function XB(a) {
  a.j && Sl(a.j);
  var c = sm(a.o, "lssv");
  return new LB(a.B, a.J, 0, a.le.bind(a), c, true, new GA(), a.H, a.D, a.o);
}
function YB(a) {
  if (a.v) return a.v;
  a.v = ZB(a);
...
A.Td = function (a) {
  ...
  if ((a = BC(e))) {
    ...
    if (a.type == "e") {
      ...
      a.type == "i" && (this.j && this.j.info(Error("Oc")), CC(this, c, (Sr(), Jr)), (f = false));
    if (a.type == "d") {
      a.A instanceof us && Df(a.A, 2, L);
      try {
        if ((c.B(a), !c.K == 0 && (f = false), c.U)) CC(this, c);
        else {
          var l = c.R(a);
...
function EC(a, c, e, f) {
  ...
  if (c.j == 200) {
    ...
    if (h) {
      var k;
      if ((h = (k = og(of(h, xi, 10, L), yi)) == null ? void 0 : k.Ia())) {
        HC(a, h);
        g = true;
      }
    }
  }
  c.j == 400 && (f = uC(f)) && f.Ia() && (HC(a, f.Ia()), (g = true));
...
function yC(a, c) {
  if (a.R) {
    var e;
    ((e = c.Ma["x-reload"]) == null ? void 0 : e.toLowerCase()) === "true" && a.R.j(true);
  }
}
function GC(a) {
  var c = a.K.shift();
...
function dE(a) {
  ...
  return (a = c === "/open" ? a.j.get("id") : null)
    ? new XD("/edit", "unknown", a, false, false, false, e)
    : null;
}
function eE(a) {
  var c = qs(ns(a.v));
  a = a.j.get("usp");
  return (c = gE[c]) ? new XD("/", c, void 0, false, true, false, a) : null;
}
function fE(a) {
  var c = a.j.get("usp");
  return a.v === "/create" ? new XD("/create", "kix", void 0, true, false, false, c) : null;
}
...
kE.prototype.zb = function (a) {
  ...
  var e = this.getType(),
    f = Nl(a, "usp");
  if ($D(this.j, c)) return new XD(c, e, void 0, true, false, false, f);
  if (aE(this.j, c)) return new XD(c, e, void 0, false, true, false, f);
  if (this.j.o.C == c) return new XD(c, e, void 0, false, true, true);
  if (this.j.o.B == c) return new XD(c, e, void 0, false, false, true);
  if (bE(this.j, c))
    return ((a = (a = rs(a)) && a.id ? a.id : void 0), new XD(c, e, a, false, false, true));
  f = new Ws(a);
  a = f.j.get("usp");
  if (cb(c, "/d/")) {
    f = c.indexOf("/", 3);
    ...
    e = new XD(c, e, g, false, false, false, a);
  } else e = (f = f.j.get("id")) ? new XD(c, e, f, false, false, false, a) : null;
...
/** buildOfflineEditorUrl（原 yE）。
 * 构造 edit/view/comment 等离线入口及启动参数；保留原 fragment 编码。
 */
function buildOfflineEditorUrl(a, c, e, f, g, h, k, l) {
  var p = e.V(),
    q = Km(c, "acjf", p);
  ...
  r =
    true === Ld(Se(r, 6, L)) && true === Ld(Se(r, 4, L))
      ? 3
      : true === Ld(Se(r, 4, L))
        ? 2
        : true === Ld(Se(r, 3, L))
...
function oG(a, c) {
  return mG(a, c, true).then(function (e) {
    e = e
      .filter(function (f) {
        return f.sa();
      })
...
function EG(a) {
  if (a.W) return a.W && a.W.o.includes("offline/iframeapi") ? false : true;
  a = a.j.A;
...
function OG(a, c, e) {
  a.o != null ? nx(a.j, c, a.o, e, false, 2) : Tw(a.j, c, e);
}
function MG(a, c, e) {
  a.o != null ? nx(a.j, c, a.o, e, false, 1) : bx(a.j, c, e);
}
function KG(a, c, e) {
  a.o != null
    ? nx(a.j, c, a.o, e, false, 0)
...
function WG(a, c, e, f) {
  a = new Request(a, c);
  return XG(a, e, 0, f === void 0 ? null : f, true, false).catch(function (g) {
    g = nl(g);
    UG(g) && TG(g);
    throw g;
  });
...
function qH(a, c, e, f, g, h) {
  ...
  return e.map(function (l) {
    ...
    return a.match(new Request(p)).then(function (q) {
      ...
      r = true;
      Cf(q, 2) != Cf(c, 5) && (r = false);
      return new jH(true, r);
    });
  });
}
function rH(a, c, e) {
...
function nI(a, c, e, f, g) {
  return a.H.clients.matchAll({ includeUncontrolled: true }).then(function (h) {
    h =
      h.filter(function (k) {
...
xI.prototype.get = function (a) {
  return uI(this.j).then(function (c) {
    c = c.map(function (e) {
      ...
      return XG(e, 3, 0, null, false, false)
        .then(function (f) {
          return f.text();
        })
        .then(function (f) {
...
function FI(a, c, e) {
  return new yI(createOfflineRedirectResponse(a), "cache-storage", e, c);
}
/** createOfflineRedirectResponse（原 GI）。
 * 生成离线入口的 302 响应。
 */
function createOfflineRedirectResponse(offlineUrl) {
  var c = Al(offlineUrl);
  offlineUrl = yl(c[1], null, c[3], c[4])
    ? offlineUrl
    : I.location.origin + (offlineUrl.startsWith("/") ? offlineUrl : "/" + offlineUrl);
  c = new Headers();
  c.set("Location", offlineUrl);
...
function LI(a, c, e) {
  ...
  return RI(a, e, c).then(function (g) {
    var h = c.j;
    h.D || ((h.o = Date.now() - h.v), (h.D = false));
    c.j.N = !!g;
...
HJ.prototype.o = function (a) {
  this.v = arguments;
  this.j ? (this.A = true) : IJ(this);
};
HJ.prototype.stop = function () {
  this.j && (I.clearTimeout(this.j), (this.j = null), (this.A = false), (this.v = null));
};
...
function uK(a, c, e, f) {
  return e.ya == null
    ...
    : getDelayedLocalFallback(f).then(function (g) {
        return iK(a.j, c, e, g);
      });
}
...
function DK(a) {
  return (a = a.ea.headers.get("Sec-Purpose")) ? a.split(";").includes("prefetch") : false;
}
function EK(a, c) {
  var e = true,
    f = true;
  ...
  return Promise.resolve(aC(this.B))
    .then(function (f) {
      ...
      return e.D
        ? IK(c, g, f, e, k)
        : e.C
          ? createDocumentForOfflineLaunch(c, a, g, f, e, k)
          : e.v
            ? readDocumentForOfflineLaunch(c, a, g, f, e, k)
...
function IK(a, c, e, f, g) {
  return MK(c, f).then(function (h) {
    ...
    return findPrimaryOrAlternateShell(a, k, l).then(function (p) {
...
function PK(a, c, e, f, g) {
  return MK(c, f).then(function (h) {
    ...
    return findPrimaryOrAlternateShell(a, k, l).then(function (p) {
      return p
        ? new yI(
            createOfflineRedirectResponse(k),
            "cache-storage",
            "document-not-available-locally",
          )
        : OK(a, k, l, f.j);
    });
  });
}
/** createDocumentForOfflineLaunch（原 JK）。
 * 创建分支取得文档信息后复用离线启动校验。
 */
...
function SK(a, c, e, f, g, h) {
  return e.C
    ? buildOfflineEditorUrl(f, g, c, 2, h, e.o, void 0, e.F || void 0)
    : buildOfflineEditorUrl(f, g, c, 4, h, e.o, a.ea.url);
}
function MK(a, c) {
  return c.A
...
function RK(a, c, e, f, g) {
  return MK(c, f).then(function (h) {
    ...
    return findPrimaryOrAlternateShell(a, k, l).then(function (p) {
      return p
        ? new yI(createOfflineRedirectResponse(k), "cache-storage", "no-offline-document-ids")
        : OK(a, k, l, f.j);
    });
  });
}
...
/** EditorNetworkFetchHandler（原 XK）。
 * 先等待 navigation preload，再尝试网络；保留服务器状态和离线兜底条件。
 */
function EditorNetworkFetchHandler(networkHandler, logger, flags) {
  this.v = networkHandler;
  this.j = logger;
  this.o = flags;
}
EditorNetworkFetchHandler.prototype.fetch = function (a) {
  var c = this,
    e = a.ea;
  a.j.B = Date.now();
  return a.C.then(function (f) {
    ...
    .then(function (f) {
      var g = a.j;
      g.F || ((g.j = Date.now() - g.B), (g.F = false));
      a.j.Z = !!f;
      if ((g = !!f)) {
      ...
      g != null && (a.j.X = g);
      var h;
      f ? (h = classifyEditorNetworkResponse(c, a, f)) : (h = new yI(null, "network", "offline"));
      return h;
    });
};
/** classifyEditorNetworkResponse（原 YK）。
 * 包装成功响应，区分 404/410、指定服务端错误及服务器建议兜底；不能一律改为本地成功。
 */
function classifyEditorNetworkResponse(networkHandler, requestContext_2, networkResponse) {
  if (requestContext_2.W && requestContext_2.W.v) {
    var f = networkResponse.status,
      g = networkResponse.headers;
    requestContext_2 = Nl(requestContext_2.ea.url, "fws");
    if (f == 404) return EI(networkResponse, "server-document-not-found");
    if (f == 410 && V(networkHandler.o, "docs-sw-eddf"))
      return EI(networkResponse, "server-document-deleted");
    if (requestContext_2 != "true") {
      if (ZK.includes(f)) return EI(networkResponse, "server-error");
      if (g.get("docs-offline-fallback-if-possible") == "true")
        return EI(networkResponse, "server-suggested");
    }
  }
  return new yI(networkResponse, "network");
}
var ZK = [500, 502, 503];
function $K() {
  this.o = [];
...
/** buildEditorStaticRoutes（原 dL）。
 * 受开关与浏览器能力约束的静态路由优化，不是离线成立的唯一前提。
 */
function buildEditorStaticRoutes(a, c, e) {
  var f = new $K();
  if (a) {
...
function qL(a, c, e) {
  ...
  if ((a = wK(a.o, c.o)) && c.v) {
    a.J.push(c);
    f = !!c.W && c.W.B;
    c.W && c.W.I && (V(a.Z, "docs-sw-eesp1sr") ? f && (a.D = true) : (a.D = f || !!e.j));
    if ((e = !a.I)) {
      g = c.j;
      Ef(a.A, 7, g.K);
      vL(a.A, g.S);
  ...
  if (f) {
    ...
    return Promise.race([Promise.all(c.j.M), eu(3e4)])
      ...
      .then(function () {
        var l = c.j,
          p = Date.now();
        l.B && l.j == null && ((l.j = p - l.B), (l.F = true));
        l.v && l.o == null && ((l.o = p - l.v), (l.D = true));
        l = a.v;
        var q = c.o,
          r = h * 1e3,
          w = k * 1e3,
...
xM.prototype.o = function (a, c) {
  if ((a = c ? wK(this.A, c) : null)) a.K = true;
  var e = this.v;
  c = VJ(e, 100009, c);
  yn(wn(Cn(En(KH(c)))), !!a);
  e.pa(c);
...
function sM(a, c) {
  ...
  g && g.I
    ...
    : ((g = new TL()), Q(g, 1, true), ZL(e, g), $L(e, new XL()), aM(e, new WL()));
  g = pf(e, TL, 1);
  var h = pf(e, XL, 2);
  Gf(g, 8, c);
  Gf(g, 6, a.D);
...
function MM() {
  ...
  this.v = k;
  GM(this.v, h);
  this.o.addEventListener("install", cx(this.j, this.I, this), false);
  this.o.addEventListener("fetch", cx(this.j, this.D, this), false);
  this.o.addEventListener("activate", cx(this.j, this.C, this), false);
  this.o.addEventListener("message", cx(this.j, this.F, this), false);
}
...
MM.prototype.D = function (a) {
  ...
  handleEditorFetchEvent(this.B, a);
};
function PM(a) {
  this.B = a.gf || null;
  this.v = a.Xf || false;
...
A.abort = function () {
  ...
  this.readyState >= 1 && this.j && this.readyState != 4 && ((this.j = false), SM(this));
  this.readyState = 0;
};
A.Fe = function (a) {
  if (
...
if (V(by, "docs-eiltdw")) $M = new Wn();
  ...
  if (ZM && eo && (bN || bo !== "editormain.js") && aN) {
    ...
    bx(aN.j, cN.L, null, false);
  }
  eo = true;
  $M = bN;
}
var rI = new WB(hy, null, by, YM, $M, void 0, void 0, true),
  sI = HK.getType(),
  dN = new xI();
hy.o.sid = WM;
var eN,
...
if (V(by, "docs-eil")) {
  ...
  mN = new PJ();
  lN = new DJ(mN, new JJ(mN, jN.A, jN.v, jN.o, null), false);
  var wN = lN.ec(),
    xN = tm(by, "buildLabel");
  if (wN.o == null) {
    wN.o = new hJ();
...
var NM = new (function () {
    ...
    c = new GK(g, f, c, l);
    f = new JI(f, g, l);
    this.j = new EditorNetworkFetchHandler(a, e, l);
    g = new gK(k, g);
    this.I = new WK(f, this.j, true, g);
    this.H = new UK(f, this.j, g, sm(l, "docs-sw-nfhms"));
    this.S = new UK(f, this.j, g, -22e3);
    this.U = new WK(this.j, c, false, g);
    this.R = new WK(c, this.j, true, g);
    this.O = new NetworkLocalRaceHandler(this.j, c, e, k, g, h, l);
    this.C = hK;
    this.A = e;
    this.o = h;
    this.N = a;
    ...
    this.F =
      V(this.D, "docs-sw-eessrr") && Fb() >= 117
        ? buildEditorStaticRoutes(false, false, null)
        : null;
  })(),
...
if (Fb() >= 117) {
  ...
  if (bO || cO || dO) JL = buildEditorStaticRoutes(cO, dO, aG(new ZF(VM, by)));
}
new MM();
var eO = BL,
  fO = Date.now();
