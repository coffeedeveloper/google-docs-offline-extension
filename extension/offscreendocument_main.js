...
z.prototype.R = function(a, b) {
  ...
  (b = this.l = this.l || b) ? b.Na ? this.j = this.A || this.v : b.ga != void 0 && this.v < b
    .ga ? (this.j = b.ga, this.l = null) : this.j = this.v: this.j = a
};
...
v("WeakMap", function(a) {
  ...
  b.prototype.has = function(k) {
    return d(k) && Aa(k, g) && Aa(k[g], this.j)
  };
...
function B(a, b, c) {
  B = Function.prototype.bind && Function.prototype.bind.toString().indexOf("native code") != -1 ?
    Na : Oa;
...
var cb = F("Firefox") || F("FxiOS"),
  db = F("Safari") && !((Za() ? Ya("Chromium") : (F("Chrome") || F("CriOS")) && (Za() || !F(
    "Edge")) || F("Silk")) || (Za() ? 0 : F("Coast")) || (Za() ? 0 : F("Opera")) || (Za() ? 0 : F(
    "Edge")) || (Za() ? Ya("Microsoft Edge") : F("Edg/")) || (Za() ? Ya("Opera") : F("OPR")) || F(
    "Firefox") || F("FxiOS") || F("Silk") || F("Android")) && !(F("iPhone") && !F("iPod") && !F(
    "iPad") || F("iPad") || F("iPod"));
var eb = {},
  fb = null;
...
function dc(a, b) {
  ...
  else rb() ? c = "" + (BigInt(b) << BigInt(32) | BigInt(a)) : (c = (a >>> 24 | b << 8) & 16777215,
...
function fc() {
  var a = I,
    b = $b;
  b & 2147483648 ? rb() ? a = "" + (BigInt(b | 0) << BigInt(32) | BigInt(a >>> 0)) : (b = y(cc(a,
    b)), a = b.next().value, b = b.next().value, a = "-" + dc(a, b)) : a = dc(a, b);
  return a
}
...
function rc(a) {
  ...
  else if (rb()) a = BigInt(a), I = Number(a & BigInt(4294967295)) >>> 0, $b = Number(a >> BigInt(
    32) & BigInt(4294967295));
  else {
    b = +(a[0] === "-");
    $b = I = 0;
    for (var c = a.length, d = 0 + b, e = (c - b) % 6 + b; e <= c; d = e, e += 6) d = Number(a
      .slice(d, e)), $b *= 1E6, I = I * 1E6 + d, I >= 4294967296 && ($b += Math.trunc(I /
      4294967296), $b >>>= 0, I >>>= 0);
...
function uc(a) {
  ...
  if (oc(a)) return b === "string" ? (b = kc(Number(a)), ic(b) ? a = Sb(b) : (b = a.indexOf("."),
      b !== -1 && (a = a.substring(0, b)), a = rb() ? Sb(hc(64, BigInt(a))) : Sb(rc(a)))) : a =
    ic(a) ? Sb(sc(a)) : Sb(tc(a)), a
}
...
function Dc(a, b, c, d) {
  ...
  if (r)
    for (var E in r) h = r[E], h != null && (h = c(h, d)) != null && (t = +E, w = void 0, l && !
      Number.isNaN(t) && (w = t + m) < g ? f[w] = h : (t = void 0, ((t = b) != null ? t : b = {})[
        E] = h));
  b && (k ? f.push(b) : f[g] = b);
...
function Kc(a, b) {
  ...
  if (Array.isArray(a)) {
    var c = a[G] | 0;
    a.length === 0 && c & 1 ? a = void 0 : c & 2 || (!b || 4096 & c || 16 & c ? a = Lc(a, c, !1,
      b && !(c & 16)) : (Fb(a, 34), c & 4 && Object.freeze(a)));
    return a
  }
  if (a != null && a[Ab] === Hb) return b = a.C, c = b[G] | 0, Ib(a, c) ? a : Mc(a, b, c) ? Nc(a,
    b) : Lc(b, c);
...
function Xc(a, b, c, d, e, f, g, h) {
  var k = b;
  f === 1 || (f !== 4 ? 0 : 2 & b || !(16 & b) && 32 & d) ? Yc(b) || (b |= !a.length || g && !(
      4096 & b) || 32 & d && !(4096 & b || 16 & b) ? 2 : 256, b !== k && H(a, b), Object.freeze(
    a)) : (f === 2 && Yc(b) && (a = Array.prototype.slice.call(a), k = 0, b = Zc(b, d), d = Wc(c,
    d, e, a)), Yc(b) || (h || (b |= 16), b !== k && H(a, b)));
...
function bd(a) {
  return a == null ? a : typeof a === "string" ? a ? new kb(a, ib) : lb() : a.constructor === kb ?
    a : gb && a != null && a instanceof Uint8Array ? a.length ? new kb(new Uint8Array(a), ib) :
  lb() : void 0
}
...
q.compare = function(a) {
  return this.H == a.H ? this.K == a.K ? 0 : this.K >>> 0 > a.K >>> 0 ? 1 : -1 : this.H > a.H ?
    1 : -1
};
...
q.div = function(a) {
  ...
  for (c = this; c.compare(a) >= 0;) {
    var d = Math.max(1, Math.floor(Sd(c) / Sd(a))),
      e = Math.ceil(Math.log(d) / Math.LN2);
    e = e <= 48 ? 1 : Math.pow(2, e - 48);
    for (var f = Zd(d), g = f.multiply(a); g.H < 0 || g.compare(c) > 0;) d -= e, f = Zd(d), g = f
      .multiply(a);
    Ud(f) && (f = Wd);
    b = b.add(f);
    c = c.add(Td(g))
...
function Zd(a) {
  return a > 0 ? a >= 0x7fffffffffffffff ? $d : new Rd(a, a / 4294967296) : a < 0 ? a <= -
    0x7fffffffffffffff ? Vd : Td(new Rd(-a, -a / 4294967296)) : Yd
}
...
function T(a) {
  qe(a.j) && (Error.captureStackTrace ? Error.captureStackTrace(U(a.j, qe, re)) : U(a.j, qe, re)
    .stack = Error().stack)
}
...
function U(a, b, c) {
  if (a != null && !b(a)) throw a = P(me(Se(a))) + " cannot be cast to " + P(me(Q(c))), b = new Ge,
    b.l = a, T(b), S(b, Error(b)), b.j;
  return a
};
      ...
      if (e.aa > 1) {
        ...
        if (c != null && Array.isArray(c)) {
          var g = c.ra || {
            ...
            h = g.aa;
          h == e ? (e = g.ba, d = e === d ? !0 : d && d.prototype.Qa || e && e.prototype.Qa ? !1 :
            f(e.prototype)) : d = h > e ? O == d : !1
        } else d = !1;
        if (!d) {
          d = !1;
          break a
...
function me(a) {
  return a.l != 0 ? P(ef("[", a.l)) + P(a.j.prototype.D[1] == 3 ? a.j.prototype.D[2] : "L" + P(a.j
    .prototype.D[0]) + ";") : a.j.prototype.D[0]
}

function ff(a, b) {
  b = a.lastIndexOf(b) + 1 | 0;
  var c = a.length + 1 | 0;
  if (b < 0 || b >= c) throw a = new Le, a.l = "Index: " + b + ", Size: " + c, T(a), S(a, Error(a)),
    a.j;
  return a.substr(b)
}
df.prototype.toString = function() {
  return String(this.l == 0 && this.j.prototype.D[1] == 1 ? "interface " : this.l == 0 && this.j
    .prototype.D[1] == 3 ? "" : "class ") + P(me(this))
};
...
wg.prototype.then = function(a, b, c) {
  return Ig(this, eg(typeof a === "function" ? a : null), eg(typeof b === "function" ? b : null),
    c)
};
...
function Kg(a, b) {
  if (a.j == 0)
    if (a.o) {
      var c = a.o;
      if (c.l) {
        for (var d = 0, e = null, f = null, g = c.l; g && (g.A || (d++, g.j == a && (e = g), !(e &&
            d > 1))); g = g.next) e || (f = g);
        e && (c.j == 0 && d == 1 ? Kg(c, b) : (f ? (d = f, d.next == c.v && (c.v = d), d.next = d
          .next.next) : Lg(c), Mg(c, e, 3, b)))
      }
      a.o = null
    } else xg(a, 3, b)
}
...
function xg(a, b, c) {
  a.j == 0 && (a === c && (b = 3, c = new TypeError("Promise cannot resolve to itself")), a.j = 1,
    Dg(c, a.zb, a.Ab, a) || (a.I = c, a.j = b, a.o = null, Og(a), b != 3 || c instanceof Jg || Pg(
      a, c)))
}
...
function Xg(a) {
  ...
  a.l = b;
  d && (h = B(a.J, a, !0), d = B(a.J, a, !1), b instanceof Tg ? (ah(b, h, d), b.L = !0) : b.then(h,
    d));
...
function xh(a) {
  if (!((a.l.get(null) + 1 | 0) / V(a.l.o / 1E3) <= a.o)) throw (new uh("Query would cause " + P(a
    .G) + " to exceed " + a.o + " qps.")).j;
  a = a.l;
  var b = Sd(Zd(Date.now()));
  yh(a, b);
  var c = U(zh(a.j), Ah, Bh);
  if (c == null || V(b) >= V(c.l)) b = Ch(a, V(b)), c = new Bh, c.l = b, c.j = 0, c.v = 2147483647,
...
function Dh(a) {
  this.l = this.o = 0;
  a != null ? "number" === typeof a ? (a = V(a), a = Math.max(Math.min(a, 2147483647), -
    2147483648) | 0) : a = a instanceof Rd ? V(a).K : a.X : a = 100;
  this.o = a;
  this.j = U([], mf, lf)
}
x(Dh, O);
...
q.la = function() {
  for (var a = this.j.length, b = this.j.length - this.j.length | 0, c = U([], mf, lf); b < a; b =
    b + 1 | 0) {
    var d = c,
      e = this.get(b);
    d.push(e)
...
function Rh(a, b) {
  for (var c, d, e = 1; e < arguments.length; e++) {
    d = arguments[e];
    for (c in d) a[c] = d[c];
    for (var f = 0; f < Qh.length; f++) c = Qh[f], Object.prototype.hasOwnProperty.call(d, c) && (a[
      c] = d[c])
  }
};
...
function Sh(a) {
  ...
  this.A = !1;
  var b;
  a instanceof Sh ? (this.A = a.A, Th(this, a.v), this.I = a.I, this.j = a.j, Uh(this, a.B), Vh(
      this, a.l), Wh(this, a.o.clone()), this.G = a.G) : a && (b = String(a).match(Vf)) ? (this
      .A = !1, Th(this, b[1] || "", !0), this.I = Xh(b[2] || ""), this.j = Xh(b[3] || "", !0), Uh(
        this, b[4]), Vh(this, b[5] || "", !0), Wh(this, b[6] || "", !0), this.G = Xh(b[7] || "")) :
    (this.A = !1, this.o = new Yh(null, this.A))
}
Sh.prototype.toString = function() {
  ...
  b && a.push(Zh(b, $h, !0), ":");
  var c = this.j;
  if (c || b == "file") a.push("//"), (b = this.I) && a.push(Zh(b, $h, !0), "@"), a.push(
      encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.B, c !=
    null && a.push(":", String(c));
  if (c = this.l) this.j && c.charAt(0) != "/" && a.push("/"), a.push(Zh(c, c.charAt(0) == "/" ?
    ai : bi, !0));
...
si.prototype.add = function(a, b, c, d, e) {
  ...
  a || (a = this.j[f] = [], this.l++);
  var g = ti(a, b, d, e);
  g > -1 ? (b = a[g], c || (b.ia = !1)) : (b = new qi(b, this.src, f, !!d, e), b.ia = c, a.push(
    b));
  return b
};
si.prototype.remove = function(a, b, c, d) {
  ...
  var e = this.j[a];
  b = ti(e, b, c, d);
  return b > -1 ? (ri(e[b]), Array.prototype.splice.call(e, b, 1), e.length == 0 && (delete this
    .j[a], this.l--), !0) : !1
};
...
function Bi(a, b, c, d, e, f) {
  ...
  d.src = a;
  d.listener = c;
  if (a.addEventListener) mi || (e = g), e === void 0 && (e = !1), a.addEventListener(b.toString(),
    d, e);
...
function zi(a, b, c, d, e) {
  ...
  c = Ai(c);
  return a && a[oi] ? a.l.add(String(b), c, !0, Ka(d) ? !!d.capture : !!d, e) : Bi(a, b, c, !0, d,
    e)
}
...
function Hi(a, b, c, d, e) {
  ...
  else(d = Ka(d) ? !!d.capture : !!d, c = Ai(c), a && a[oi]) ? a.l.remove(String(b), c, d, e) : a &&
    (a = Di(a)) && (b = a.j[b.toString()], a = -1, b && (a = ti(b, c, d, e)), (c = a > -1 ? b[a] :
      null) && Ii(c))
}
  ...
  if (typeof a !== "number" && a && !a.removed) {
    ...
    if (b && b[oi]) ui(b.l, a);
      ...
      b.removeEventListener ? b.removeEventListener(c, d, a.capture) : b.detachEvent ? b
        .detachEvent(Fi(c), d) : b.addListener && b.removeListener && b.removeListener(d);
      xi--;
...
function Ui(a, b, c) {
  b && (a.j.stop(), Vi(a, a.v));
  a.isActive() || (b = Math.max(0, a.B + a.l - Date.now()), b == 0 && (c ? b = Vi(a, a.v) : a.l =
    0), a.j.start(b))
}
q.stop = function() {
  this.j.stop()
...
function bj(a, b) {
  ...
  try {
    ...
    a.O && (c = W(c, "errorSender_sendTimeMs", Date.now().toString()), c = W(c, "errorSenderType", a
      .Ka()), b.errorSender_frontIndex && (c = W(c, "errorSender_frontIndex", b
      .errorSender_frontIndex)), b.errorSender_nextIndex && (c = W(c, "errorSender_nextIndex", b
      .errorSender_nextIndex)), b.errorSender_queueSize && (c = W(c, "errorSender_queueSize", b
...
q.pb = function() {
  ...
  c || d ? (this.A = 0, this.F = null, this.l.stop(), $g(gh(), function() {
    Vg(b);
    Wg(b, !0)
  })) : (this.A++, this.F = a === -1 ? this.j.B : a, Zi(this), this.enqueue(this.V), Vg(b), Wg(
    b, !0))
};
...
tj.prototype.fa = function() {
  ...
  if (c == null ? 0 : pc(K(c, 2)) != null) {
    var d;
    (b = (d = sd(c, 2)) == null ? void 0 : d.toString()) && a.set("canaryanalysisservertestgroup",
      b);
    if (c == null) var e = void 0;
      ...
      var f = f === void 0 ? !1 : f;
      var g = typeof b;
      b == null ? f = b : g === "bigint" ? f = String(hc(64, b)) : oc(b) ? g === "string" ? (f =
        b, oc(f), b = kc(Number(f)), ic(b) ? f = String(b) : (b = f.indexOf("."), b !== -1 && (
          f = f.substring(0, b)), f = rc(f))) : f = f ? tc(b) : sc(b) : f = void 0;
      e = d(f != null ? f : e);
      c = pd(c, 2);
...
wj.prototype.fa = function() {
  ...
  try {
    for (; !c.done; c = b.next()) {
      var g = c.value,
        h = Bj(g.key);
      h === 0 ? (a.set("apps_telemetry.automation_property_present." + g.T, "true"), e = !0) :
        h === 2 && a.set("apps_telemetry.automation_property_check_failed." + g.T, "true")
    }
  } finally {
...
function rk(a, b) {
  ...
  try {
    ...
    e = !1, a = fk(w, c), d.set("apps_telemetry.handling_error", Sj(a))
  }
...
function $k(a) {
  D.call(this, "Error in protected function: " + (a && a.message ? String(a.message) : String(a)),
    a);
...
q.send = function(a, b, c, d) {
  ...
  "withCredentials" in this.j && this.j.withCredentials !== this.S && (this.j.withCredentials =
    this.S);
  try {
    this.v && (clearTimeout(this.v), this.v = null), this.O > 0 && (this.v = setTimeout(this.yb
      .bind(this), this.O)), this.F = !0, this.j.send(a), this.F = !1
  } catch (t) {
    gl(this)
  }
};
...
q.abort = function(a) {
  this.j && this.o && (this.o = !1, this.A = !0, this.j.abort(), this.A = !1, this.B = a || 7,
    this.dispatchEvent("complete"), this.dispatchEvent("abort"), il(this))
};
q.N = function() {
...
function ej(a) {
  ...
  if (!c) {
    if (b = b === 0) a = String(a.M).match(Vf)[1] || null, !a && A.self && A.self.location && (a = A
      .self.location.protocol.slice(0, -1)), b = !dl.test(a ? a.toLowerCase() : "");
    c = b
  }
  return c
}
...
function yl(a) {
  ...
  a.M.listen(a.j, "c", function(e) {
    ...
    var g = e.Z.severity;
    (g = g == "fatal" || g == "postmortem") && !a.gb && (a.ib && !f ? a.U.notify(e, e.Z) : a.U
      .notify(void 0, e.Z));
...
function El(a, b, c, d) {
  ...
  try {
    ...
    throw e && !a.O && (a.J = !1), a.F = !0, c.provideLogDataError = g.message, c.severity || (c
      .severity = "fatal"), Jf(g);
  } finally {
...
vl.prototype.V = function(a, b, c) {
  ...
  g = a.stack || "";
  if (g.trim().length == 0 || g == "Not available") b["stacklessError-reportingStack"] = If(vl
    .prototype.V), [a.message].concat(oa(Object.keys(b)), oa(Object.values(b))).some(function(
  h) {
    return h && h.includes("<eye3")
  }) || (b.eye3Hint = "<eye3-stackless title='Stackless JS Error - " + a.name + "'/>");
  this.F && !this.O ? (this.J = this.A, c == "fatal" ? c = "postmortem" : c == "incident" && (c =
    "warningafterdeath")) : c == "fatal" && (this.F = !0);
  this.A = !1;
  b.severity = c
};
  ...
  return ya(new xa(new ta(function(u) {
    switch (u.j) {
      ...
      case 5:
        ...
        d = c.next();
        try {
          for (; !d.done; d = c.next()) f = d.value, g = y(f), h = g.next().value, k = g
            .next().value, l = h, m = k, r = void 0, b.set(l, (r = m) != null ? r : "")
        } finally {
          d && !d.done && (e = c.return) && e.call(c)
        }
      case 3:
...
Pl.prototype.Oa = function(a, b) {
  ...
  if (a || c) c = id(this.j, rj, 3), b = new qj, b = vd(b, 1, this.o), b = vd(b, 2, this.l), nd(c,
    qj, 5, b), Ql(this)
};
...
q.ob = function(a) {
  if (this.j && (this.F = a, this.A || (this.status = this.F.status, this.statusText = this.F
      .statusText, this.A = a.headers, this.readyState = 2, Tl(this)), this.j && (this
      .readyState = 3, Tl(this), this.j)))
    if (this.responseType === "arraybuffer") a.arrayBuffer().then(this.mb.bind(this), this.ma
      .bind(this));
...
function jm(a, b) {
  var c = b.j;
  c && c.data && c.ports && c.ports.length ? (b = c.data ? em(JSON.stringify(c.data)) : new dm, km(
    a, b, c.ports.length > 1 ? c.ports[1] : void 0).then(function(d) {
    c.ports[0].postMessage(Gc(d))
  })) : Yl(a.j, Error("Dropped invalid event."), {
    event: String(b)
  })
}
...
// offscreen → extension worker 的 runtime RPC，使用原始数组消息格式。
function nm(a) {
  var b = Gg();
  chrome.runtime.sendMessage(Gc(a), void 0, function(c) {
    return om(b, function(d) {
      return new lm(d)
    }, c)
  });
  return b.promise.Ra(function(c) {
    c = Hf(c);
    nb(c, "offscreenDocumentRequestType", sd(a, 1).toString());
    throw c;
  })
}
...
function om(a, b, c) {
  ...
  c !== void 0 ? (d = b(c), d.xa() ? (b = a.reject, c = Error, d = d.xa(), d = td(d, 1), b.call(a,
...
// GoogleIframeManager（研究命名）：维护 iframe、握手门闩、超时与消息端口。
function qm(a) {
  X.call(this);
  this.j = this.B = null;
  this.A = Gg();
...
// 移除 iframe 并清理超时，必要时重置握手状态。
function rm(a) {
  A.clearTimeout(a.o);
  a.j && (a.v && (a.A = Gg(), a.v = !1), a.j.parentNode && a.j.parentNode.removeChild(a.j), a.j =
    null);
  return Promise.resolve()
}

function sm(a, b) {
  return a.j ? Promise.resolve() : tm(a, b)
}

// 创建 extensionFrame iframe；14 秒未握手进入关闭路径。
function tm(a, b) {
  b || Xl(a.l, Error("Creating extension frame without an OUID."));
  var c = um(a, b);
  return rm(a).then(function() {
    a.j = vj("IFRAME");
    a.j.id = "extensionFrame";
    Bf(a.j, pm(c));
    document.body.appendChild(a.j);
    a.o = Qi(function() {
      Yl(a.l, Error("Timed out waiting for frame connection."));
      return Eg([Ri(), $i(a.B.B)]).then(function() {
        A.close()
      })
    }, 14E3);
    return Promise.resolve()
...
// 构造 Google 同源后台页面 /offline/extension/frame?ouid=...，账号值做 URL 编码。
function um(a, b) {
  return Vh(a.F, "/offline/extension/frame").toString() + "?ouid=" + (b ? encodeURIComponent(String(
    b)) : "")
}

// 每次 frame RPC 使用 MessageChannel；响应后关闭本地回复端口。
function vm(a, b) {
  return Promise.resolve(a.A.promise).then(function(c) {
    var d = new MessageChannel;
    return (new Promise(function(e) {
      d.port1.onmessage = function(f) {
        e(new fm(f.data))
      };
      c.postMessage(Gc(b), [d.port2])
    })).finally(function() {
      d.port1.close()
    })
  })
...
// OffscreenLifetime（研究命名）：跟踪外部连接数，避免无界后台常驻。
function Bm() {
  X.call(this);
  var a = this;
  this.o = null;
  this.l = this.j = 0;
  chrome.runtime.onConnectExternal.addListener(function(b) {
    return Cm(a, b)
  });
  Dm(this)
}
...
// 连接归零后的空闲关闭：60 秒。
function Em(a) {
  a.j == 0 && (A.clearTimeout(a.l), a.l = Qi(function() {
    a.j == 0 && A.close()
  }, 6E4))
}

// offscreen 从启动起 1 小时关闭；这不是永久保活机制。
function Dm(a) {
  Qi(function() {
    a.o && Hl(a.o, Hf("Force closed the offscreen document after one hour."));
    A.close()
  }, 36E5)
};
...
// OffscreenController（研究命名）：解析启动参数、注册消息监听和生命周期。
function Jm() {
  X.call(this);
  var a = this,
    b = new Sh(self.location);
  this.V = Km(b, "sessionId", function(c) {
    return String(c)
  }, kf());
  this.j = this.l = this.M = null;
  this.o = new Bm;
  Em(this.o);
  this.O = new Fm;
  Gm(this.O);
  this.L = new Wi(this);
  dg(this, this.L);
  this.L.listen(A, "message", this.S);
  this.J = Km(b, "randomPercentageForSampling", function(c) {
    return Number(c)
  }, Math.random() * 100);
  this.R = this.J < 1;
  this.v = new Wl(this.J);
  this.B = "unknown";
  this.F = null;
  this.A = "unknown";
  this.P = new im(this.v, function(c, d) {
    return Lm(a, c, d)
  });
  chrome.runtime.onMessage.addListener(this.U.bind(this))
}
x(Jm, X);
Jm.prototype.S = function(a) {
  jm(this.P, a)
};

// Google frame → offscreen：type 1 完成握手，type 3 回传账号状态；继续转给 worker。
function Lm(a, b, c) {
  var d = hm(new gm, pc(K(b, 1)));
  switch (pc(K(b, 1, void 0, Tc))) {
    case 1:
      b = (b = ld(b, $l, 7)) ? td(b, 1) : null;
      var e = am();
      b ? ud(e, 1, b) : Xl(a.v, Error("Scheduler frame connect request sent without an ouid."));
      b = zm(e);
      return nm(b).then(function() {
        var f = a.j;
        f.A.resolve(c);
        f.v = !0;
        A.clearTimeout(f.o)
    ...
    case 3:
      return b = Am(ym(7), ld(b, cm, 3)), nm(b).then(function() {
        return d
      })
  }
  throw Error("Dropped unknown message " + b);
}
Jm.prototype.U = function(a, b, c) {
  var d = this;
  A.clearTimeout(this.o.l);
  var e = new xm(a);
  Mm(this, e).then(function(f) {
    c(Gc(f))
  }).catch(function(f) {
    var g = f instanceof Error ? f : Error(f);
    f = new Zl;
    ud(f, 1, g.message);
    g = mm(new lm, pc(K(e, 1)));
    nd(g, Zl, 3, f);
    c(Gc(g))
  }).finally(function() {
    Em(d.o)
...
// worker → offscreen：1 重建 iframe；4 frame RPC；5 移除 iframe；6 确保 iframe 存在。
function Mm(a, b) {
  var c = mm(new lm, pc(K(b, 1)));
  try {
    switch (pc(K(b, 1, void 0, Tc))) {
      case 1:
        return Nm(a, b), tm(a.j, a.F).then(function() {
          return c
        });
      case 4:
        return vm(a.j, ld(b, bm, 5)).then(function(d) {
          nd(c, fm, 4, d);
          return c
        });
      case 5:
        return rm(a.j).then(function() {
          return c
        });
      case 6:
        return Nm(a, b), sm(a.j, a.F).then(function() {
          return c
        });
      default:
...
// 惰性初始化：账号、Google origin、版本、状态及日志上下文。
function Nm(a, b) {
  if (!a.j) {
    b = ld(b, wm, 2);
    a.F = td(b, 1);
    a.M = td(b, 2);
    var c;
    a.B = (c = vc(K(b, 4))) != null ? c : a.B;
    var d;
    a.A = (d = vc(K(b, 3))) != null ? d : a.A;
    c = new Sh(a.M);
    var e = Vh(c, "/offline/jserror").toString();
    d = a.R;
    b = a.V;
    var f = f === void 0 ? !1 : f;
    var g = g === void 0 ? mh() : g;
    ...
    k.v = Rl;
    f = new vl(k);
    f.o.sessionTypeName = "offline-off-screen-document";
    f.o.reportsNonFatalErrors = String(d);
    f.o.sid = b;
    f.o.extensionVersion = a.A;
    f.o.optInStatus = a.B;
    a.l = f;
    dg(a, a.l);
    a.v.j = a.l;
    a.o.o = a.l;
    a.j = new qm(a.J, "OffscreenDocument");
    f = a.j;
    g = a.l;
    f.B = g;
    f.l.j = g;
...
function Km(a, b, c, d) {
  a = a.o.la(b);
  return a.length != 0 ? c(a[0]) : d
};
// 原始 offscreen 入口。完整 Docs 编辑器与 Google 同源业务脚本不在此包中。
new Jm;
