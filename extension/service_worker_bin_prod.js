// Google Docs Offline 1.110.1 — 本机原始代码的可读副本。
...
function r(a, b) {
  if (b) a: {
    ...
    a = a[a.length - 1];d = c[a];b = b(d);b != d && b != null && ea(c, a, {
      configurable: !0,
      writable: !0,
      value: b
    })
...
y.prototype.P = function(a, b) {
  ...
  (b = this.l = this.l || b) ? b.Oa ? this.j = this.D || this.v : b.ha != void 0 && this.v < b
    .ha ? (this.j = b.ha, this.l = null) : this.j = this.v: this.j = a
};
...
r("Promise", function(a) {
  ...
  b.all = function(g) {
    ...
    return k.done ? d([]) : new b(function(l, m) {
      ...
      var t = [],
        x = 0;
      do t.push(void 0), x++, d(k.value).ka(q(t.length - 1), m), k = h.next();
      while (!k.done)
    })
  };
  return b
...
r("WeakMap", function(a) {
  ...
  b.prototype.has = function(k) {
    return d(k) && Ca(k, g) && Ca(k[g], this.j)
  };
  b.prototype.delete = function(k) {
    return d(k) && Ca(k, g) && Ca(k[g], this.j) ? delete k[g][this.j] : !1
  };
  return b
});
r("Map", function(a) {
  ...
  function d(h, k) {
    var l = k && typeof k;
    l == "object" || l == "function" ? f.has(k) ? l = f.get(k) : (l = "" + ++g, f.set(k, l)) :
      l = "p_" + k;
    var m = h[0][l];
    if (m && Ca(h[0], l))
  ...
  e.prototype.set = function(h, k) {
    ...
    l.entry ? l.entry.value = k : (l.entry = {
        ...
        key: h,
        value: k
      }, l.list.push(l.entry), this[1].previous.next = l.entry, this[1].previous = l.entry,
      this.size++);
    return this
  };
  e.prototype.delete = function(h) {
    h = d(this, h);
    return h.entry && h.list ? (h.list.splice(h.index, 1), h.list.length || delete this[0][h
        .id
  ...
  e.prototype.forEach = function(h, k) {
    for (var l = this.entries(), m; !(m = l.next()).done;) m = m.value, h.call(k, m[1], m[0],
      this)
  };
...
r("Set", function(a) {
  ...
  if (function() {
      ...
      try {
        ...
        f = e.next();
        return f.done || f.value[0] == c || f.value[0].x != 4 || f.value[1] != f.value[0] ? !1 :
          e.next().done
      } catch (g) {
        return !1
      }
...
function A(a, b, c) {
  A = Function.prototype.bind && Function.prototype.bind.toString().indexOf("native code") != -1 ?
    Pa : Qa;
...
function bb() {
  return Xa ? !!Za && Za.brands.length > 0 : !1
};
...
var gb = C("Firefox") || C("FxiOS"),
  hb = C("Safari") && !((bb() ? ab("Chromium") : (C("Chrome") || C("CriOS")) && (bb() || !C(
    "Edge")) || C("Silk")) || (bb() ? 0 : C("Coast")) || (bb() ? 0 : C("Opera")) || (bb() ? 0 : C(
    "Edge")) || (bb() ? ab("Microsoft Edge") : C("Edg/")) || (bb() ? ab("Opera") : C("OPR")) || C(
    "Firefox") || C("FxiOS") || C("Silk") || C("Android")) && !(C("iPhone") && !C("iPod") && !C(
    "iPad") || C("iPad") || C("iPod"));
var ib = {},
  jb = null;
var kb = typeof Uint8Array !== "undefined",
  lb = typeof btoa === "function",
  mb = {},
  nb = typeof structuredClone != "undefined";
...
var wb = typeof Symbol === "function" && typeof Symbol() === "symbol";

function xb(a, b, c) {
  return typeof Symbol === "function" && typeof Symbol() === "symbol" ? (c === void 0 ? 0 : c) &&
    Symbol.for && a ? Symbol.for(a) : a != null ? Symbol(a) : Symbol() : b
}
var yb = xb("jas", void 0, !0),
  zb = xb(void 0, "0di"),
  Ab = xb(void 0, "1oa"),
  Bb = xb(void 0, Symbol()),
  Cb = xb(void 0, "0ubs"),
...
var Yb = Rb(function(a) {
  ...
  bc = Number.MIN_SAFE_INTEGER.toString(),
  Zb = Wb ? BigInt(Number.MIN_SAFE_INTEGER) : void 0,
  cc = Number.MAX_SAFE_INTEGER.toString(),
  $b = Wb ? BigInt(Number.MAX_SAFE_INTEGER) : void 0;
...
function jc(a, b) {
  ...
  else vb() ? c = "" + (BigInt(b) << BigInt(32) | BigInt(a)) : (c = (a >>> 24 | b << 8) & 16777215,
    b = b >> 16 & 65535, a = (a & 16777215) + c * 6777216 + b * 6710656, c += b * 8147497, b *= 2,
    a >= 1E7 && (c += a / 1E7 >>> 0, a %= 1E7), c >= 1E7 && (b += c / 1E7 >>> 0, c %= 1E7), c =
    b + kc(c) + kc(a));
  return c
}
...
function lc() {
  var a = F,
    b = ec;
  b & 2147483648 ? vb() ? a = "" + (BigInt(b | 0) << BigInt(32) | BigInt(a >>> 0)) : (b = w(ic(a,
    b)), a = b.next().value, b = b.next().value, a = "-" + jc(a, b)) : a = jc(a, b);
  return a
}
...
var mc = typeof BigInt === "function" ? BigInt.asIntN : void 0,
  nc = Number.isSafeInteger,
  oc = Number.isFinite,
  pc = Math.trunc;
...
function xc(a) {
  ...
  else if (vb()) a = BigInt(a), F = Number(a & BigInt(4294967295)) >>> 0, ec = Number(a >> BigInt(
    32) & BigInt(4294967295));
  else {
    b = +(a[0] === "-");
    ec = F = 0;
    for (var c = a.length, d = 0 + b, e = (c - b) % 6 + b; e <= c; d = e, e += 6) d = Number(a
      .slice(d, e)), ec *= 1E6, F = F * 1E6 + d, F >= 4294967296 && (ec += Math.trunc(F /
      4294967296), ec >>>= 0, F >>>= 0);
...
function Ac(a) {
  ...
  if (uc(a)) return b === "string" ? (b = pc(Number(a)), nc(b) ? a = Xb(b) : (b = a.indexOf("."),
      b !== -1 && (a = a.substring(0, b)), a = vb() ? Xb(mc(64, BigInt(a))) : Xb(xc(a)))) : a =
    nc(a) ? Xb(yc(a)) : Xb(zc(a)), a
}
...
function Jc(a, b, c, d) {
  ...
  if (q)
    for (var E in q) h = q[E], h != null && (h = c(h, d)) != null && (t = +E, x = void 0, l && !
      Number.isNaN(t) && (x = t + m) < g ? f[x] = h : (t = void 0, ((t = b) != null ? t : b = {})[
        E] = h));
  b && (k ? f.push(b) : f[g] = b);
    ...
    case "object":
      ...
      if (a instanceof ob) {
        ...
        if (b == null) a = "";
          ...
          if (lb) {
            for (var c = "", d = 0, e = b.length - 10240; d < e;) c += String.fromCharCode.apply(
              null, b.subarray(d, d += 10240));
...
function Qc(a, b) {
  ...
  if (Array.isArray(a)) {
    var c = a[D] | 0;
    a.length === 0 && c & 1 ? a = void 0 : c & 2 || (!b || 4096 & c || 16 & c ? a = Rc(a, c, !1,
      b && !(c & 16)) : (Kb(a, 34), c & 4 && Object.freeze(a)));
    return a
  }
  if (a != null && a[Eb] === Mb) return b = a.B, c = b[D] | 0, Nb(a, c) ? a : Sc(a, b, c) ? Tc(a,
    b) : Rc(b, c);
...
function Uc(a) {
  var b = a.B,
    c = b[D] | 0;
  return Nb(a, c) ? Sc(a, b, c) ? Tc(a, b, !0) : new a.constructor(Rc(b, c, !1)) : a
}
...
function Sc(a, b, c) {
  return c & 2 ? !0 : c & 32 && !(c & 4096) ? (Jb(b, c | 2), a.j = Ob, !0) : !1
};
var Yc = Xb(0),
  Zc = {};
...
function cd(a, b, c, d, e, f, g, h) {
  var k = b;
  f === 1 || (f !== 4 ? 0 : 2 & b || !(16 & b) && 32 & d) ? dd(b) || (b |= !a.length || g && !(
    4096 & b) || 32 & d && !(4096 & b || 16 & b) ? 2 : 256, b !== k && Jb(a, b), Object.freeze(
    a)) : (f === 2 && dd(b) && (a = Array.prototype.slice.call(a), k = 0, b = ed(b, d), d = bd(c,
    d, e, a)), dd(b) || (h || (b |= 16), b !== k && Jb(a, b)));
...
function hd(a) {
  return a == null ? a : typeof a === "string" ? a ? new ob(a, mb) : pb() : a.constructor === ob ?
    a : kb && a != null && a instanceof Uint8Array ? a.length ? new ob(new Uint8Array(a), mb) :
  pb() : void 0
}
...
function nd(a) {
  if (wb) {
    var b;
    return (b = a[Ab]) != null ? b : a[Ab] = new Map
  }
...
function rd(a, b, c) {
  ...
  if (g = !(4 & m)) {
    var q = a,
      ...
      x = !!(2 & m);
    x && (t |= 2);
    for (var u = !x, N = !0, E = 0, ma = 0; E < q.length; E++) {
      var U = Cc(q[E], b, !1, t);
      if (U instanceof b) {
        if (!x) {
          var Ma = Nb(U);
...
function sd(a, b, c, d) {
  if (d != null) {
    if (!(d instanceof b)) throw Error("Expected instanceof " + rc(b) + " but got " + (d && rc(d
      .constructor)));
  } else d = void 0;
  ad(a, c, d);
  d && !Nb(d) && Xc(a.B);
...
J.prototype.clone = function() {
  var a = this.B,
    b = a[D] | 0;
  return Sc(this, a, b) ? Tc(this, a, !0) : new this.constructor(Rc(a, b, !1))
};
...
function Dd() {
  ...
  c = a.B;
  b = c[D] | 0;
  return Nb(a, b) ? a : Sc(a, c, b) ? Tc(a, c) : new a.constructor(Rc(c, b, !0))
}
J.prototype[Eb] = Mb;
...
Nd.prototype.ctor = function(a) {
  ...
  try {
    ...
    if (wd(a, 1).split("/").pop() != e) var f = null;
      ...
      var m = Cc(l, g, !0, k);
      if (!(m instanceof g)) throw Error("incorrect type in any value: got " + m.constructor
        .displayName + ", expected " + g.displayName);
      (g = !!(2 & k)) || (m = Uc(m));
...
p.equals = function(a) {
  return a == null ? !1 : this.K == a.K && this.I == a.I
};
p.compare = function(a) {
  return this.I == a.I ? this.K == a.K ? 0 : this.K >>> 0 > a.K >>> 0 ? 1 : -1 : this.I > a.I ?
    1 : -1
};
...
p.div = function(a) {
  ...
  for (c = this; c.compare(a) >= 0;) {
    var d = Math.max(1, Math.floor(Yd(c) / Yd(a))),
      e = Math.ceil(Math.log(d) / Math.LN2);
    e = e <= 48 ? 1 : Math.pow(2, e - 48);
    for (var f = ee(d), g = f.multiply(a); g.I < 0 || g.compare(c) > 0;) d -= e, f = ee(d), g = f
      .multiply(a);
    $d(f) && (f = be);
    b = b.add(f);
    c = c.add(Zd(g))
...
function ee(a) {
  return a > 0 ? a >= 0x7fffffffffffffff ? fe : new Xd(a, a / 4294967296) : a < 0 ? a <= -
    0x7fffffffffffffff ? ae : Zd(new Xd(-a, -a / 4294967296)) : de
}
...
function Q(a) {
  we(a.j) && (Error.captureStackTrace ? Error.captureStackTrace(R(a.j, we, xe)) : R(a.j, we, xe)
    .stack = Error().stack)
}
...
function R(a, b, c) {
  if (a != null && !b(a)) throw a = M(se(Ye(a))) + " cannot be cast to " + M(se(O(c))), b = new Me,
    b.l = a, Q(b), P(b, Error(b)), b.j;
  return a
};
      ...
      if (e.ba > 1) {
        ...
        if (c != null && Array.isArray(c)) {
          var g = c.ra || {
            ...
            h = g.ba;
          h == e ? (e = g.ca, d = e === d ? !0 : d && d.prototype.Ra || e && e.prototype.Ra ? !1 :
            f(e.prototype)) : d = h > e ? L == d : !1
        } else d = !1;
        if (!d) {
          d = !1;
          break a
...
function se(a) {
  return a.l != 0 ? M(lf("[", a.l)) + M(a.j.prototype.F[1] == 3 ? a.j.prototype.F[2] : "L" + M(a.j
    .prototype.F[0]) + ";") : a.j.prototype.F[0]
}

function mf(a, b) {
  b = a.lastIndexOf(b) + 1 | 0;
  var c = a.length + 1 | 0;
  if (b < 0 || b >= c) throw a = new Re, a.l = "Index: " + b + ", Size: " + c, Q(a), P(a, Error(a)),
    a.j;
  return a.substr(b)
}
kf.prototype.toString = function() {
  return String(this.l == 0 && this.j.prototype.F[1] == 1 ? "interface " : this.l == 0 && this.j
    .prototype.F[1] == 3 ? "" : "class ") + M(se(this))
};
...
p.dispose = function() {
  ...
  else this.j = !0, a = this.v == null ? zf : this.v, this.v = null;
  if (a != null) {
    this.sa();
    if (a.length != 0)
...
function Df(a) {
  ...
  return !c && a.lineNumber && a.fileName && a.stack && a.message && a.name ? {
    ...
    '"' : "Unknown Error of unknown type", typeof a.toString === "function" && Object.prototype
...
function Ef(a, b) {
  ...
  var c = a.stack || "",
    d = a.cause;
  d && !b[Gf(d)] && (c += "\nCaused by: ", d.stack && d.stack.indexOf(d.toString()) == 0 || (c +=
  ...
  if (Array.isArray(a)) {
    ...
    for (e = 0; e < a.length && !(d > 4); e++) b[Gf(a[e])] || (c += "\nInner error " + d++ + ": ",
      a[e].stack && a[e].stack.indexOf(a[e].toString()) == 0 || (c += typeof a[e] === "string" ?
        a[e] : a[e].message + "\n"), c += Ef(a[e], b));
...
var eg = typeof AsyncContext !== "undefined" && typeof AsyncContext.Snapshot === "function" ?
  function(a) {
  ...
  return new X(function(b, c) {
    ...
    if (d)
      for (var f = function(l, m) {
          ...
          c(l)
        }, h, k = 0; k < a.length; k++) h = a[k], Cg(h, Ra(f, k), g);
    else b(e)
  })
}
...
X.prototype.then = function(a, b, c) {
  return Jg(this, eg(typeof a === "function" ? a : null), eg(typeof b === "function" ? b : null),
    c)
};
X.prototype.$goog_Thenable = !0;
p = X.prototype;
p.T = function(a, b) {
...
function Lg(a, b) {
  if (a.j == 0)
    if (a.o) {
      var c = a.o;
      if (c.l) {
        for (var d = 0, e = null, f = null, g = c.l; g && (g.D || (d++, g.j == a && (e = g), !(e &&
            d > 1))); g = g.next) e || (f = g);
        e && (c.j == 0 && d == 1 ? Lg(c, b) : (f ? (d = f, d.next == c.v && (c.v = d), d.next = d
          .next.next) : Mg(c), Ng(c, e, 3, b)))
      }
      a.o = null
    } else wg(a, 3, b)
}
...
function wg(a, b, c) {
  a.j == 0 && (a === c && (b = 3, c = new TypeError("Promise cannot resolve to itself")), a.j = 1,
    Dg(c, a.Eb, a.Fb, a) || (a.J = c, a.j = b, a.o = null, Pg(a), b != 3 || c instanceof Kg || Qg(
      a, c)))
}

function Dg(a, b, c, d) {
  if (a instanceof X) return Og(a, zg(b || ug, c || null, d)), !0;
  if (vg(a)) return a.then(b, c, d), !0;
  if (La(a)) try {
    var e = a.then;
    if (typeof e === "function") return Rg(a, e, b, c, d), !0
  } catch (f) {
    return c.call(d, f), !0
  }
  return !1
...
Ug.prototype.cancel = function(a) {
  if (this.o) this.l instanceof Ug && this.l.cancel();
    ...
    this.G = !0;
    this.o || (a = new Vg(this), Wg(this), Xg(this, !1, a))
  }
};
...
function Yg(a) {
  ...
  for (var d = c = !1; a.D.length && !a.J;) {
    ...
    if (f = a.v ? g : f) try {
      ...
      if (vg(b) || typeof z.Promise === "function" && b instanceof z.Promise) d = !0, a.J = !0
    } catch (k) {
      b = k, a.v = !0, eh(a) || (c = !0)
    }
  }
  a.l = b;
  d && (h = A(a.H, a, !0), d = A(a.H, a, !1), b instanceof Ug ? (bh(b, h, d), b.L = !0) : b.then(h,
    d));
...
function yh(a) {
  if (!((a.l.get(null) + 1 | 0) / S(a.l.o / 1E3) <= a.o)) throw (new vh("Query would cause " + M(a
    .A) + " to exceed " + a.o + " qps.")).j;
  a = a.l;
  var b = Yd(ee(Date.now()));
  zh(a, b);
  var c = R(Ah(a.j), Bh, Ch);
  if (c == null || S(b) >= S(c.l)) b = Dh(a, S(b)), c = new Ch, c.l = b, c.j = 0, c.v = 2147483647,
    c.o = -2147483648, a.j.add(c);
  c.j = c.j + 1 | 0;
  c.v = Math.min(1, c.v);
  c.o = Math.max(1, c.o)
}
...
function Eh(a) {
  this.l = this.o = 0;
  a != null ? "number" === typeof a ? (a = S(a), a = Math.max(Math.min(a, 2147483647), -
    2147483648) | 0) : a = a instanceof Xd ? S(a).K : a.Y : a = 100;
  this.o = a;
  this.j = R([], sf, rf)
}
v(Eh, L);
...
p.xa = function() {
  for (var a = this.j.length, b = this.j.length - this.j.length | 0, c = R([], sf, rf); b < a; b =
    b + 1 | 0) {
    var d = c,
      e = this.get(b);
    d.push(e)
...
Lh.prototype.F = [
  "com.google.apps.docsshared.xplat.observable.EventObserverTracker$ObservableObserverPair", 0
];
...
function Sh(a, b) {
  for (var c, d, e = 1; e < arguments.length; e++) {
    d = arguments[e];
    for (c in d) a[c] = d[c];
    for (var f = 0; f < Rh.length; f++) c = Rh[f], Object.prototype.hasOwnProperty.call(d, c) && (a[
      c] = d[c])
  }
};
...
function Th(a) {
  ...
  this.D = !1;
  var b;
  a instanceof Th ? (this.D = a.D, Uh(this, a.v), this.J = a.J, this.j = a.j, Vh(this, a.C), Wh(
      this, a.l), Xh(this, a.o.clone()), this.A = a.A) : a && (b = String(a).match(Vf)) ? (this
      .D = !1, Uh(this, b[1] || "", !0), this.J = Yh(b[2] || ""), this.j = Yh(b[3] || "", !0), Vh(
        this, b[4]), Wh(this, b[5] || "", !0), Xh(this, b[6] || "", !0), this.A = Yh(b[7] || "")) :
    (this.D = !1, this.o = new Zh(null, this.D))
}
Th.prototype.toString = function() {
  ...
  b && a.push($h(b, ai, !0), ":");
  var c = this.j;
  if (c || b == "file") a.push("//"), (b = this.J) && a.push($h(b, ai, !0), "@"), a.push(
      encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.C, c !=
    null && a.push(":", String(c));
  if (c = this.l) this.j && c.charAt(0) != "/" && a.push("/"), a.push($h(c, c.charAt(0) == "/" ?
    bi : ci, !0));
...
p.remove = function(a) {
  ii(this);
  a = ji(this, a);
  return this.j.has(a) ? (this.o = null, this.l = this.l - this.j.get(a).length, this.j.delete(
    a)) : !1
};
p.clear = function() {
  this.j = this.o = null;
...
function pi(a, b) {
  ...
  this.button = this.screenY = this.screenX = this.clientY = this.clientX = this.offsetY = this
    .offsetX = 0;
  this.key = "";
...
pi.prototype.init = function(a, b) {
  ...
  d ? (this.clientX = d.clientX !== void 0 ? d.clientX : d.pageX, this.clientY = d.clientY !==
      void 0 ? d.clientY : d.pageY, this.screenX = d.screenX || 0, this.screenY = d.screenY || 0
      ) : (this.offsetX = a.offsetX, this.offsetY = a.offsetY, this.clientX = a.clientX !==
...
ui.prototype.add = function(a, b, c, d, e) {
  ...
  a || (a = this.j[f] = [], this.l++);
  var g = vi(a, b, d, e);
  g > -1 ? (b = a[g], c || (b.ja = !1)) : (b = new si(b, this.src, f, !!d, e), b.ja = c, a.push(
    b));
  return b
};
ui.prototype.remove = function(a, b, c, d) {
  ...
  var e = this.j[a];
  b = vi(e, b, c, d);
  return b > -1 ? (ti(e[b]), Array.prototype.splice.call(e, b, 1), e.length == 0 && (delete this
    .j[a], this.l--), !0) : !1
};
...
var xi = "closure_lm_" + (Math.random() * 1E6 | 0),
  yi = {},
  zi = 0;
...
function Ai(a, b, c, d, e) {
  ...
  c = Ci(c);
  return a && a[qi] ? a.listen(b, c, La(d) ? !!d.capture : !!d, e) : Di(a, b, c, !1, d, e)
}
...
function Di(a, b, c, d, e, f) {
  ...
  d.src = a;
  d.listener = c;
  if (a.addEventListener) oi || (e = g), e === void 0 && (e = !1), a.addEventListener(b.toString(),
    d, e);
...
function Bi(a, b, c, d, e) {
  ...
  c = Ci(c);
  return a && a[qi] ? a.l.add(String(b), c, !0, La(d) ? !!d.capture : !!d, e) : Di(a, b, c, !0, d,
    e)
}
...
function Ii(a, b, c, d, e) {
  ...
  else(d = La(d) ? !!d.capture : !!d, c = Ci(c), a && a[qi]) ? a.l.remove(String(b), c, d, e) : a &&
    (a = Ei(a)) && (b = a.j[b.toString()], a = -1, b && (a = vi(b, c, d, e)), (c = a > -1 ? b[a] :
      null) && Ji(c))
}
...
function Ji(a) {
  if (typeof a !== "number" && a && !a.removed) {
    ...
    if (b && b[qi]) wi(b.l, a);
      ...
      var c = a.type,
        d = a.proxy;
      b.removeEventListener ? b.removeEventListener(c, d, a.capture) : b.detachEvent ? b
        .detachEvent(Gi(c), d) : b.addListener && b.removeListener && b.removeListener(d);
      zi--;
...
p.dispatchEvent = function(a) {
  ...
  a.l || (g = a.currentTarget = b, e = Qi(g, d, !0, a) && e, a.l || (e = Qi(g, d, !1, a) && e));
  if (c)
    for (f = 0; !a.l && f < c.length; f++) g = a.currentTarget = c[f], e = Qi(g, d, !1, a) && e;
  return e
};
p.N = function() {
  Z.W.N.call(this);
...
function Vi(a, b, c) {
  b && (a.j.stop(), Xi(a, a.v));
  a.isActive() || (b = Math.max(0, a.C + a.l - Date.now()), b == 0 && (c ? b = Xi(a, a.v) : a.l =
    0), a.j.start(b))
}
p.stop = function() {
  this.j.stop()
...
Yi.prototype.listen = function(a, b, c, d) {
  ...
  for (var e = 0; e < b.length; e++) {
    var f = Ai(a, b[e], c || this.handleEvent, d || !1, this.l || this);
    if (!f) break;
    this.j[f.key] = f
  }
  return this
...
p.send = function(a, b, c, d) {
  ...
  var e = ah(ah(hh(this.v.length), function(f) {
    if (!(f >= this.fa)) return this.O && (a = V(a, "errorSender_enqueueTimeMs", Date.now()
...
p.za = function() {
  var a = this.o && this.o.getState().j >= 3,
    b = this.na() || this.j.isActive() || this.l.isActive() || this.P;
...
function cj(a, b) {
  ...
  try {
    ...
    a.O && (c = V(c, "errorSender_sendTimeMs", Date.now().toString()), c = V(c, "errorSenderType", a
      .Ka()), b.errorSender_frontIndex && (c = V(c, "errorSender_frontIndex", b
      .errorSender_frontIndex)), b.errorSender_nextIndex && (c = V(c, "errorSender_nextIndex", b
      .errorSender_nextIndex)), b.errorSender_queueSize && (c = V(c, "errorSender_queueSize", b
...
p.ob = function() {
  var a = ej(this.j),
    b = this.H,
    c = fj(this.j) || a >= 400 && a <= 500,
    d = this.A > 3;
  c || d ? (this.A = 0, this.C = null, this.l.stop(), ah(hh(), function() {
    Wg(b);
    Xg(b, !0)
  })) : (this.A++, this.C = a === -1 ? this.j.C : a, aj(this), this.enqueue(this.X), Wg(b), Xg(
    b, !0))
};

function aj(a) {
  a.A != 1 || a.l.isActive() ? a.l.start() : Vi(a.l, !0, !0)
}
p.N = function() {
...
ij.prototype.toString = function() {
  var a = "{bool=" + !(this.l ? !td(this.j, 5) : !td(this.j, 2)) + ', string="',
    b = this.l ? yd(this.j, 6) : wd(this.j, 3);
...
var lj = ['window[("_callback_" + expid)] is not a function',
...
uj.prototype.ga = function() {
  var a = new Map,
    b, c = (b = this.j) == null ? void 0 : pj(tj(b));
  if (c == null ? 0 : vc(H(c, 2)) != null) {
    var d;
    (b = (d = xd(c, 2)) == null ? void 0 : d.toString()) && a.set("canaryanalysisservertestgroup",
      b);
    if (c == null) var e = void 0;
      ...
      var f = f === void 0 ? !1 : f;
      var g = typeof b;
      b == null ? f = b : g === "bigint" ? f = String(mc(64, b)) : uc(b) ? g === "string" ? (f =
        b, uc(f), b = pc(Number(f)), nc(b) ? f = String(b) : (b = f.indexOf("."), b !== -1 && (
          f = f.substring(0, b)), f = xc(f))) : f = f ? zc(b) : yc(b) : f = void 0;
      e = d(f != null ? f : e);
      c = ud(c, 2);
...
wj.prototype.ga = function() {
  ...
  try {
    for (; !c.done; c = b.next()) {
      var g = c.value,
        h = Bj(g.key);
      h === 0 ? (a.set("apps_telemetry.automation_property_present." + g.S, "true"), e = !0) :
        h === 2 && a.set("apps_telemetry.automation_property_check_failed." + g.S, "true")
    }
  } finally {
  ...
  try {
    for (; !h.done; h = g.next()) {
      var l = h.value,
        m = l.S,
        q = Dj(this, l.name, l.Ja);
      if (!q.da) {
        var t = q.reason;
        a.set("apps_telemetry.native_function_tampering." + m + ".reason", t);
        t === "non_function_type" && a.set("apps_telemetry.native_function_tampering." + m +
          ".type", q.type);
        f = !0
      }
    }
...
function zj() {
  return "WorkerGlobalScope" in z && typeof z.WorkerGlobalScope === "function" && self instanceof z
    .WorkerGlobalScope
}
...
var Gj = [],
  ...
  Mj = [RegExp("at file:///|@file:///|phantomjs|node:electron|py-scrap|eval code|Program Files"),
...
function bk(a) {
  try {
    return ek(a) ? a.message + "\n" + a.stack : a && a instanceof Object ? JSON.stringify(a) :
      String(a)
  } catch (b) {
    return String(a)
  }
...
gk.prototype.j = function(a) {
  var b = Wj(a);
  return hk(a.message, this.l) || hk(a.j, this.o) || hk(b, this.l) || hk(b, this.o) ? "warning" :
    null
};
...
ik.prototype.j = function(a) {
  switch (this.matchType) {
    ...
    case 1:
      a: {
        e = a.message;d = w(this.l);a = d.next();
        try {
          for (; !a.done; a = d.next())
...
var mk = [new Rj, kk(
    ...
    .split(";"), Gj, 2), new gk([], Hj, 2, 0), new gk(Lj, Mj, 3, 0), kk(
    ...
    .split(";"),
    ["postUserData", "inline.cdn.mcas.ms", "evaluating 'n.standardSelectors'"], 3), new gk(Nj, Hj,
    5, 0), kk(
    ...
    .split(";"), Gj, 5), new gk(Oj, Oj, 4, 0), kk([
...
function rk(a, b) {
  ...
  try {
    ...
    e = !1, a = fk(x, c), d.set("apps_telemetry.handling_error", Sj(a))
  }
...
uk.prototype.ga = function() {
  if ("WorkerGlobalScope" in z && typeof z.WorkerGlobalScope === "function" && self instanceof z
    .WorkerGlobalScope) return new Map;
  try {
    var a = Array.from(document.querySelectorAll("script")).filter(this.l).slice(0, 30).map(this
      .j).join("\n")
  } catch (b) {
...
function yk(a, b) {
  ...
  g = g === void 0 ? xk() : g;
  c = c.Cb;
  this.o = pk(b, d, f === void 0 ? !1 : f, c === void 0 ? ca(!0) : c);
...
try {
  var Lk, Mk, Nk = (Mk = (Lk = window) == null ? void 0 : Lk.top) != null ? Mk : z;
...
p.send = function(a, b, c, d) {
  if (this.j) throw Error("[goog.net.XhrIo] Object is active with another request=" + this.M +
    "; newUri=" + a);
  ...
  !(cb(hl, b) >= 0) || d || g || c.set("Content-Type",
  ...
  "withCredentials" in this.j && this.j.withCredentials !== this.U && (this.j.withCredentials =
    this.U);
  try {
    this.A && (clearTimeout(this.A), this.A = null), this.O > 0 && (this.A = setTimeout(this.Db
      .bind(this), this.O)), this.G = !0, this.j.send(a), this.G = !1
  } catch (t) {
    jl(this)
  }
};
...
p.abort = function(a) {
  this.j && this.o && (this.o = !1, this.v = !0, this.j.abort(), this.v = !1, this.C = a || 7,
    this.dispatchEvent("complete"), this.dispatchEvent("abort"), ll(this))
};
p.N = function() {
  this.j && (this.o && (this.o = !1, this.v = !0, this.j.abort(), this.v = !1), ll(this, !0));
  fl.W.N.call(this)
};
p.Qa = function() {
...
function fj(a) {
  ...
  if (!c) {
    if (b = b === 0) a = String(a.M).match(Vf)[1] || null, !a && z.self && z.self.location && (a = z
      .self.location.protocol.slice(0, -1)), b = !gl.test(a ? a.toLowerCase() : "");
    c = b
  }
  return c
}
...
function xl(a, b) {
  ...
  if (a.l) {
    var d = c.push,
      e = new Date(b.o());
    d.call(c, "[", vl(e.getFullYear() - 2E3) + vl(e.getMonth() + 1) + vl(e.getDate()) + " " + vl(e
      .getHours()) + ":" + vl(e.getMinutes()) + ":" + vl(e.getSeconds()) + "." + vl(Math.floor(e
      .getMilliseconds() / 10)), "] ")
  }
  d = c.push;
  e = a.D.get();
...
function Bl(a) {
  ...
  a.M.listen(a.j, "c", function(e) {
    ...
    var g = e.aa.severity;
    (g = g == "fatal" || g == "postmortem") && !a.gb && (a.ib && !f ? a.V.notify(e, e.aa) : a.V
      .notify(void 0, e.aa));
...
function Dl(a, b) {
  ...
  } else b = typeof a === "string" ? Error("Unhandled " + b + " with: " + a) : typeof a ===
    "number" ? Error("Unhandled " + b + " with number: " + a) : a == null ? Error("Unhandled " + b +
...
function Nl(a, b) {
  if (a && typeof a === "object" && !a.message && a.constructor && a
    .constructor instanceof Function && (a.constructor.name ? a.constructor.name : Ff(a
      .constructor)) === "Object") {
    b.unknownErrorToStringResult = Object.prototype.toString.call(a);
    for (var c = JSON, d = c.stringify, e = {}, f = Object.keys(a), g = 0, h = 0; h < f.length &&
      g < 10; h++) {
      var k = f[h];
      try {
...
function Hl(a, b, c, d) {
  ...
  try {
    ...
    throw e && !a.O && (a.H = !1), a.C = !0, c.provideLogDataError = g.message, c.severity || (c
      .severity = "fatal"), If(g);
  } finally {
    if (c["severity-unprefixed"] = c.severity || "fatal", c.severity = "" + c[
      "severity-unprefixed"], !a.Va)
      for (var f in c) typeof c[f] === "number" || c[f] instanceof Number || typeof c[f] ===
        "boolean" || c[f] instanceof Boolean || a.Ta.includes(f) || f in c && delete c[f]
  }
}
yl.prototype.X = function(a, b, c) {
  ...
  g = a.stack || "";
  if (g.trim().length == 0 || g == "Not available") b["stacklessError-reportingStack"] = Hf(yl
    .prototype.X), [a.message].concat(pa(Object.keys(b)), pa(Object.values(b))).some(function(
  h) {
    return h && h.includes("<eye3")
  }) || (b.eye3Hint = "<eye3-stackless title='Stackless JS Error - " + a.name + "'/>");
  this.C && !this.O ? (this.H = this.A, c == "fatal" ? c = "postmortem" : c == "incident" && (c =
    "warningafterdeath")) : c == "fatal" && (this.C = !0);
  this.A = !1;
  b.severity = c
};
  ...
  return za(new ya(new ua(function(u) {
    switch (u.j) {
      ...
      case 5:
        ...
        d = c.next();
        try {
          for (; !d.done; d = c.next()) f = d.value, g = w(f), h = g.next().value, k = g
            .next().value, l = h, m = k, q = void 0, b.set(l, (q = m) != null ? q : "")
        } finally {
          d && !d.done && (e = c.return) && e.call(c)
        }
      case 3:
...
Ul.prototype.Pa = function(a, b) {
  ...
  if (a || c) c = od(this.j, sj, 3), b = new rj, b = Bd(b, 1, this.o), b = Bd(b, 2, this.l), sd(c,
    rj, 5, b), Vl(this)
};
Ul.prototype.qa = function(a) {
  a: {
    ...
    } else jd(b.B, void 0, c, 4);b = od(b, nj, 4)
  }
  b.qa(a);Vl(this)
};
...
p.abort = function() {
  ...
  this.readyState >= 1 && this.j && this.readyState != 4 && (this.j = !1, $l(this));
  this.readyState = 0
};
p.nb = function(a) {
  if (this.j && (this.H = a, this.A || (this.status = this.H.status, this.statusText = this.H
      .statusText, this.A = a.headers, this.readyState = 2, Zl(this)), this.j && (this
      .readyState = 3, Zl(this), this.j)))
    if (this.responseType === "arraybuffer") a.arrayBuffer().then(this.lb.bind(this), this.ma
      .bind(this));
...
p.getAllResponseHeaders = function() {
  if (!this.A) return "";
  for (var a = [], b = this.A.entries(), c = b.next(); !c.done;) c = c.value, a.push(c[0] + ": " +
    c[1]), c = b.next();
  return a.join("\r\n")
};
...
function lm(a) {
  var b = Hg();
  chrome.runtime.sendMessage(Mc(a), void 0, function(c) {
    return mm(b, function(d) {
      return new jm(d)
    }, c)
  });
  return b.promise.catch(function(c) {
    c = T(c);
    rb(c, "offscreenDocumentRequestType", xd(a, 1).toString());
    throw c;
  })
}

function mm(a, b, c) {
  var d = chrome.runtime;
  c !== void 0 ? (d = b(c), d.wa() ? (b = a.reject, c = Error, d = d.wa(), d = yd(d, 1), b.call(a,
    c("Error from Offscreen page:" + d))) : a.resolve(d)) : a.reject(Error(
    "No response from Offscreen page:" + (d.lastError ? d.lastError.message :
      "without lastError")))
};

// 状态层：读取已启用离线的账号 OUID。以下 storage.local 函数只保存控制状态。
function nm() {
  return om(chrome.storage.local, ["optedInUserOuid"]).then(function(a) {
    return a.optedInUserOuid || null
  })
}

// 启用离线并可选保存 OUID；保持原始 Promise 顺序。
function pm(a) {
  return qm({
    offlineOptedIn: !0
  }).then(function() {
    if (a) {
      var b = {};
      return qm((b.optedInUserOuid = a, b))
    }
  })
}

// 退出离线：写入 false，再清理账号标识。
function rm() {
  return qm({
    offlineOptedIn: !1
  }).then(function() {
...
// 三态开关：unknown / opted_in / opted_out；异常值会抛错。
function tm() {
  return om(chrome.storage.local, ["offlineOptedIn"]).then(function(a) {
    a = a.offlineOptedIn;
    switch (a) {
      case void 0:
        return "unknown";
...
// 企业策略：允许离线的域名列表。autoEnabled 列表也会隐含允许。
function Fg() {
  return om(chrome.storage.managed, ["allowedDocsOfflineDomains"]).then(function(a) {
    return a && a.allowedDocsOfflineDomains ? a.allowedDocsOfflineDomains : []
  })
}

function Gg() {
  return om(chrome.storage.managed, ["autoEnabledDocsOfflineDomains"]).then(function(a) {
...
function om(a, b) {
  return new X(function(c, d) {
    a.get(b, function(e) {
      chrome.runtime.lastError ? d(Error(chrome.runtime.lastError)) : c(e)
    })
  })
}
...
function qm(a) {
  return new X(function(b, c) {
    chrome.storage.local.set(a, function() {
      chrome.runtime.lastError ? c(Error(chrome.runtime.lastError)) : b()
    })
  })
}
...
function sm() {
  return new X(function(a, b) {
    chrome.storage.local.remove("optedInUserOuid", function() {
      chrome.runtime.lastError ? b(Error(chrome.runtime.lastError)) : a()
    })
  })
}

function um() {
  return om(chrome.storage.local, ["lastSuccessfulFrameConnectTime"]).then(function(a) {
    return a.lastSuccessfulFrameConnectTime || null
  })
};
...
// OffscreenDocumentManager（研究命名）：创建隐藏 DOM 页的配置、就绪门闩和恢复状态。
function Dm(a, b, c) {
  W.call(this);
  this.A = null;
  this.H = a;
  ...
  this.o = !1;
  a = new Th;
  Wh(a, "offscreendocument.html");
  gi(a, "randomPercentageForSampling", this.v);
  gi(a, "sessionId", this.C);
  this.G = {
    url: a.toString(),
    reasons: ["IFRAME_SCRIPTING"],
    justification: "Use iframe to access user data under docs.google.com domain"
  };
  this.j = new bm(this.v)
}
v(Dm, W);
...
// 关闭链路：先请求 offscreen 移除 iframe，再关闭 offscreen document 并重置门闩。
function Fm(a) {
  return Gm().then(function(b) {
    return b ? lm(Bm(new Am, 5)).then(function() {
...
function Nm(a, b) {
  return Gm().then(function(c) {
    b[Om(0)] = c.toString();
    return c ? Promise.resolve() : Pm(a)
  })
}

// Chrome offscreen 创建入口；处理并发创建单例时的特定错误。
function Pm(a) {
  return chrome.offscreen.createDocument(a.G).catch(function(b) {
    if (b instanceof Error && b.message.includes(
        "Only a single offscreen document may be created")) cm(a.j, b);
    else return Promise.reject(b)
  })
}

function Qm(a, b) {
  return chrome.offscreen.closeDocument().catch(function(c) {
    c = c instanceof Error ? c.message : c.toString();
    cm(a.j, Error(c), b);
    b.errorWhenForceCloseOffscreenDoc = c
  }).then(function() {
    return Pm(a)
  })
}
...
function Lm(a, b, c) {
  ...
  var d = new vm;
  c = Ad(d, 1, c);
  c = Ad(c, 2, a.A.toString());
  a = Ad(c, 3, a.H);
  a = Ad(a, 4, "opted_in");
  return sd(b, vm, 2, a)
}

// 向 Google iframe 发起业务 RPC；特定端口错误允许一次延迟重试。
function Rm(a, b) {
  var c = {
      sendingFrameRequestType: xd(b, 1)
    },
    d = Cm(Bm(new Am, 4), b);
  return Jm(Sm(a, d, c, 0)).catch(function(e) {
    if (e instanceof Error) {
      c.offlineFrameConnected_afterFirstError = a.o;
      if (Tm(e.message)) return cm(a.j, e, c), new Promise(function(f) {
        return setTimeout(function() {
          return f(Sm(a, d, c, 1))
        }, 2E3)
      });
      if ("Requests cancelled because user has been opted out" == e.message) return Promise
        .resolve(new fm)
    }
    return Promise.reject(e instanceof Error ? e : Error(e))
  })
}

function Sm(a, b, c, d) {
  return a.l.promise.then(function() {
    return Gm()
  }).then(function(e) {
    c[Om(d)] = e.toString();
    return e ? Ag() : Um(a)
...
function Um(a) {
  Hm(a);
  return tm().then(function(b) {
    return b == "opted_in" ? nm().then(function(c) {
      return Mm(a, c)
    }) : Bg()
  })
}

// 确保 offscreen 存在并发送初始化消息；连接失败时重建再重试。
function Km(a, b) {
  xd(b, 1) == 6 || xd(b, 1);
  var c = {
    sendingOffscreenDocumentRequestType: xd(b, 1).toString()
  };
  return Ag(Nm(a, c)).then(function() {
    return Si()
  }).then(function() {
    return lm(b)
  }).T(function(d) {
    return d instanceof Error && Tm(d.message) ? (cm(a.j, d, c), Ag(Gm()).then(function(e) {
      c[Om(1)] = e.toString()
    }).then(function() {
      return Qm(a, c)
    }).then(function() {
      ...
      return lm(b)
    })) : Promise.reject(d instanceof Error ? d : Error(d))
  }).T(function(d) {
    return Vm(d, c)
  })
}
...
function Tm(a) {
  return a.includes("Could not establish connection. Receiving end does not exist.") || a.includes(
    "The message port closed before a response was received.") || a.includes(
    "A listener indicated an asynchronous response by returning true, but the message channel closed before a response was received"
    )
}

// 通过 self.clients.matchAll 检查 offscreen 页面是否存在；不是网页 Service Worker 注册检查。
function Gm() {
  return self.clients.matchAll().then(function(a) {
    return a.some(function(b) {
      return b.url.includes(chrome.runtime.getURL("offscreendocument.html"))
    })
  })
}
Dm.prototype.N = function() {
  Fm(this);
  W.prototype.N.call(this)
};
...
function Om(a) {
  switch (a) {
    case 0:
      return "hasDocument_beforeCreatingOffscreenDoc_0";
    case 1:
      return "hasDocument_beforeCreatingOffscreenDoc_1";
    default:
      throw Error("Cannot get error context key with retryAttempt " + a);
  }
}
...
// OfflineExtensionController（研究命名）：同步注册 Chrome 事件，随后 load() 恢复持久化状态。
function dn() {
  W.call(this);
  var a = this;
  this.G = qf();
  ...
  chrome.alarms.onAlarm.addListener(function(b) {
    return a.L.promise.then(function() {
      return Ml(a.j, Ll(a.j, a.sb, a)(b))
    }).T(function(c) {
      var d = {};
      dm(a.l, T(c), (d.extension_codePath = "onAlarm_listener", d))
    })
  });
  chrome.runtime.onMessageExternal.addListener(function(b, c, d) {
    return en(a, b, d)
  });
  chrome.runtime.onMessage.addListener(this.tb.bind(this));
  this.C = new Yi(this);
  dg(this, this.C);
  this.C.listen(z, "message", this.ub);
  this.v = Math.random() * 100;
  this.H = this.v < 1;
  this.l = new bm(this.v);
  this.o = new Dm(fn(), this.G, this.v);
  chrome.runtime.onConnectExternal.addListener(n());
  Ri(this.Ab, 252E5, this)
}
v(dn, W);
p = dn.prototype;
p.load = function() {
  var a = this;
  this.A = "docs.google.com";
  return qm({
    docsDomain: this.A
  }).then(function() {
    a.j = gn(a);
...
function jn(a, b, c) {
  return gi(gi(Wh(hn(a), "/offline/extension/report"), "v", c), "optin", b).toString()
}
p.Ab = function() {
  chrome.alarms.create("open", {
    delayInMinutes: 1
  });
  cm(this.l, Error("Called unsafeClose_"))
};

// 后台调度：heartbeat alarm 的配置周期为 5 分钟，实际触发受浏览器调度影响。
function kn(a, b) {
  b = b === void 0 ? !1 : b;
  return new X(function(c) {
    chrome.alarms.get("heartbeat", function(d) {
      d || chrome.alarms.create("heartbeat", {
        periodInMinutes: 5
      });
      d && !b || ln(a, "heartbeat").T(function(e) {
        dm(a.l, T(e), {
...
// Worker 启动恢复：读取开关及账号，已启用时重新创建 Google iframe。
p.pb = function() {
  var a = this;
  return um().then(function(b) {
    a.j.o.lastSuccessfulFrameConnectTime = (b == null ? void 0 : b.toString()) || "null"
  }).then(function() {
    return tm()
  }).then(function(b) {
    var c = fn();
    a.j.o.extensionVersion = c;
    a.j.o.optInStatus = String(b);
    nn(a, String(b), c);
    switch (b) {
      case "unknown":
        break;
      case "opted_in":
        return nm().then(function(d) {
          return Mm(a.o, d)
        });
      case "opted_out":
        break;
...
function nn(a, b, c) {
  a.H && (b = jn(a, b, c), z.fetch(new Request(b, {
    method: "post",
    mode: "cors"
  })).then(n()).catch(function(d) {
    Kl(a.j, T(d))
  }))
}
p.ub = function(a) {
  var b = this,
    c = a.j;
  c && c.data && c.ports && c.ports.length ? (a = new Ym(c.data), on(this, a, c.ports.length > 1 ?
    c.ports[1] : void 0).then(function(d) {
    c.ports[0].postMessage(Mc(d))
  }).T(function(d) {
    dm(b.l, T(d), {
      context: "onMessageFromOfflineFrame_postMessage"
    })
  })) : dm(this.l, Error("Dropped invalid event."), {
    event: String(a)
  })
};

// 外部网页消息入口：返回 true 保持异步回复通道；允许来源由 manifest 限制。
function en(a, b, c) {
  var d = new Ym(b);
  on(a, d).then(function(e) {
    c(Mc(e))
  }).T(function(e) {
    e instanceof Error && e.message == "Attempting to use a disconnected port object" ? dm(a.l,
      Error("Failed to reply to request because listen port was disconnected."), {
        requestType: zd(d)
      }) : dm(a.l, T(e), {
      requestType: zd(d)
    })
...
// offscreen → worker：type 3 保存握手信息，type 7 汇报账号/退出状态。
p.tb = function(a, b, c) {
  var d = this;
  a = new Am(a);
  switch (zd(a)) {
    case 3:
      var e = I(a, wm, 4);
      a = Bc(H(e, 1)) != null ? wd(e, 1) : null;
      var f = yd(e, 2);
      pm(a).then(function() {
        return qm({
          lastSuccessfulFrameConnectTime: parseInt(f, 10)
        })
      }).then(function() {
        var h = d.o;
        h.o = !0;
    ...
    case 7:
      var g = km(7);
      a = (e = I(a, zm, 6)) == null ? void 0 : wd(e, 1);
      (a ? pn(this, a) : qn(this)).then(function() {
        return c(Mc(g))
      }).T(function(h) {
        dm(d.l, T(h), {
...
function on(a, b, c) {
  return Ag().then(a.wb.bind(a, b, c)).T(function(d) {
...
// 网页请求分发：1 握手；2 确保离线；3 账号/退出；4 frame RPC；5 企业策略。
p.wb = function(a) {
  var b = this,
    c = im(new hm, vc(H(a, 1)));
  switch (zd(a)) {
    case 1:
      return (a = (a = I(a, wm, 7)) ? yd(a, 1) : null) || cm(this.l, Error(
        "Scheduler frame connect request sent without an ouid.")), pm(a).then(function() {
        return qm({
          lastSuccessfulFrameConnectTime: Date.now()
        })
      }).then(function() {
        var f = b.o;
        f.o = !0;
    ...
    case 2:
      var d = (a = I(a, Wm, 8)) ? yd(a, 1) : null,
        e = a ? !!td(a, 2) : !1;
      return pm(d).then(function() {
        return d ? d : nm()
      }).then(function(f) {
        return Im(b.o, f).then(function() {
          return kn(b, e)
        })
      }).then(function() {
        return c
    ...
    case 3:
      return (a = I(a, zm, 3)) && wd(a, 1) ? (a = wd(a, 1), pn(this, a).then(function() {
        return c
      })) : qn(this).then(function() {
        return c
      });
    case 5:
      return rn(I(a, Xm, 5)).then(function(f) {
        sd(c, gm, 4, f);
        return c
      });
    case 4:
      return a = I(a, ym, 4), Ag(Rm(this.o, a)).then(function(f) {
        sd(c, fm, 3, f);
        return c
      })
  }
...
// 企业策略查询：autoEnabled 域名同时视为 allowed。
function rn(a) {
  var b = yd(a, 1);
  return Eg().then(function(c) {
    var d = c[0],
      e = c[1];
    c = new gm;
    e = cb(e, b) >= 0;
    ...
    d = d == null ? d : sc(d);
    ad(c, 1, d);
    ad(c, 2, e == null ? e : sc(e));
    return c
  })
}

function pn(a, b) {
  return a.M ? Ag(Fm(a.o)) : (cm(a.l, Error("Extension frame connected with the wrong OUID.")), a
    .M = !0, Ag(Mm(a.o, b)))
}

// 完整退出：持久化关闭状态 → 清除 heartbeat → 关闭隐藏页面。
function qn(a) {
...
function gn(a) {
  var b = Wh(hn(a), "/offline/jserror").toString(),
    c = a.H;
  a = String(a.G);
  var d = !0;
  d = d === void 0 ? !1 : d;
  ...
  g.v = Wl;
  b = new yl(g);
  b.o.sessionTypeName = "offline-event-page";
  b.o.reportsNonFatalErrors = String(c);
  b.o.sid = a;
  return b
}

function hn(a) {
  return Uh(new Th("//" + a.A), "https")
}

function fn() {
  var a = chrome.runtime.getManifest();
  return a.version ? a.version : "unknown"
};
// 保留原始入口与全局兼容别名；此 bundle 不负责网页导航缓存。
self.window = self;
(new dn).load();
