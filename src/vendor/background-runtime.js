/**
 * background 运行库：从固定样本按词法绑定语义化还原。
...
/**
 * 保留字段 ABI：j=下一状态地址，A=执行中，o=委托迭代器，J=yield 返回值；不同编译目标字段布局以原样本为准。
 */
...
GeneratorContext.prototype.P = function (value, other) {
  ...
  (other = this.l = this.l || other)
    ? other.Oa
      ? (this.j = this.D || this.v)
      : other.ha != void 0 && this.v < other.ha
        ? ((this.j = other.ha), (this.l = null))
        : (this.j = this.v)
    : (this.j = value);
};
...
function GeneratorIterator(engine) {
  this.next = function (value) {
    enterGenerator(engine.j);
    engine.j.o
      ? (value = advanceDelegatedIterator(engine, engine.j.o.next, value, engine.j.C))
      : (engine.j.C(value), (value = runGenerator(engine)));
    return value;
  };
...
function collectRestArguments() {
  for (
    var intermediate = Number(this), values = [], intermediate2 = intermediate;
    intermediate2 < arguments.length;
    intermediate2++
  )
...
var arrayFlagsSymbol = createInternalSymbol("jas", void 0, true),
  ...
  messageMarkerSymbol = createInternalSymbol("m_m", "Ic", true);
Math.max.apply(
  Math,
  iterableToArray(
    Object.values({
...
function isImmutableMessage(message, flags) {
  return flags === void 0
    ? message.j !== copyOnWriteToken && !!(2 & (message.B[arrayFlagsKey] | 0))
...
function readRepeatedMessages(message, MessageType, fieldNumber) {
  ...
  (mode === 2 || mutableOrFlags) &&
    detachCopyOnWriteArray(message) &&
    ((parentArray = message.B), (parentFlags = parentArray[arrayFlagsKey] | 0));
...
ArrayMessage.prototype.clone = function () {
  var backingOrStateValue = this.B,
    intermediate = backingOrStateValue[arrayFlagsKey] | 0;
  ...
  try {
    ...
    if (readStringOrDefault(value, 1).split("/").pop() != intermediate4) var intermediate5 = null;
      ...
      detachCopyOnWriteArray(value) &&
        ((backingOrStateValue = value.B), (intermediate7 = backingOrStateValue[arrayFlagsKey] | 0));
...
prototypeAlias.add = function (other) {
  var leftHighUpper16 = this.I >>> 16,
    leftHighLower16 = this.I & 65535,
    leftLowUpper16OrCarry = this.K >>> 16,
    rightHighUpper16 = other.I >>> 16,
    rightHighLower16 = other.I & 65535,
...
prototypeAlias.multiply = function (other) {
  ...
  var intermediate = this.I >>> 16,
    intermediate2 = this.I & 65535,
    intermediate3 = this.K >>> 16,
    intermediate4 = this.K & 65535,
    intermediate5 = other.I >>> 16,
    intermediate6 = other.I & 65535,
...
prototypeAlias.div = function (divisor) {
  ...
  for (intermediate2 = this; intermediate2.compare(divisor) >= 0; ) {
    ...
    for (
      ...
      intermediate6.I < 0 || intermediate6.compare(intermediate2) > 0;
...
prototypeAlias.shiftLeft = function (bits) {
  ...
  return bits < 32
    ? int64FromWords(intermediate << bits, (this.I << bits) | (intermediate >>> (32 - bits)))
...
function getJavaClass(value) {
  ...
  if (value instanceof Int64) value = getJavaClassMetadata(JavaLong);
    ...
    value = (value = value.ra)
      ? getJavaClassMetadata(value.ca, value.ba)
      ...
      if (intermediate2)
        if (intermediate2.ba > 1) {
          ...
          if (value != null && Array.isArray(value)) {
            var intermediate3 = value.ra || { ca: JavaObject, ba: 1 },
              intermediate4 = intermediate3.ba;
            intermediate4 == intermediate2
              ? ((intermediate2 = intermediate3.ca),
                (intermediate =
                  intermediate2 === intermediate
                    ? true
                    : (intermediate && intermediate.prototype.Ra) ||
                        (intermediate2 && intermediate2.prototype.Ra)
                      ? false
...
function getJavaClassName(javaClass) {
  return javaClass.l != 0
    ? javaString(repeatJavaString("[", javaClass.l)) +
        javaString(
          javaClass.j.prototype.F[1] == 3
            ? javaClass.j.prototype.F[2]
            : "L" + javaString(javaClass.j.prototype.F[0]) + ";",
        )
...
JavaClass.prototype.toString = function () {
  return (
    String(
      this.l == 0 && this.j.prototype.F[1] == 1
        ? "interface "
        : this.l == 0 && this.j.prototype.F[1] == 3
          ? ""
          : "class ",
...
prototypeAlias.dispose = function () {
  ...
  if (intermediate != null) {
    ...
    substringAfterLast(
      substringAfterLast(
        javaString(intermediate.j.prototype.F[0]) +
 ...
 * 保留字段 ABI：J=已销毁，D=析构回调队列，N=析构钩子，na=已销毁查询。
 */
function Disposable() {
  this.J = this.J;
  this.D = this.D;
 ...
 * 保留字段 ABI：j=状态(0 pending/1 同化中/2 fulfilled/3 rejected)，J=结果，o=父链，l/v=回调队首/队尾，A=回调已排程，D=未处理拒绝。
 */
...
function settlePromise(promise, state, value) {
  promise.j == 0 &&
    ...
    (promise.j = 1),
    assimilateThenable(value, promise.Eb, promise.Fb, promise) ||
      ((promise.J = value),
      (promise.j = state),
      (promise.o = null),
  ...
  if (this.o) this.l instanceof LegacyDeferred && this.l.cancel();
    ...
    if (this.j) {
      ...
      value
        ...
        : (intermediate.C--, intermediate.C <= 0 && intermediate.cancel());
    }
    this.G = true;
    this.o ||
...
function runDeferredCallbacks(deferred) {
  ...
  for (var intermediate3 = (intermediate2 = false); deferred.D.length && !deferred.J; ) {
    var intermediate4 = deferred.D.shift(),
  ...
  intermediate3 &&
    ((intermediate7 = bindFunction(deferred.H, deferred, true)),
    (intermediate3 = bindFunction(deferred.H, deferred, false)),
  ...
  if (helper != null)
    for (var intermediate in helper) {
      ...
      isBoxedInteger(intermediate3)
        ? ((intermediate3 = checkedJavaCast(intermediate3, isBoxedInteger, JavaInteger).Y),
...
function CircularBuffer(capacity) {
  ...
  capacity != null
    ? "number" === typeof capacity
      ...
      : (capacity = capacity instanceof Int64 ? requireNonNull(capacity).K : capacity.Y)
    : (capacity = 100);
  this.o = capacity;
 ...
 * 保留字段 ABI：v=scheme，J=userInfo，j=host，C=port，l=path，o=QueryData，A=fragment，D=参数忽略大小写。
 */
  ...
  value instanceof MutableUrl
    ...
    : value && (urlParts = String(value).match(urlPartsPattern))
      ? ((this.D = false),
        ...
        (this.J = decodeUrlComponent(urlParts[2] || "")),
        ...
        (this.A = decodeUrlComponent(urlParts[7] || "")))
      : ((this.D = false), (this.o = new QueryData(null, this.D)));
}
...
MutableUrl.prototype.resolve = function (relativeUrl) {
  ...
  overridesComponent
    ...
    : (overridesComponent = !!relativeUrl.A);
...
function setUrlQueryData(url, query, decode) {
  query instanceof QueryData
    ? ((url.o = query), setQueryIgnoreCase(url.o, url.D))
    : (decode || (query = encodeUrlComponent(query, queryEscapePattern)),
      (url.o = new QueryData(query, url.D)));
}
...
/** xa(key) 是后台版读取全部参数值的 ABI；隐藏页对应 la，不可跨 bundle 混用。 */
...
ListenerMap.prototype.add = function (value, other, options, context, extra) {
  ...
  intermediate2 > -1
    ? ((other = value[intermediate2]), options || (other.ja = false))
...
function restartBackoff(timer, reset, runImmediately) {
  ...
  timer.isActive() ||
    ((reset = Math.max(0, timer.C + timer.l - Date.now())),
    reset == 0 &&
...
function RetryingLogTransport(
  ...
  this.o &&
    trackObserver(this.L, this.o.l(), function () {
      instance.o.getState().j >= 3 &&
        (instance.R = (initializeNetworkStatuses(), offlineNetworkStatus));
      instance.o.getState().j >= 3 ||
        instance.R !== (initializeNetworkStatuses(), offlineNetworkStatus) ||
...
prototypeAlias.send = function (value, other, options, context) {
  parseBooleanFlag(this.ea.get("docs-dafjera")) &&
...
prototypeAlias.za = function () {
  var intermediate = this.o && this.o.getState().j >= 3,
    intermediate2 = this.na() || this.j.isActive() || this.l.isActive() || this.P;
...
function sendNextLogEntry(transport, entry) {
  ...
  try {
    ...
    transport.V != null &&
      (intermediate = appendQueryParameters(intermediate, "reportingSessionId", transport.V));
    transport.A > 0 &&
      (intermediate = appendQueryParameters(intermediate, "retryCount", transport.A));
    transport.C != null &&
      (intermediate = appendQueryParameters(intermediate, "previousErrorSendStatus", transport.C));
    transport.O &&
...
prototypeAlias.ob = function () {
  ...
  intermediate2 || intermediate3
    ...
    : (this.A++,
      (this.C = xhrStatus === -1 ? this.j.C : xhrStatus),
...
EnvironmentInspector.prototype.ga = function () {
  ...
  try {
    for (; !iteration.done; iteration = iterator.next()) {
      ...
      intermediate4 === 0
        ? (map.set("apps_telemetry.automation_property_present." + value.S, "true"),
          (intermediate2 = true))
        : intermediate4 === 2 &&
          map.set("apps_telemetry.automation_property_check_failed." + value.S, "true");
    }
  } finally {
    iteration &&
      !iteration.done &&
...
function inspectNativeFunction(inspector, name, getFunction) {
  ...
  return inspector
    ? (inspector = inspector[1])
      ? inspector !== name
        ? { da: false, reason: "likely_wrong_native_function" }
        : { da: true }
      : { da: false, reason: "likely_bound_function" }
    : { da: false, reason: "likely_non_native_source" };
}
...
function classifyError(classifier, error) {
  return (error = classifier.j(error))
    ? { ta: classifier.ta, la: classifier.la, Ba: error.toUpperCase() }
    : null;
}
  ...
  switch (this.matchType) {
    ...
    case 2:
      return (
        ...
        includesAnyToken(intermediate, this.l) || includesAnyToken(intermediate, this.Z)
          ? "warning"
          : null
      );
    default:
...
function addTelemetrySessionMetadata(processor, error, severity, context) {
  ...
  (processor = processTelemetryError(processor, error, severity, intermediate)) &&
    copyMapEntries(intermediate, processor.va);
...
function createTelemetryProcessor(options, observer) {
  ...
  try {
    var featureFlag = readFeatureFlag(getFeatureFlagStore(), ignoredErrorsFlag),
      ...
      intermediate7 = void 0,
      backingOrStateValue = featureFlag.B,
...
prototypeAlias.send = function (value, iterator, options, context) {
  ...
  !(arrayIndexOf(methodsWithRequestBody, iterator) >= 0) ||
    context ||
    intermediate ||
...
function dispatchXhrError(request) {
  request.H ||
    ((request.H = true), request.dispatchEvent("complete"), request.dispatchEvent("error"));
}
...
prototypeAlias.N = function () {
  this.j &&
    (this.o && ((this.o = false), (this.v = true), this.j.abort(), (this.v = false)),
    ...
    if (request.G && (request.j ? request.j.readyState : 0) == 4)
      ...
      try {
        isSuccessfulXhr(request)
          ...
          : ((request.C = 6), dispatchXhrError(request));
      } finally {
        cleanupXhr(request);
      }
    }
  ...
  reporter.M.listen(reporter.j, "c", function (value) {
    ...
    (severity = severity == "fatal" || severity == "postmortem") &&
      ...
      (reporter.ib && !intermediate3
        ? reporter.V.notify(value, value.aa)
        : reporter.V.notify(void 0, value.aa));
...
function monitorPromise(reporter, promise) {
  reporter.j &&
    promise.then(void 0, function (value) {
...
function enrichReportContext(reporter, error, context, fatal) {
  ...
  try {
    ...
    throw (
      backingOrStateValue && !reporter.O && (reporter.H = false),
      (reporter.C = true),
    ...
    if (
      ...
      for (var intermediate in context)
        typeof context[intermediate] === "number" ||
          context[intermediate] instanceof Number ||
          typeof context[intermediate] === "boolean" ||
          context[intermediate] instanceof Boolean ||
          reporter.Ta.includes(intermediate) ||
          (intermediate in context && delete context[intermediate]);
  }
}
...
prototypeAlias.send = function (value) {
  ...
  (this.X || runtimeGlobal)
    .fetch(new Request(this.V, record))
    .then(this.nb.bind(this), this.ma.bind(this));
};
...
function logSampledInfo(logger, error, context) {
  ...
  logger.o &&
    ((context.sampling_samplePercentage = (0.01).toString()), logger.j.info(error, context));
}
/**
