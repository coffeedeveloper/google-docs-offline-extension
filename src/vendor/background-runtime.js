...
y.prototype.P = function(a, b) {
  ...
  (b = this.l = this.l || b) ? b.Oa ? this.j = this.D || this.v : b.ha != void 0 && this.v < b.ha ? (this
    .j = b.ha, this.l = null) : this.j = this.v: this.j = a
};
  ...
  b.prototype.H =
    function() {
      ...
      typeof g === "function" ? g = new g("unhandledrejection", {
        ...
        cancelable: !0
      }) : (g = ha.document.createEvent("CustomEvent"), g.initCustomEvent("unhandledrejection", !1, !0,
        g));
      g.promise = this;
      g.reason = this.o;
      return k(g)
...
var gb = C("Firefox") || C("FxiOS"),
  hb = C("Safari") && !((bb() ? ab("Chromium") : (C("Chrome") || C("CriOS")) && (bb() || !C("Edge")) || C(
    "Silk")) || (bb() ? 0 : C("Coast")) || (bb() ? 0 : C("Opera")) || (bb() ? 0 : C("Edge")) || (bb() ? ab(
    "Microsoft Edge") : C("Edg/")) || (bb() ? ab("Opera") : C("OPR")) || C("Firefox") || C("FxiOS") || C(
    "Silk") || C("Android")) && !(C("iPhone") && !C("iPod") && !C("iPad") || C("iPad") || C("iPod"));
var ib = {},
  jb = null;
...
function jc(a, b) {
  ...
  else vb() ? c = "" + (BigInt(b) << BigInt(32) | BigInt(a)) : (c = (a >>> 24 | b << 8) & 16777215, b = b >>
    16 & 65535, a = (a & 16777215) + c * 6777216 + b * 6710656, c += b * 8147497, b *= 2, a >= 1E7 && (c +=
      a / 1E7 >>> 0, a %= 1E7), c >= 1E7 && (b += c / 1E7 >>> 0, c %= 1E7), c = b + kc(c) + kc(a));
  return c
}
...
function lc() {
  var a = F,
    b = ec;
  b & 2147483648 ? vb() ? a = "" + (BigInt(b | 0) << BigInt(32) | BigInt(a >>> 0)) : (b = w(ic(a, b)), a = b
    .next().value, b = b.next().value, a = "-" + jc(a, b)) : a = jc(a, b);
  return a
}
...
function xc(a) {
  ...
  else if (vb()) a = BigInt(a), F = Number(a & BigInt(4294967295)) >>> 0, ec = Number(a >> BigInt(32) &
    BigInt(4294967295));
  else {
    b = +(a[0] === "-");
    ec = F = 0;
    for (var c = a.length, d = 0 + b, e = (c - b) % 6 + b; e <= c; d = e, e += 6) d = Number(a.slice(d, e)),
      ec *= 1E6, F = F * 1E6 + d, F >= 4294967296 && (ec += Math.trunc(F / 4294967296), ec >>>= 0, F >>>= 0);
    b && (b = w(ic(F, ec)), a = b.next().value, b = b.next().value, F = a,
      ec = b)
  }
  return lc()
}
...
function Ac(a) {
  ...
  if (uc(a)) return b === "string" ? (b = pc(Number(a)), nc(b) ? a = Xb(b) : (b = a.indexOf("."), b !== -1 &&
    (a = a.substring(0, b)), a = vb() ? Xb(mc(64, BigInt(a))) : Xb(xc(a)))) : a = nc(a) ? Xb(yc(a)) : Xb(
    zc(a)), a
}
...
function Jc(a, b, c, d) {
  ...
  if (q)
    for (var E in q) h = q[E], h !=
      null && (h = c(h, d)) != null && (t = +E, x = void 0, l && !Number.isNaN(t) && (x = t + m) < g ? f[x] =
...
function Qc(a, b) {
  ...
  if (Array.isArray(a)) {
    var c = a[D] | 0;
    a.length === 0 && c & 1 ? a = void 0 : c & 2 || (!b || 4096 & c || 16 & c ? a = Rc(a, c, !1, b && !(c &
      16)) : (Kb(a, 34), c & 4 && Object.freeze(a)));
    return a
  }
  if (a != null && a[Eb] === Mb) return b = a.B, c = b[D] | 0, Nb(a, c) ? a : Sc(a, b, c) ? Tc(a, b) : Rc(b,
    c);
...
function cd(a, b, c, d, e, f, g, h) {
  var k = b;
  f === 1 || (f !== 4 ? 0 : 2 & b || !(16 & b) && 32 & d) ? dd(b) || (b |= !a.length || g && !(4096 & b) ||
    32 & d && !(4096 & b || 16 & b) ? 2 : 256, b !== k && Jb(a, b), Object.freeze(a)) : (f === 2 && dd(b) &&
    (a = Array.prototype.slice.call(a), k = 0, b = ed(b, d), d = bd(c, d, e, a)), dd(b) || (h || (b |= 16),
      b !== k && Jb(a, b)));
...
function hd(a) {
  return a == null ? a : typeof a === "string" ? a ? new ob(a, mb) : pb() : a.constructor === ob ? a : kb &&
    a != null && a instanceof Uint8Array ? a.length ? new ob(new Uint8Array(a), mb) : pb() : void 0
}
...
function Nd() {
  var a = Od('[["feature named `pageObserver` was not found","feature named `hover` was not found"]]'),
    b = Pd,
    c = 2;
  c = c === void 0 ? 2 : c;
  this.key = "45696263";
...
p.div = function(a) {
  ...
  for (c = this; c.compare(a) >= 0;) {
    var d = Math.max(1, Math.floor(Yd(c) /
        Yd(a))),
...
function ee(a) {
  return a > 0 ? a >= 0x7fffffffffffffff ? fe : new Xd(a, a / 4294967296) : a < 0 ? a <= -0x7fffffffffffffff ?
    ae : Zd(new Xd(-a, -a / 4294967296)) : de
}
...
function Q(a) {
  we(a.j) && (Error.captureStackTrace ? Error.captureStackTrace(R(a.j, we, xe)) : R(a.j, we, xe).stack =
    Error().stack)
}
...
function R(a, b, c) {
  if (a != null && !b(a)) throw a = M(se(Ye(a))) + " cannot be cast to " + M(se(O(c))), b = new Me, b.l = a,
    Q(b), P(b, Error(b)), b.j;
  return a
};
      ...
      if (e.ba > 1) {
        ...
        if (c != null && Array.isArray(c)) {
          var g = c.ra || {
            ...
            h = g.ba;
          h == e ? (e = g.ca, d = e === d ? !0 : d && d.prototype.Ra || e && e.prototype.Ra ? !1 : f(e
            .prototype)) : d = h > e ? L == d : !1
        } else d = !1;
        if (!d) {
          d = !1;
          break a
...
function se(a) {
  return a.l != 0 ? M(lf("[", a.l)) + M(a.j.prototype.F[1] == 3 ? a.j.prototype.F[2] : "L" + M(a.j.prototype
    .F[0]) + ";") : a.j.prototype.F[0]
}
...
kf.prototype.toString = function() {
  return String(this.l == 0 && this.j.prototype.F[1] == 1 ? "interface " : this.l == 0 && this.j.prototype
    .F[1] == 3 ? "" : "class ") + M(se(this))
};
...
function Lg(a, b) {
  if (a.j == 0)
    if (a.o) {
      var c = a.o;
      if (c.l) {
        for (var d = 0, e = null, f = null, g = c.l; g && (g.D || (d++, g.j == a && (e = g), !(e && d >
          1))); g = g.next) e || (f = g);
        e && (c.j == 0 && d == 1 ? Lg(c, b) : (f ? (d = f, d.next == c.v && (c.v = d), d.next = d.next.next) :
          Mg(c), Ng(c, e, 3, b)))
      }
      a.o = null
    } else wg(a, 3, b)
...
function wg(a, b, c) {
  a.j == 0 && (a === c && (b = 3, c = new TypeError("Promise cannot resolve to itself")), a.j = 1, Dg(c, a.Eb,
    a.Fb, a) || (a.J = c, a.j = b, a.o = null, Pg(a), b != 3 || c instanceof Kg || Qg(a, c)))
}
...
function Yg(a) {
  ...
  a.l = b;
  d && (h = A(a.H, a, !0), d = A(a.H, a, !1), b instanceof Ug ? (bh(b, h, d), b.L = !0) :
    b.then(h, d));
...
function yh(a) {
  if (!((a.l.get(null) + 1 | 0) / S(a.l.o / 1E3) <= a.o)) throw (new vh("Query would cause " + M(a.A) +
    " to exceed " + a.o + " qps.")).j;
  a = a.l;
  var b = Yd(ee(Date.now()));
  zh(a, b);
  var c = R(Ah(a.j), Bh, Ch);
  if (c == null || S(b) >= S(c.l)) b = Dh(a, S(b)), c = new Ch, c.l = b, c.j = 0, c.v = 2147483647, c.o = -
...
function Eh(a) {
  this.l = this.o = 0;
  a != null ? "number" === typeof a ? (a = S(a), a = Math.max(Math.min(a, 2147483647), -2147483648) | 0) : a =
    a instanceof Xd ? S(a).K : a.Y : a = 100;
  this.o = a;
  this.j = R([], sf, rf)
}
v(Eh, L);
...
p.xa = function() {
  for (var a = this.j.length, b = this.j.length - this.j.length | 0, c = R([], sf, rf); b < a; b = b + 1 |
    0) {
    var d = c,
      e = this.get(b);
    d.push(e)
...
Lh.prototype.F = ["com.google.apps.docsshared.xplat.observable.EventObserverTracker$ObservableObserverPair",
  0];
...
var Rh = "constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf"
  .split(" ");
...
function Th(a) {
  ...
  this.D = !1;
  var b;
  a instanceof Th ? (this.D = a.D, Uh(this, a.v), this.J = a.J, this.j = a.j, Vh(this, a.C), Wh(this, a.l),
    Xh(this, a.o.clone()), this.A = a.A) : a && (b = String(a).match(Vf)) ? (this.D = !1, Uh(this, b[1] ||
    "", !0), this.J = Yh(b[2] || ""), this.j = Yh(b[3] || "", !0), Vh(this, b[4]), Wh(this, b[5] || "", !
    0), Xh(this, b[6] || "", !0), this.A = Yh(b[7] || "")) : (this.D = !1, this.o = new Zh(null, this.D))
}
Th.prototype.toString = function() {
  ...
  b && a.push($h(b, ai, !0), ":");
  var c = this.j;
  if (c || b == "file") a.push("//"), (b = this.J) && a.push($h(b, ai, !0), "@"), a.push(encodeURIComponent(
    String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.C, c != null && a.push(":", String(c));
  if (c = this.l) this.j && c.charAt(0) != "/" && a.push("/"), a.push($h(c, c.charAt(0) == "/" ? bi : ci, !
    0));
...
function $h(a, b, c) {
  return typeof a === "string" ? (a = encodeURI(a).replace(b, hi), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g,
    "%$1")), a) : null
}
...
ui.prototype.add = function(a, b, c, d, e) {
  ...
  a || (a = this.j[f] = [], this.l++);
  var g = vi(a, b, d, e);
  g > -1 ? (b = a[g], c || (b.ja = !1)) : (b = new si(b, this.src, f, !!d, e), b.ja = c, a.push(b));
  return b
};
ui.prototype.remove = function(a, b, c, d) {
  ...
  var e = this.j[a];
  b = vi(e, b, c, d);
  return b > -1 ? (ti(e[b]), Array.prototype.splice.call(e, b, 1), e.length == 0 && (delete this.j[a], this
    .l--), !0) : !1
};
...
function Di(a, b, c, d, e, f) {
  ...
  d.src = a;
  d.listener = c;
  if (a.addEventListener) oi || (e = g), e === void 0 && (e = !1), a.addEventListener(b.toString(), d, e);
...
function Bi(a, b, c, d, e) {
  ...
  c = Ci(c);
  return a && a[qi] ? a.l.add(String(b), c, !0, La(d) ? !!d.capture : !!d, e) : Di(a, b, c, !0, d, e)
}
...
function Ii(a, b, c, d, e) {
  if (Array.isArray(b))
    ...
    a)) && (b = a.j[b.toString()], a = -1, b && (a = vi(b, c, d, e)), (c = a > -1 ? b[a] : null) && Ji(c))
}
...
function Ji(a) {
  if (typeof a !== "number" && a && !a.removed) {
    ...
    if (b && b[qi]) wi(b.l, a);
      ...
      var c = a.type,
        d = a.proxy;
      b.removeEventListener ? b.removeEventListener(c, d, a.capture) : b.detachEvent ? b.detachEvent(Gi(c),
...
function Vi(a, b, c) {
  b && (a.j.stop(), Xi(a, a.v));
  a.isActive() || (b = Math.max(0, a.C + a.l - Date.now()), b == 0 && (c ? b = Xi(a, a.v) : a.l = 0), a.j
    .start(b))
}
p.stop = function() {
  this.j.stop()
...
function cj(a, b) {
  ...
  try {
    ...
    a.O && (c = V(c, "errorSender_sendTimeMs", Date.now().toString()), c = V(c, "errorSenderType", a.Ka()), b
      .errorSender_frontIndex && (c = V(c, "errorSender_frontIndex", b.errorSender_frontIndex)), b
      .errorSender_nextIndex && (c = V(c, "errorSender_nextIndex",
        b.errorSender_nextIndex)), b.errorSender_queueSize && (c = V(c, "errorSender_queueSize", b
...
p.ob = function() {
  ...
  c || d ? (this.A = 0, this.C = null, this.l.stop(), ah(hh(), function() {
    Wg(b);
    Xg(b, !0)
  })) : (this.A++, this.C = a === -1 ? this.j.C : a, aj(this), this.enqueue(this.X), Wg(b), Xg(b, !0))
};
...
uj.prototype.ga = function() {
  ...
  if (c == null ? 0 : vc(H(c, 2)) != null) {
    ...
    if (c == null) var e = void 0;
      ...
      var f = f === void 0 ? !1 : f;
      var g = typeof b;
      b == null ? f = b : g === "bigint" ? f = String(mc(64, b)) : uc(b) ? g === "string" ? (f = b, uc(f),
        b = pc(Number(f)), nc(b) ? f = String(b) : (b = f.indexOf("."), b !== -1 && (f = f.substring(0,
          b)), f = xc(f))) : f = f ? zc(b) : yc(b) : f = void 0;
      e = d(f != null ? f : e);
      c = ud(c, 2);
  ...
  var h, k;
  (e = (h = this.j) == null ? void 0 : (k = I(h, oj, 1)) == null ? void 0 : xd(k, 6)) && a.set("clientApp",
    String(e));
  return a
};
...
wj.prototype.ga = function() {
  ...
  try {
    for (; !c.done; c = b.next()) {
      var g = c.value,
        h = Bj(g.key);
      h === 0 ? (a.set("apps_telemetry.automation_property_present." + g.S, "true"), e = !0) : h === 2 && a
        .set("apps_telemetry.automation_property_check_failed." + g.S, "true")
    }
  } finally {
...
function rk(a, b) {
  ...
  try {
    ...
    e = !1, a = fk(x, c), d.set("apps_telemetry.handling_error",
      Sj(a))
  }
...
p.send = function(a, b, c, d) {
  ...
  try {
    this.A && (clearTimeout(this.A), this.A = null), this.O > 0 && (this.A = setTimeout(this.Db.bind(this),
      this.O)), this.G = !0, this.j.send(a), this.G = !1
  } catch (t) {
    jl(this)
  }
};
...
p.abort = function(a) {
  this.j && this.o && (this.o = !1, this.v = !0, this.j.abort(), this.v = !1, this.C = a || 7, this
    .dispatchEvent("complete"), this.dispatchEvent("abort"), ll(this))
};
p.N = function() {
...
function fj(a) {
  ...
  if (!c) {
    if (b = b === 0) a = String(a.M).match(Vf)[1] || null, !a && z.self && z.self.location && (a = z.self
      .location.protocol.slice(0, -1)), b = !gl.test(a ? a.toLowerCase() : "");
    c = b
  }
  return c
}
...
function Hl(a, b, c, d) {
  ...
  try {
    ...
    throw e && !a.O && (a.H = !1), a.C = !0, c.provideLogDataError = g.message, c.severity || (c.severity =
      "fatal"), If(g);
  } finally {
...
yl.prototype.X = function(a, b, c) {
  ...
  g = a.stack || "";
  if (g.trim().length == 0 || g == "Not available") b["stacklessError-reportingStack"] = Hf(yl.prototype.X),
    [a.message].concat(pa(Object.keys(b)), pa(Object.values(b))).some(function(h) {
      return h && h.includes("<eye3")
    }) || (b.eye3Hint = "<eye3-stackless title='Stackless JS Error - " + a.name + "'/>");
  this.C && !this.O ?
    (this.H = this.A, c == "fatal" ? c = "postmortem" : c == "incident" && (c = "warningafterdeath")) : c ==
    "fatal" && (this.C = !0);
  this.A = !1;
  b.severity = c
};
  ...
  return za(new ya(new ua(function(u) {
    switch (u.j) {
      ...
      case 5:
        ...
        d = c.next();
        try {
          for (; !d.done; d = c.next()) f = d.value, g = w(f), h = g.next().value, k = g.next()
            .value, l = h, m = k, q = void 0, b.set(l, (q = m) != null ? q : "")
        } finally {
          d && !d.done && (e = c.return) && e.call(c)
        }
      case 3:
...
Ul.prototype.Pa = function(a, b) {
  ...
  if (a || c) c = od(this.j, sj, 3), b = new rj, b = Bd(b, 1, this.o), b = Bd(b, 2, this.l), sd(c, rj, 5,
    b), Vl(this)
};
...
p.nb = function(a) {
  if (this.j && (this.H = a, this.A || (this.status = this.H.status, this.statusText = this.H.statusText,
      this.A = a.headers, this.readyState = 2, Zl(this)), this.j && (this.readyState = 3, Zl(this), this
      .j)))
...
export { W, X, Hg, Ag, Bg, T, rb, dg, Th, Wh, gi, Uh, Yi, qf, Ri, Si, bm, cm, dm, em, fm, gm, hm, jm, vm, wm, xm, ym, zm, Am, Wm, Xm, Ym, Mc, I, H, vc, Bc, wd, yd, td, xd, zd, Ad, Bd, sd, sc, ad, cb, zl, yl, nh, Wl, Kl, Ll, Ml, Zm, $m };
